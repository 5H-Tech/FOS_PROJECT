...
void _main(void)
{
  ...
  800041:	e8 b2 1c 00 00       	call   801cf8 <sys_disable_interrupt>
		cprintf("\n");
  ...
  800162:	e8 ab 1b 00 00       	call   801d12 <sys_enable_interrupt>
  ...
  8001d2:	83 c4 10             	add    $0x10,%esp
		...
		sys_disable_interrupt();
  8001d5:	e8 1e 1b 00 00       	call   801cf8 <sys_disable_interrupt>
  ...
  8001e7:	83 c4 10             	add    $0x10,%esp
		...
		sys_enable_interrupt();
  8001ea:	e8 23 1b 00 00       	call   801d12 <sys_enable_interrupt>
  ...
  800218:	e8 7d 05 00 00       	call   80079a <_panic>
		...
		{
			sys_disable_interrupt();
  80021d:	e8 d6 1a 00 00       	call   801cf8 <sys_disable_interrupt>
			cprintf("\n===============================================\n") ;
  800222:	83 ec 0c             	sub    $0xc,%esp
  800225:	68 98 24 80 00       	push   $0x802498
  80022a:	e8 0d 08 00 00       	call   800a3c <cprintf>
  80022f:	83 c4 10             	add    $0x10,%esp
			cprintf("Congratulations!! The array is sorted correctly\n") ;
  800232:	83 ec 0c             	sub    $0xc,%esp
  800235:	68 cc 24 80 00       	push   $0x8024cc
  80023a:	e8 fd 07 00 00       	call   800a3c <cprintf>
  80023f:	83 c4 10             	add    $0x10,%esp
			cprintf("===============================================\n\n") ;
  800242:	83 ec 0c             	sub    $0xc,%esp
  800245:	68 00 25 80 00       	push   $0x802500
  80024a:	e8 ed 07 00 00       	call   800a3c <cprintf>
  80024f:	83 c4 10             	add    $0x10,%esp
			sys_enable_interrupt();
  800252:	e8 bb 1a 00 00       	call   801d12 <sys_enable_interrupt>
		}

		sys_disable_interrupt();
  800257:	e8 9c 1a 00 00       	call   801cf8 <sys_disable_interrupt>
			Chose = 0 ;
  ...
  800265:	68 32 25 80 00       	push   $0x802532
  ...
  8002ae:	75 b2                	jne    800262 <_main+0x22a>
		...
		sys_enable_interrupt();
  8002b0:	e8 5d 1a 00 00       	call   801d12 <sys_enable_interrupt>
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  800555:	68 80 23 80 00       	push   $0x802380
  ...
  800576:	50                   	push   %eax
  800577:	68 50 25 80 00       	push   $0x802550
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  8005a4:	50                   	push   %eax
  8005a5:	68 55 25 80 00       	push   $0x802555
...
cputchar(int ch)
{
  ...
  8005c8:	50                   	push   %eax
  8005c9:	e8 5e 17 00 00       	call   801d2c <sys_cputc>
...
atomic_cputchar(int ch)
{
  ...
  8005d7:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8005da:	e8 19 17 00 00       	call   801cf8 <sys_disable_interrupt>
	char c = ch;
  ...
  8005ec:	50                   	push   %eax
  8005ed:	e8 3a 17 00 00       	call   801d2c <sys_cputc>
  8005f2:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  8005f5:	e8 18 17 00 00       	call   801d12 <sys_enable_interrupt>
}
  8005fa:	90                   	nop
  8005fb:	c9                   	leave  
  8005fc:	c3                   	ret    
...
getchar(void)
{
  ...
  80060a:	eb 08                	jmp    800614 <getchar+0x17>
	{
		c = sys_cgetc();
  80060c:	e8 ff 14 00 00       	call   801b10 <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  800622:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800625:	e8 ce 16 00 00       	call   801cf8 <sys_disable_interrupt>
	int c=0;
  ...
  800631:	eb 08                	jmp    80063b <atomic_getchar+0x1c>
	{
		c = sys_cgetc();
  800633:	e8 d8 14 00 00       	call   801b10 <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  80063f:	74 f2                	je     800633 <atomic_getchar+0x14>
	...
	sys_enable_interrupt();
  800641:	e8 cc 16 00 00       	call   801d12 <sys_enable_interrupt>
	return c;
...
libmain(int argc, char **argv)
{
  ...
  80065b:	e8 fd 14 00 00       	call   801b5d <sys_getenvindex>
  ...
  8006d5:	83 c4 10             	add    $0x10,%esp
	...
	sys_disable_interrupt();
  8006d8:	e8 1b 16 00 00       	call   801cf8 <sys_disable_interrupt>
	cprintf("**************************************\n");
  8006dd:	83 ec 0c             	sub    $0xc,%esp
  8006e0:	68 74 25 80 00       	push   $0x802574
  ...
  800706:	52                   	push   %edx
  800707:	50                   	push   %eax
  800708:	68 9c 25 80 00       	push   $0x80259c
  ...
  80072e:	52                   	push   %edx
  80072f:	50                   	push   %eax
  800730:	68 c4 25 80 00       	push   $0x8025c4
  ...
  80074b:	50                   	push   %eax
  80074c:	68 05 26 80 00       	push   $0x802605
  800751:	e8 e6 02 00 00       	call   800a3c <cprintf>
  800756:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  800759:	83 ec 0c             	sub    $0xc,%esp
  80075c:	68 74 25 80 00       	push   $0x802574
  800761:	e8 d6 02 00 00       	call   800a3c <cprintf>
  800766:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  800769:	e8 a4 15 00 00       	call   801d12 <sys_enable_interrupt>
...
destroy(void)
{
  ...
  800781:	e8 a3 13 00 00       	call   801b29 <sys_env_destroy>
...
exit(void)
{
  ...
  80078f:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  800792:	e8 f8 13 00 00       	call   801b8f <sys_env_exit>
}
  800797:	90                   	nop
  800798:	c9                   	leave  
  800799:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8007ba:	50                   	push   %eax
  8007bb:	68 1c 26 80 00       	push   $0x80261c
  ...
  8007d3:	50                   	push   %eax
  8007d4:	68 21 26 80 00       	push   $0x802621
  ...
  8007f8:	68 3d 26 80 00       	push   $0x80263d
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800824:	68 40 26 80 00       	push   $0x802640
  800829:	6a 26                	push   $0x26
  80082b:	68 8c 26 80 00       	push   $0x80268c
  ...
  8008ea:	68 98 26 80 00       	push   $0x802698
  8008ef:	6a 3a                	push   $0x3a
  8008f1:	68 8c 26 80 00       	push   $0x80268c
  ...
  800954:	68 ec 26 80 00       	push   $0x8026ec
  800959:	6a 44                	push   $0x44
  80095b:	68 8c 26 80 00       	push   $0x80268c
...
static void putch(int ch, struct printbuf *b) {
  ...
  8009ac:	51                   	push   %ecx
  8009ad:	52                   	push   %edx
  8009ae:	e8 34 11 00 00       	call   801ae7 <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800a24:	50                   	push   %eax
  800a25:	e8 bd 10 00 00       	call   801ae7 <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  800a6c:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800a6f:	e8 84 12 00 00       	call   801cf8 <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  800a8c:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  800a8f:	e8 7e 12 00 00       	call   801d12 <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800ad9:	e8 3e 16 00 00       	call   80211c <__udivdi3>
  ...
  800b27:	52                   	push   %edx
  800b28:	50                   	push   %eax
  800b29:	e8 fe 16 00 00       	call   80222c <__umoddi3>
  800b2e:	83 c4 10             	add    $0x10,%esp
  800b31:	05 54 29 80 00       	add    $0x802954,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800c84:	8b 04 85 78 29 80 00 	mov    0x802978(,%eax,4),%eax
  ...
  800d65:	8b 34 9d c0 27 80 00 	mov    0x8027c0(,%ebx,4),%esi
  800d6c:	85 f6                	test   %esi,%esi
  800d6e:	75 19                	jne    800d89 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800d70:	53                   	push   %ebx
  800d71:	68 65 29 80 00       	push   $0x802965
  ...
  800d84:	e9 49 02 00 00       	jmp    800fd2 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800d89:	56                   	push   %esi
  800d8a:	68 6e 29 80 00       	push   $0x80296e
  ...
  800db5:	75 05                	jne    800dbc <vprintfmt+0x1a6>
				p = "(null)";
  800db7:	be 71 29 80 00       	mov    $0x802971,%esi
			if (width > 0 && padc != '-')
...
void readline(const char *prompt, char* buf)
{
  ...
  8010d0:	68 d0 2a 80 00       	push   $0x802ad0
  ...
  801112:	68 d3 2a 80 00       	push   $0x802ad3
...
void atomic_readline(const char *prompt, char* buf)
{
  ...
  8011bf:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8011c2:	e8 31 0b 00 00       	call   801cf8 <sys_disable_interrupt>
	int i, c, echoing;
  ...
  8011d3:	68 d0 2a 80 00       	push   $0x802ad0
  ...
  801211:	68 d3 2a 80 00       	push   $0x802ad3
  801216:	e8 21 f8 ff ff       	call   800a3c <cprintf>
  80121b:	83 c4 10             	add    $0x10,%esp
			sys_enable_interrupt();
  80121e:	e8 ef 0a 00 00       	call   801d12 <sys_enable_interrupt>
			return;
  ...
  8012b3:	c6 00 00             	movb   $0x0,(%eax)
			sys_enable_interrupt();
  8012b6:	e8 57 0a 00 00       	call   801d12 <sys_enable_interrupt>
			return;
...
void* malloc(uint32 size)
{
  ...
  8019d5:	68 e4 2a 80 00       	push   $0x802ae4
  8019da:	6a 16                	push   $0x16
  8019dc:	68 09 2b 80 00       	push   $0x802b09
...
void free(void* virtual_address)
{
  ...
  8019ef:	68 18 2b 80 00       	push   $0x802b18
  8019f4:	6a 2e                	push   $0x2e
  8019f6:	68 09 2b 80 00       	push   $0x802b09
  8019fb:	e8 9a ed ff ff       	call   80079a <_panic>
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  801a09:	88 45 f4             	mov    %al,-0xc(%ebp)
	panic("this function is not required...!!");
  801a0c:	83 ec 04             	sub    $0x4,%esp
  801a0f:	68 3c 2b 80 00       	push   $0x802b3c
  801a14:	6a 3b                	push   $0x3b
  801a16:	68 09 2b 80 00       	push   $0x802b09
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  801a29:	68 3c 2b 80 00       	push   $0x802b3c
  801a2e:	6a 41                	push   $0x41
  801a30:	68 09 2b 80 00       	push   $0x802b09
...
void sfree(void* virtual_address)
{
  ...
  801a43:	68 3c 2b 80 00       	push   $0x802b3c
  801a48:	6a 47                	push   $0x47
  801a4a:	68 09 2b 80 00       	push   $0x802b09
  801a4f:	e8 46 ed ff ff       	call   80079a <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  801a5d:	68 3c 2b 80 00       	push   $0x802b3c
  801a62:	6a 4c                	push   $0x4c
  801a64:	68 09 2b 80 00       	push   $0x802b09
  801a69:	e8 2c ed ff ff       	call   80079a <_panic>
...
void expand(uint32 newSize)
{
  ...
  801a77:	68 3c 2b 80 00       	push   $0x802b3c
  801a7c:	6a 52                	push   $0x52
  801a7e:	68 09 2b 80 00       	push   $0x802b09
  801a83:	e8 12 ed ff ff       	call   80079a <_panic>
...
void shrink(uint32 newSize)
{
  ...
  801a91:	68 3c 2b 80 00       	push   $0x802b3c
  801a96:	6a 56                	push   $0x56
  801a98:	68 09 2b 80 00       	push   $0x802b09
  801a9d:	e8 f8 ec ff ff       	call   80079a <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  801aab:	68 3c 2b 80 00       	push   $0x802b3c
  801ab0:	6a 5b                	push   $0x5b
  801ab2:	68 09 2b 80 00       	push   $0x802b09
  801ab7:	e8 de ec ff ff       	call   80079a <_panic>
