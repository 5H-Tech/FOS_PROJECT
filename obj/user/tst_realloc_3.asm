...
void _main(void)
{
  ...
  80006f:	e8 af 1b 00 00       	call   801c23 <sys_calculate_free_frames>
  800074:	89 45 e8             	mov    %eax,-0x18(%ebp)
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
  800077:	e8 2a 1c 00 00       	call   801ca6 <sys_pf_calculate_allocated_pages>
  ...
  8000bf:	e8 5f 1b 00 00       	call   801c23 <sys_calculate_free_frames>
  ...
  8000e1:	e8 c0 1b 00 00       	call   801ca6 <sys_pf_calculate_allocated_pages>
  ...
  8000fd:	e8 a2 06 00 00       	call   8007a4 <_panic>
		...
		//Allocate 20 KB
		freeFrames = sys_calculate_free_frames() ;
  800102:	e8 1c 1b 00 00       	call   801c23 <sys_calculate_free_frames>
  800107:	89 45 e8             	mov    %eax,-0x18(%ebp)
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
  80010a:	e8 97 1b 00 00       	call   801ca6 <sys_pf_calculate_allocated_pages>
  ...
  800167:	e8 b7 1a 00 00       	call   801c23 <sys_calculate_free_frames>
  ...
  800189:	e8 18 1b 00 00       	call   801ca6 <sys_pf_calculate_allocated_pages>
  ...
  8001a5:	e8 fa 05 00 00       	call   8007a4 <_panic>
		...
		//Allocate 30 KB
		freeFrames = sys_calculate_free_frames() ;
  8001aa:	e8 74 1a 00 00       	call   801c23 <sys_calculate_free_frames>
  8001af:	89 45 e8             	mov    %eax,-0x18(%ebp)
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
  8001b2:	e8 ef 1a 00 00       	call   801ca6 <sys_pf_calculate_allocated_pages>
  ...
  80020d:	e8 92 05 00 00       	call   8007a4 <_panic>
		//if ((freeFrames - sys_calculate_free_frames()) != 256 ) panic("Wrong allocation: ");
		if((freeFrames - sys_calculate_free_frames()) != 0) panic("Wrong allocation: either extra pages are allocated in memory or pages not allocated correctly on PageFile");
  800212:	e8 0c 1a 00 00       	call   801c23 <sys_calculate_free_frames>
  ...
  800234:	e8 6d 1a 00 00       	call   801ca6 <sys_pf_calculate_allocated_pages>
  ...
  800250:	e8 4f 05 00 00       	call   8007a4 <_panic>
		...
		//Allocate 40 KB
		freeFrames = sys_calculate_free_frames() ;
  800255:	e8 c9 19 00 00       	call   801c23 <sys_calculate_free_frames>
  80025a:	89 45 e8             	mov    %eax,-0x18(%ebp)
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
  80025d:	e8 44 1a 00 00       	call   801ca6 <sys_pf_calculate_allocated_pages>
  ...
  8002b4:	e8 eb 04 00 00       	call   8007a4 <_panic>
		//if ((freeFrames - sys_calculate_free_frames()) != 256 ) panic("Wrong allocation: ");
		if((freeFrames - sys_calculate_free_frames()) != 0) panic("Wrong allocation: either extra pages are allocated in memory or pages not allocated correctly on PageFile");
  8002b9:	e8 65 19 00 00       	call   801c23 <sys_calculate_free_frames>
  ...
  8002db:	e8 c6 19 00 00       	call   801ca6 <sys_pf_calculate_allocated_pages>
  ...
  800420:	7c e1                	jl     800403 <_main+0x3cb>
		...
		freeFrames = sys_calculate_free_frames() ;
  800422:	e8 fc 17 00 00       	call   801c23 <sys_calculate_free_frames>
  800427:	89 45 e8             	mov    %eax,-0x18(%ebp)
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
  80042a:	e8 77 18 00 00       	call   801ca6 <sys_pf_calculate_allocated_pages>
  ...
  80044e:	52                   	push   %edx
  80044f:	50                   	push   %eax
  800450:	e8 ee 15 00 00       	call   801a43 <realloc>
  ...
  800489:	e8 18 18 00 00       	call   801ca6 <sys_pf_calculate_allocated_pages>
...
libmain(int argc, char **argv)
{
  ...
  800665:	e8 ee 14 00 00       	call   801b58 <sys_getenvindex>
  ...
  8006e2:	e8 0c 16 00 00       	call   801cf3 <sys_disable_interrupt>
	cprintf("**************************************\n");
  8006e7:	83 ec 0c             	sub    $0xc,%esp
  8006ea:	68 8c 25 80 00       	push   $0x80258c
  ...
  800710:	52                   	push   %edx
  800711:	50                   	push   %eax
  800712:	68 b4 25 80 00       	push   $0x8025b4
  ...
  800738:	52                   	push   %edx
  800739:	50                   	push   %eax
  80073a:	68 dc 25 80 00       	push   $0x8025dc
  ...
  800755:	50                   	push   %eax
  800756:	68 1d 26 80 00       	push   $0x80261d
  80075b:	e8 e6 02 00 00       	call   800a46 <cprintf>
  800760:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  800763:	83 ec 0c             	sub    $0xc,%esp
  800766:	68 8c 25 80 00       	push   $0x80258c
  80076b:	e8 d6 02 00 00       	call   800a46 <cprintf>
  800770:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  800773:	e8 95 15 00 00       	call   801d0d <sys_enable_interrupt>
...
destroy(void)
{
  ...
  80078b:	e8 94 13 00 00       	call   801b24 <sys_env_destroy>
...
exit(void)
{
  ...
  800799:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  80079c:	e8 e9 13 00 00       	call   801b8a <sys_env_exit>
}
  8007a1:	90                   	nop
  8007a2:	c9                   	leave  
  8007a3:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8007c4:	50                   	push   %eax
  8007c5:	68 34 26 80 00       	push   $0x802634
  ...
  8007dd:	50                   	push   %eax
  8007de:	68 39 26 80 00       	push   $0x802639
  ...
  800802:	68 55 26 80 00       	push   $0x802655
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  80082e:	68 58 26 80 00       	push   $0x802658
  800833:	6a 26                	push   $0x26
  800835:	68 a4 26 80 00       	push   $0x8026a4
  ...
  8008f4:	68 b0 26 80 00       	push   $0x8026b0
  8008f9:	6a 3a                	push   $0x3a
  8008fb:	68 a4 26 80 00       	push   $0x8026a4
  ...
  80095e:	68 04 27 80 00       	push   $0x802704
  800963:	6a 44                	push   $0x44
  800965:	68 a4 26 80 00       	push   $0x8026a4
...
static void putch(int ch, struct printbuf *b) {
  ...
  8009b6:	51                   	push   %ecx
  8009b7:	52                   	push   %edx
  8009b8:	e8 25 11 00 00       	call   801ae2 <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800a2e:	50                   	push   %eax
  800a2f:	e8 ae 10 00 00       	call   801ae2 <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  800a76:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800a79:	e8 75 12 00 00       	call   801cf3 <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  800a96:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  800a99:	e8 6f 12 00 00       	call   801d0d <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800ae3:	e8 2c 16 00 00       	call   802114 <__udivdi3>
  ...
  800b31:	52                   	push   %edx
  800b32:	50                   	push   %eax
  800b33:	e8 ec 16 00 00       	call   802224 <__umoddi3>
  800b38:	83 c4 10             	add    $0x10,%esp
  800b3b:	05 74 29 80 00       	add    $0x802974,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800c8e:	8b 04 85 98 29 80 00 	mov    0x802998(,%eax,4),%eax
  ...
  800d6f:	8b 34 9d e0 27 80 00 	mov    0x8027e0(,%ebx,4),%esi
  800d76:	85 f6                	test   %esi,%esi
  800d78:	75 19                	jne    800d93 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800d7a:	53                   	push   %ebx
  800d7b:	68 85 29 80 00       	push   $0x802985
  ...
  800d8e:	e9 49 02 00 00       	jmp    800fdc <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800d93:	56                   	push   %esi
  800d94:	68 8e 29 80 00       	push   $0x80298e
  ...
  800dbf:	75 05                	jne    800dc6 <vprintfmt+0x1a6>
				p = "(null)";
  800dc1:	be 91 29 80 00       	mov    $0x802991,%esi
			if (width > 0 && padc != '-')
...
void* malloc(uint32 size)
{
  ...
  801805:	e8 80 04 00 00       	call   801c8a <sys_allocateMem>
  ...
  801831:	89 14 85 60 50 80 00 	mov    %edx,0x805060(,%eax,4)
  ...
  80184f:	c7 04 85 c0 40 80 00 	movl   $0x1,0x8040c0(,%eax,4)
  801856:	01 00 00 00 
			sizeofarray++;
  ...
  801881:	50                   	push   %eax
  801882:	e8 03 04 00 00       	call   801c8a <sys_allocateMem>
  ...
  8018ae:	89 14 85 60 50 80 00 	mov    %edx,0x805060(,%eax,4)
  ...
  8018c9:	c7 04 85 c0 40 80 00 	movl   $0x1,0x8040c0(,%eax,4)
  8018d0:	01 00 00 00 
				sizeofarray++;
  ...
  801947:	8b 04 85 c0 40 80 00 	mov    0x8040c0(,%eax,4),%eax
  ...
  801997:	e8 ee 02 00 00       	call   801c8a <sys_allocateMem>
  80199c:	83 c4 10             	add    $0x10,%esp
				numOfPages[sizeofarray]=num;
  80199f:	a1 2c 30 80 00       	mov    0x80302c,%eax
  8019a4:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8019a7:	89 14 85 60 50 80 00 	mov    %edx,0x805060(,%eax,4)
				addresses[sizeofarray]=last_addres;
  ...
  8019c5:	c7 04 85 c0 40 80 00 	movl   $0x1,0x8040c0(,%eax,4)
  8019cc:	01 00 00 00 
				sizeofarray++;
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  8019f5:	68 f0 2a 80 00       	push   $0x802af0
  8019fa:	68 8d 00 00 00       	push   $0x8d
  8019ff:	68 13 2b 80 00       	push   $0x802b13
  801a04:	e8 9b ed ff ff       	call   8007a4 <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  801a12:	68 f0 2a 80 00       	push   $0x802af0
  801a17:	68 93 00 00 00       	push   $0x93
  801a1c:	68 13 2b 80 00       	push   $0x802b13
  801a21:	e8 7e ed ff ff       	call   8007a4 <_panic>
...
void sfree(void* virtual_address)
{
  ...
  801a2f:	68 f0 2a 80 00       	push   $0x802af0
  801a34:	68 99 00 00 00       	push   $0x99
  801a39:	68 13 2b 80 00       	push   $0x802b13
  801a3e:	e8 61 ed ff ff       	call   8007a4 <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  801a4c:	68 f0 2a 80 00       	push   $0x802af0
  801a51:	68 9e 00 00 00       	push   $0x9e
  801a56:	68 13 2b 80 00       	push   $0x802b13
  801a5b:	e8 44 ed ff ff       	call   8007a4 <_panic>
...
void expand(uint32 newSize)
{
  ...
  801a69:	68 f0 2a 80 00       	push   $0x802af0
  801a6e:	68 a4 00 00 00       	push   $0xa4
  801a73:	68 13 2b 80 00       	push   $0x802b13
...
void shrink(uint32 newSize)
{
  ...
  801a86:	68 f0 2a 80 00       	push   $0x802af0
  801a8b:	68 a8 00 00 00       	push   $0xa8
  801a90:	68 13 2b 80 00       	push   $0x802b13
  801a95:	e8 0a ed ff ff       	call   8007a4 <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  801aa3:	68 f0 2a 80 00       	push   $0x802af0
  801aa8:	68 ad 00 00 00       	push   $0xad
  801aad:	68 13 2b 80 00       	push   $0x802b13
  801ab2:	e8 ed ec ff ff       	call   8007a4 <_panic>
...
int sys_env_destroy(int32  envid)
{
  ...
  801b35:	e8 7d ff ff ff       	call   801ab7 <syscall>
  801b3a:	83 c4 18             	add    $0x18,%esp
}
  801b3d:	c9                   	leave  
  801b3e:	c3                   	ret    

00801b3f <sys_getenvid>:
...
int32 sys_getenvid(void)
{
  ...
  801b4c:	6a 02                	push   $0x2
  801b4e:	e8 64 ff ff ff       	call   801ab7 <syscall>
  801b53:	83 c4 18             	add    $0x18,%esp
}
  801b56:	c9                   	leave  
  801b57:	c3                   	ret    

00801b58 <sys_getenvindex>:
...
int32 sys_getenvindex(void)
{
  ...
  801b65:	6a 03                	push   $0x3
  801b67:	e8 4b ff ff ff       	call   801ab7 <syscall>
  801b6c:	83 c4 18             	add    $0x18,%esp
}
  801b6f:	c9                   	leave  
  801b70:	c3                   	ret    

00801b71 <sys_getparentenvid>:
...
int32 sys_getparentenvid(void)
{
  ...
  801b7e:	6a 04                	push   $0x4
  801b80:	e8 32 ff ff ff       	call   801ab7 <syscall>
  801b85:	83 c4 18             	add    $0x18,%esp
}
  801b88:	c9                   	leave  
  801b89:	c3                   	ret    

00801b8a <sys_env_exit>:
...
int __sys_allocate_page(void *va, int perm)
{
  ...
  801bb7:	e8 fb fe ff ff       	call   801ab7 <syscall>
  801bbc:	83 c4 18             	add    $0x18,%esp
}
  801bbf:	c9                   	leave  
  801bc0:	c3                   	ret    

00801bc1 <__sys_map_frame>:
...
int __sys_map_frame(int32 srcenv, void *srcva, int32 dstenv, void *dstva, int perm)
{
  ...
  801bc6:	8b 75 18             	mov    0x18(%ebp),%esi
  801bc9:	8b 5d 14             	mov    0x14(%ebp),%ebx
  ...
  801bd8:	52                   	push   %edx
  801bd9:	50                   	push   %eax
  801bda:	6a 08                	push   $0x8
  801bdc:	e8 d6 fe ff ff       	call   801ab7 <syscall>
...
int __sys_unmap_frame(int32 envid, void *va)
{
  ...
  801bfa:	52                   	push   %edx
  801bfb:	50                   	push   %eax
  801bfc:	6a 09                	push   $0x9
  801bfe:	e8 b4 fe ff ff       	call   801ab7 <syscall>
  801c03:	83 c4 18             	add    $0x18,%esp
}
  801c06:	c9                   	leave  
  801c07:	c3                   	ret    

00801c08 <sys_calculate_required_frames>:
...
uint32 sys_calculate_required_frames(uint32 start_virtual_address, uint32 size)
{
  ...
  801c17:	6a 0a                	push   $0xa
  801c19:	e8 99 fe ff ff       	call   801ab7 <syscall>
  801c1e:	83 c4 18             	add    $0x18,%esp
}
  801c21:	c9                   	leave  
  801c22:	c3                   	ret    

00801c23 <sys_calculate_free_frames>:
...
uint32 sys_calculate_free_frames()
{
  ...
  801c32:	e8 80 fe ff ff       	call   801ab7 <syscall>
  801c37:	83 c4 18             	add    $0x18,%esp
}
  801c3a:	c9                   	leave  
  801c3b:	c3                   	ret    

00801c3c <sys_calculate_modified_frames>:
uint32 sys_calculate_modified_frames()
{
  ...
  801c4b:	e8 67 fe ff ff       	call   801ab7 <syscall>
  801c50:	83 c4 18             	add    $0x18,%esp
}
  801c53:	c9                   	leave  
  801c54:	c3                   	ret    

00801c55 <sys_calculate_notmod_frames>:
...
uint32 sys_calculate_notmod_frames()
{
  ...
  801c64:	e8 4e fe ff ff       	call   801ab7 <syscall>
  801c69:	83 c4 18             	add    $0x18,%esp
}
  801c6c:	c9                   	leave  
  801c6d:	c3                   	ret    

00801c6e <sys_freeMem>:
...
void sys_freeMem(uint32 virtual_address, uint32 size)
{
  ...
  801c7d:	6a 11                	push   $0x11
  801c7f:	e8 33 fe ff ff       	call   801ab7 <syscall>
...
void sys_allocateMem(uint32 virtual_address, uint32 size)
{
  ...
  801c9b:	e8 17 fe ff ff       	call   801ab7 <syscall>
...
00801ca6 <sys_pf_calculate_allocated_pages>:
...
int sys_pf_calculate_allocated_pages()
{
  ...
  801cb5:	e8 fd fd ff ff       	call   801ab7 <syscall>
  801cba:	83 c4 18             	add    $0x18,%esp
}
  801cbd:	c9                   	leave  
  801cbe:	c3                   	ret    

00801cbf <sys_calculate_pages_tobe_removed_ready_exit>:
...
int sys_calculate_pages_tobe_removed_ready_exit(uint32 WS_or_MEMORY_flag)
{
  ...
  801ccd:	6a 0f                	push   $0xf
  801ccf:	e8 e3 fd ff ff       	call   801ab7 <syscall>
  801cd4:	83 c4 18             	add    $0x18,%esp
}
  801cd7:	c9                   	leave  
  801cd8:	c3                   	ret    

00801cd9 <sys_scarce_memory>:
...
void sys_scarce_memory()
{
  ...
  801ce8:	e8 ca fd ff ff       	call   801ab7 <syscall>
...
00801cf3 <sys_disable_interrupt>:
...
sys_disable_interrupt()
{
  ...
  801d00:	6a 14                	push   $0x14
  801d02:	e8 b0 fd ff ff       	call   801ab7 <syscall>
...
sys_enable_interrupt()
{
  ...
  801d1c:	e8 96 fd ff ff       	call   801ab7 <syscall>
...
sys_cputc(const char c)
{
  ...
  801d3f:	50                   	push   %eax
  801d40:	6a 16                	push   $0x16
  801d42:	e8 70 fd ff ff       	call   801ab7 <syscall>
...
sys_clear_ffl()
{
  ...
  801d5a:	6a 17                	push   $0x17
  801d5c:	e8 56 fd ff ff       	call   801ab7 <syscall>
...
sys_createSemaphore(char* semaphoreName, uint32 initialValue)
{
  ...
  801d76:	50                   	push   %eax
  801d77:	6a 18                	push   $0x18
  801d79:	e8 39 fd ff ff       	call   801ab7 <syscall>
  801d7e:	83 c4 18             	add    $0x18,%esp
}
  801d81:	c9                   	leave  
  801d82:	c3                   	ret    

00801d83 <sys_getSemaphoreValue>:
...
sys_getSemaphoreValue(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801d92:	52                   	push   %edx
  801d93:	50                   	push   %eax
  801d94:	6a 1b                	push   $0x1b
  801d96:	e8 1c fd ff ff       	call   801ab7 <syscall>
  801d9b:	83 c4 18             	add    $0x18,%esp
}
  801d9e:	c9                   	leave  
  801d9f:	c3                   	ret    

00801da0 <sys_waitSemaphore>:
...
sys_waitSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801daf:	52                   	push   %edx
  801db0:	50                   	push   %eax
  801db1:	6a 19                	push   $0x19
  801db3:	e8 ff fc ff ff       	call   801ab7 <syscall>
...
sys_signalSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801dcd:	52                   	push   %edx
  801dce:	50                   	push   %eax
  801dcf:	6a 1a                	push   $0x1a
  801dd1:	e8 e1 fc ff ff       	call   801ab7 <syscall>
...
00801ddc <sys_createSharedObject>:
...
sys_createSharedObject(char* shareName, uint32 size, uint8 isWritable, void* virtual_address)
{
  ...
  801de8:	8b 4d 14             	mov    0x14(%ebp),%ecx
  801deb:	0f b6 55 fc          	movzbl -0x4(%ebp),%edx
  ...
  801df9:	50                   	push   %eax
  801dfa:	6a 1c                	push   $0x1c
  801dfc:	e8 b6 fc ff ff       	call   801ab7 <syscall>
  801e01:	83 c4 18             	add    $0x18,%esp
}
  801e04:	c9                   	leave  
  801e05:	c3                   	ret    

00801e06 <sys_getSizeOfSharedObject>:
...
sys_getSizeOfSharedObject(int32 ownerID, char* shareName)
{
  ...
  801e15:	52                   	push   %edx
  801e16:	50                   	push   %eax
  801e17:	6a 1d                	push   $0x1d
  801e19:	e8 99 fc ff ff       	call   801ab7 <syscall>
  801e1e:	83 c4 18             	add    $0x18,%esp
}
  801e21:	c9                   	leave  
  801e22:	c3                   	ret    

00801e23 <sys_getSharedObject>:
//==========
...
sys_getSharedObject(int32 ownerID, char* shareName, void* virtual_address)
{
  ...
  801e34:	52                   	push   %edx
  801e35:	50                   	push   %eax
  801e36:	6a 1e                	push   $0x1e
  801e38:	e8 7a fc ff ff       	call   801ab7 <syscall>
  801e3d:	83 c4 18             	add    $0x18,%esp
}
  801e40:	c9                   	leave  
  801e41:	c3                   	ret    

00801e42 <sys_freeSharedObject>:
...
sys_freeSharedObject(int32 sharedObjectID, void *startVA)
{
  ...
  801e55:	e8 5d fc ff ff       	call   801ab7 <syscall>
  801e5a:	83 c4 18             	add    $0x18,%esp
}
  801e5d:	c9                   	leave  
  801e5e:	c3                   	ret    

00801e5f <sys_getMaxShares>:
...
uint32 	sys_getMaxShares()
{
  ...
  801e6e:	e8 44 fc ff ff       	call   801ab7 <syscall>
  801e73:	83 c4 18             	add    $0x18,%esp
}
  801e76:	c9                   	leave  
  801e77:	c3                   	ret    

00801e78 <sys_create_env>:
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int LRU_second_list_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  801e89:	50                   	push   %eax
  801e8a:	6a 21                	push   $0x21
  801e8c:	e8 26 fc ff ff       	call   801ab7 <syscall>
  801e91:	83 c4 18             	add    $0x18,%esp
}
  801e94:	c9                   	leave  
  801e95:	c3                   	ret    

00801e96 <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  801ea7:	e8 0b fc ff ff       	call   801ab7 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  801ec3:	e8 ef fb ff ff       	call   801ab7 <syscall>
...
sys_get_virtual_time()
{
  ...
  801ed7:	8d 50 04             	lea    0x4(%eax),%edx
  801eda:	8d 45 f8             	lea    -0x8(%ebp),%eax
  ...
  801ee7:	e8 cb fb ff ff       	call   801ab7 <syscall>
  801eec:	83 c4 18             	add    $0x18,%esp
	return result;
  801eef:	8b 4d 08             	mov    0x8(%ebp),%ecx
  801ef2:	8b 45 f8             	mov    -0x8(%ebp),%eax
  801ef5:	8b 55 fc             	mov    -0x4(%ebp),%edx
  801ef8:	89 01                	mov    %eax,(%ecx)
  801efa:	89 51 04             	mov    %edx,0x4(%ecx)
}
  801efd:	8b 45 08             	mov    0x8(%ebp),%eax
  801f00:	c9                   	leave  
  801f01:	c2 04 00             	ret    $0x4

00801f04 <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  801f14:	6a 13                	push   $0x13
  801f16:	e8 9c fb ff ff       	call   801ab7 <syscall>
...
uint32 sys_rcr2()
{
  ...
  801f30:	e8 82 fb ff ff       	call   801ab7 <syscall>
  801f35:	83 c4 18             	add    $0x18,%esp
}
  801f38:	c9                   	leave  
  801f39:	c3                   	ret    

00801f3a <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  801f46:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  801f4a:	6a 00                	push   $0x0
  801f4c:	6a 00                	push   $0x0
  801f4e:	6a 00                	push   $0x0
  801f50:	6a 00                	push   $0x0
  801f52:	50                   	push   %eax
  801f53:	6a 26                	push   $0x26
  801f55:	e8 5d fb ff ff       	call   801ab7 <syscall>
...
void rsttst()
{
  ...
  801f6d:	6a 28                	push   $0x28
  801f6f:	e8 43 fb ff ff       	call   801ab7 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801f86:	8b 55 18             	mov    0x18(%ebp),%edx
  ...
  801f9a:	e8 18 fb ff ff       	call   801ab7 <syscall>
...
void chktst(uint32 n)
{
  ...
  801fb3:	6a 29                	push   $0x29
  801fb5:	e8 fd fa ff ff       	call   801ab7 <syscall>
...
void inctst()
{
  ...
  801fcd:	6a 2a                	push   $0x2a
  801fcf:	e8 e3 fa ff ff       	call   801ab7 <syscall>
...
uint32 gettst()
{
  ...
  801fe7:	6a 2b                	push   $0x2b
  801fe9:	e8 c9 fa ff ff       	call   801ab7 <syscall>
  801fee:	83 c4 18             	add    $0x18,%esp
}
  801ff1:	c9                   	leave  
  801ff2:	c3                   	ret    

00801ff3 <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  802005:	e8 ad fa ff ff       	call   801ab7 <syscall>
  80200a:	83 c4 18             	add    $0x18,%esp
  80200d:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  802010:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  802014:	75 07                	jne    80201d <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  802016:	b8 01 00 00 00       	mov    $0x1,%eax
  80201b:	eb 05                	jmp    802022 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
00802024 <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  802036:	e8 7c fa ff ff       	call   801ab7 <syscall>
  80203b:	83 c4 18             	add    $0x18,%esp
  80203e:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  802041:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  802045:	75 07                	jne    80204e <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  802047:	b8 01 00 00 00       	mov    $0x1,%eax
  80204c:	eb 05                	jmp    802053 <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
00802055 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  802067:	e8 4b fa ff ff       	call   801ab7 <syscall>
  80206c:	83 c4 18             	add    $0x18,%esp
  80206f:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  802072:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  802076:	75 07                	jne    80207f <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  802078:	b8 01 00 00 00       	mov    $0x1,%eax
  80207d:	eb 05                	jmp    802084 <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
00802086 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  802098:	e8 1a fa ff ff       	call   801ab7 <syscall>
  80209d:	83 c4 18             	add    $0x18,%esp
  8020a0:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  8020a3:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  8020a7:	75 07                	jne    8020b0 <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  8020a9:	b8 01 00 00 00       	mov    $0x1,%eax
  8020ae:	eb 05                	jmp    8020b5 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
008020b7 <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  8020c5:	6a 2d                	push   $0x2d
  8020c7:	e8 eb f9 ff ff       	call   801ab7 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  8020ea:	e8 c8 f9 ff ff       	call   801ab7 <syscall>
...
008020f7 <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  802106:	52                   	push   %edx
  802107:	50                   	push   %eax
  802108:	6a 2f                	push   $0x2f
  80210a:	e8 a8 f9 ff ff       	call   801ab7 <syscall>
