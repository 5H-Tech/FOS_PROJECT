...
void free(void* virtual_address)
{
  ...
  8021be:	8b 04 85 c0 50 80 00 	mov    0x8050c0(,%eax,4),%eax
  ...
  8021ef:	8b 04 85 60 60 80 00 	mov    0x806060(,%eax,4),%eax
  ...
  802211:	c7 04 85 c0 50 80 00 	movl   $0x0,0x8050c0(,%eax,4)
  802218:	00 00 00 00 
    	changes++;
