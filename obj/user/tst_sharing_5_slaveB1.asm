...
_main(void)
{
  ...
  80009f:	68 99 20 80 00       	push   $0x802099
  8000a4:	50                   	push   %eax
  ...
  8000f9:	68 e4 20 80 00       	push   $0x8020e4
  ...
  80011c:	68 fc 20 80 00       	push   $0x8020fc
...
libmain(int argc, char **argv)
{
  ...
  8001e6:	52                   	push   %edx
  8001e7:	50                   	push   %eax
  8001e8:	68 e4 21 80 00       	push   $0x8021e4
  ...
  80020e:	52                   	push   %edx
  80020f:	50                   	push   %eax
  800210:	68 0c 22 80 00       	push   $0x80220c
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80029a:	50                   	push   %eax
  80029b:	68 64 22 80 00       	push   $0x802264
  ...
  8002b3:	50                   	push   %eax
  8002b4:	68 69 22 80 00       	push   $0x802269
  ...
  8002d8:	68 85 22 80 00       	push   $0x802285
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800304:	68 88 22 80 00       	push   $0x802288
  800309:	6a 26                	push   $0x26
  80030b:	68 d4 22 80 00       	push   $0x8022d4
  ...
  8003ca:	68 e0 22 80 00       	push   $0x8022e0
  8003cf:	6a 3a                	push   $0x3a
  8003d1:	68 d4 22 80 00       	push   $0x8022d4
  ...
  800434:	68 34 23 80 00       	push   $0x802334
  800439:	6a 44                	push   $0x44
  80043b:	68 d4 22 80 00       	push   $0x8022d4
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800611:	05 94 25 80 00       	add    $0x802594,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800764:	8b 04 85 b8 25 80 00 	mov    0x8025b8(,%eax,4),%eax
  ...
  800845:	8b 34 9d 00 24 80 00 	mov    0x802400(,%ebx,4),%esi
  80084c:	85 f6                	test   %esi,%esi
  80084e:	75 19                	jne    800869 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800850:	53                   	push   %ebx
  800851:	68 a5 25 80 00       	push   $0x8025a5
  ...
  800864:	e9 49 02 00 00       	jmp    800ab2 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800869:	56                   	push   %esi
  80086a:	68 ae 25 80 00       	push   $0x8025ae
  ...
  800895:	75 05                	jne    80089c <vprintfmt+0x1a6>
				p = "(null)";
  800897:	be b1 25 80 00       	mov    $0x8025b1,%esi
			if (width > 0 && padc != '-')
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable) {
  ...
  801616:	68 10 27 80 00       	push   $0x802710
  80161b:	68 b6 00 00 00       	push   $0xb6
  801620:	68 33 27 80 00       	push   $0x802733
...
void* sget(int32 ownerEnvID, char *sharedVarName) {
  ...
  801633:	68 10 27 80 00       	push   $0x802710
  801638:	68 bb 00 00 00       	push   $0xbb
  80163d:	68 33 27 80 00       	push   $0x802733
...
void sfree(void* virtual_address) {
  ...
  801650:	68 10 27 80 00       	push   $0x802710
  801655:	68 c0 00 00 00       	push   $0xc0
  80165a:	68 33 27 80 00       	push   $0x802733
...
void *realloc(void *virtual_address, uint32 new_size) {
  ...
  80166d:	68 10 27 80 00       	push   $0x802710
  801672:	68 c4 00 00 00       	push   $0xc4
  801677:	68 33 27 80 00       	push   $0x802733
...
void expand(uint32 newSize) {
  ...
  80168a:	68 10 27 80 00       	push   $0x802710
  80168f:	68 c9 00 00 00       	push   $0xc9
  801694:	68 33 27 80 00       	push   $0x802733
...
void shrink(uint32 newSize) {
  ...
  8016a7:	68 10 27 80 00       	push   $0x802710
  8016ac:	68 cc 00 00 00       	push   $0xcc
  8016b1:	68 33 27 80 00       	push   $0x802733
...
void freeHeap(void* virtual_address) {
  ...
  8016c4:	68 10 27 80 00       	push   $0x802710
  8016c9:	68 d0 00 00 00       	push   $0xd0
  8016ce:	68 33 27 80 00       	push   $0x802733
