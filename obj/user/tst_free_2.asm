...
//		}
  ...
  800078:	e8 bc 22 00 00       	call   802339 <sys_bypassPageFault>
  ...
  80008e:	e8 8f 1f 00 00       	call   802022 <sys_calculate_free_frames>
  ...
  8000bb:	e8 62 1f 00 00       	call   802022 <sys_calculate_free_frames>
  8000c0:	89 45 e4             	mov    %eax,-0x1c(%ebp)
		int usedDiskPages = sys_pf_calculate_allocated_pages() ;
  8000c3:	e8 dd 1f 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  8000fd:	e8 a3 1f 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  80012f:	e8 ee 1e 00 00       	call   802022 <sys_calculate_free_frames>
  800134:	89 45 e4             	mov    %eax,-0x1c(%ebp)
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
  800137:	e8 69 1f 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  800178:	e8 93 09 00 00       	call   800b10 <_panic>
		if ((sys_pf_calculate_allocated_pages() - usedDiskPages) != 512) panic("Extra or less pages are allocated in PageFile");
  80017d:	e8 23 1f 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  8001a9:	89 85 38 ff ff ff    	mov    %eax,-0xc8(%ebp)
		...
		freeFrames = sys_calculate_free_frames() ;
  8001af:	e8 6e 1e 00 00       	call   802022 <sys_calculate_free_frames>
  8001b4:	89 45 e4             	mov    %eax,-0x1c(%ebp)
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
  8001b7:	e8 e9 1e 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  8001ff:	e8 a1 1e 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  80022a:	89 85 3c ff ff ff    	mov    %eax,-0xc4(%ebp)
		...
		freeFrames = sys_calculate_free_frames() ;
  800230:	e8 ed 1d 00 00       	call   802022 <sys_calculate_free_frames>
  800235:	89 45 e4             	mov    %eax,-0x1c(%ebp)
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
  800238:	e8 68 1e 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  800285:	e8 86 08 00 00       	call   800b10 <_panic>
		if ((sys_pf_calculate_allocated_pages() - usedDiskPages) != 1) panic("Extra or less pages are allocated in PageFile");
  80028a:	e8 16 1e 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  8002b5:	89 85 40 ff ff ff    	mov    %eax,-0xc0(%ebp)
		...
		freeFrames = sys_calculate_free_frames() ;
  8002bb:	e8 62 1d 00 00       	call   802022 <sys_calculate_free_frames>
  8002c0:	89 45 e4             	mov    %eax,-0x1c(%ebp)
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
  8002c3:	e8 dd 1d 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  800319:	e8 87 1d 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  800348:	89 85 44 ff ff ff    	mov    %eax,-0xbc(%ebp)
		...
		freeFrames = sys_calculate_free_frames() ;
  80034e:	e8 cf 1c 00 00       	call   802022 <sys_calculate_free_frames>
  800353:	89 45 e4             	mov    %eax,-0x1c(%ebp)
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
  800356:	e8 4a 1d 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  8003ab:	e8 f5 1c 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  8003ef:	89 85 48 ff ff ff    	mov    %eax,-0xb8(%ebp)
		...
		freeFrames = sys_calculate_free_frames() ;
  8003f5:	e8 28 1c 00 00       	call   802022 <sys_calculate_free_frames>
  8003fa:	89 45 e4             	mov    %eax,-0x1c(%ebp)
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
  8003fd:	e8 a3 1c 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  800450:	e8 bb 06 00 00       	call   800b10 <_panic>
		if ((sys_pf_calculate_allocated_pages() - usedDiskPages) != 512) panic("Extra or less pages are allocated in PageFile");
  800455:	e8 4b 1c 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  800481:	89 85 4c ff ff ff    	mov    %eax,-0xb4(%ebp)
	...
	{
		int freeFrames = sys_calculate_free_frames() ;
  800487:	e8 96 1b 00 00       	call   802022 <sys_calculate_free_frames>
  80048c:	89 45 dc             	mov    %eax,-0x24(%ebp)
		int usedDiskPages = sys_pf_calculate_allocated_pages() ;
  80048f:	e8 11 1c 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  8004a6:	e8 fa 1b 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  8004d9:	e8 42 1e 00 00       	call   802320 <sys_rcr2>
  ...
  80050b:	e8 10 1e 00 00       	call   802320 <sys_rcr2>
  ...
  800530:	e8 db 05 00 00       	call   800b10 <_panic>
		...
		freeFrames = sys_calculate_free_frames() ;
  800535:	e8 e8 1a 00 00       	call   802022 <sys_calculate_free_frames>
  80053a:	89 45 dc             	mov    %eax,-0x24(%ebp)
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
  80053d:	e8 63 1b 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  800551:	83 c4 10             	add    $0x10,%esp
		if ((usedDiskPages - sys_pf_calculate_allocated_pages()) != 512) panic("Wrong free: Extra or less pages are removed from PageFile");
  800554:	e8 4c 1b 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  800584:	c6 00 0a             	movb   $0xa,(%eax)
		if (sys_rcr2() != (uint32)&(byteArr[0])) panic("Free: successful access to freed space!! it should not be succeeded");
  800587:	e8 94 1d 00 00       	call   802320 <sys_rcr2>
  ...
  8005b9:	e8 62 1d 00 00       	call   802320 <sys_rcr2>
  ...
  8005de:	e8 2d 05 00 00       	call   800b10 <_panic>
		...
		freeFrames = sys_calculate_free_frames() ;
  8005e3:	e8 3a 1a 00 00       	call   802022 <sys_calculate_free_frames>
  8005e8:	89 45 dc             	mov    %eax,-0x24(%ebp)
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
  8005eb:	e8 b5 1a 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  800602:	e8 9e 1a 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  800633:	c6 00 0a             	movb   $0xa,(%eax)
		if (sys_rcr2() != (uint32)&(byteArr[0])) panic("Free: successful access to freed space!! it should not be succeeded");
  800636:	e8 e5 1c 00 00       	call   802320 <sys_rcr2>
  ...
  80066b:	e8 b0 1c 00 00       	call   802320 <sys_rcr2>
  ...
  800693:	e8 78 04 00 00       	call   800b10 <_panic>
		...
		freeFrames = sys_calculate_free_frames() ;
  800698:	e8 85 19 00 00       	call   802022 <sys_calculate_free_frames>
  80069d:	89 45 dc             	mov    %eax,-0x24(%ebp)
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
  8006a0:	e8 00 1a 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  8006b4:	83 c4 10             	add    $0x10,%esp
		if ((usedDiskPages - sys_pf_calculate_allocated_pages()) != 1) panic("Wrong free: Extra or less pages are removed from PageFile");
  8006b7:	e8 e9 19 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  8006e8:	c6 00 0a             	movb   $0xa,(%eax)
		if (sys_rcr2() != (uint32)&(byteArr[0])) panic("Free: successful access to freed space!! it should not be succeeded");
  8006eb:	e8 30 1c 00 00       	call   802320 <sys_rcr2>
  ...
  800720:	e8 fb 1b 00 00       	call   802320 <sys_rcr2>
  ...
  800748:	e8 c3 03 00 00       	call   800b10 <_panic>
		...
		freeFrames = sys_calculate_free_frames() ;
  80074d:	e8 d0 18 00 00       	call   802022 <sys_calculate_free_frames>
  800752:	89 45 dc             	mov    %eax,-0x24(%ebp)
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
  800755:	e8 4b 19 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  80076c:	e8 34 19 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  80079d:	c6 00 0a             	movb   $0xa,(%eax)
		if (sys_rcr2() != (uint32)&(byteArr[0])) panic("Free: successful access to freed space!! it should not be succeeded");
  8007a0:	e8 7b 1b 00 00       	call   802320 <sys_rcr2>
  ...
  8007d5:	e8 46 1b 00 00       	call   802320 <sys_rcr2>
  ...
  8007fd:	e8 0e 03 00 00       	call   800b10 <_panic>
		...
		freeFrames = sys_calculate_free_frames() ;
  800802:	e8 1b 18 00 00       	call   802022 <sys_calculate_free_frames>
  800807:	89 45 dc             	mov    %eax,-0x24(%ebp)
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
  80080a:	e8 96 18 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  800821:	e8 7f 18 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  800866:	c6 00 0a             	movb   $0xa,(%eax)
		if (sys_rcr2() != (uint32)&(byteArr[0])) panic("Free: successful access to freed space!! it should not be succeeded");
  800869:	e8 b2 1a 00 00       	call   802320 <sys_rcr2>
  ...
  80089e:	e8 7d 1a 00 00       	call   802320 <sys_rcr2>
  ...
  8008c6:	e8 45 02 00 00       	call   800b10 <_panic>
		...
		freeFrames = sys_calculate_free_frames() ;
  8008cb:	e8 52 17 00 00       	call   802022 <sys_calculate_free_frames>
  8008d0:	89 45 dc             	mov    %eax,-0x24(%ebp)
		usedDiskPages = sys_pf_calculate_allocated_pages() ;
  8008d3:	e8 cd 17 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  8008e7:	83 c4 10             	add    $0x10,%esp
		if ((usedDiskPages - sys_pf_calculate_allocated_pages()) != 512) panic("Wrong free: Extra or less pages are removed from PageFile");
  8008ea:	e8 b6 17 00 00       	call   8020a5 <sys_pf_calculate_allocated_pages>
  ...
  80091d:	c6 00 0a             	movb   $0xa,(%eax)
		if (sys_rcr2() != (uint32)&(byteArr[0])) panic("Free: successful access to freed space!! it should not be succeeded");
  800920:	e8 fb 19 00 00       	call   802320 <sys_rcr2>
  ...
  800955:	e8 c6 19 00 00       	call   802320 <sys_rcr2>
  ...
  800982:	e8 9b 16 00 00       	call   802022 <sys_calculate_free_frames>
  ...
  8009ad:	e8 87 19 00 00       	call   802339 <sys_bypassPageFault>
...
libmain(int argc, char **argv)
{
  ...
  8009d1:	e8 81 15 00 00       	call   801f57 <sys_getenvindex>
  ...
  800a4e:	e8 9f 16 00 00       	call   8020f2 <sys_disable_interrupt>
	cprintf("**************************************\n");
  ...
  800adf:	e8 28 16 00 00       	call   80210c <sys_enable_interrupt>
...
destroy(void)
{
  ...
  800af7:	e8 27 14 00 00       	call   801f23 <sys_env_destroy>
...
exit(void)
{
  ...
  800b05:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  800b08:	e8 7c 14 00 00       	call   801f89 <sys_env_exit>
}
  800b0d:	90                   	nop
  800b0e:	c9                   	leave  
  800b0f:	c3                   	ret    
...
static void putch(int ch, struct printbuf *b) {
  ...
  800d22:	51                   	push   %ecx
  800d23:	52                   	push   %edx
  800d24:	e8 b8 11 00 00       	call   801ee1 <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800d9a:	50                   	push   %eax
  800d9b:	e8 41 11 00 00       	call   801ee1 <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  800de2:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800de5:	e8 08 13 00 00       	call   8020f2 <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  800e02:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  800e05:	e8 02 13 00 00       	call   80210c <sys_enable_interrupt>
	return cnt;
...
void free(void* virtual_address)
{
  ...
  801dd3:	00 00 00 00 
    	changes++;
  801dd7:	a1 28 30 80 00       	mov    0x803028,%eax
  801ddc:	40                   	inc    %eax
  801ddd:	a3 28 30 80 00       	mov    %eax,0x803028
    }
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  801df4:	68 b0 2e 80 00       	push   $0x802eb0
  801df9:	68 9f 00 00 00       	push   $0x9f
  801dfe:	68 d3 2e 80 00       	push   $0x802ed3
  801e03:	e8 08 ed ff ff       	call   800b10 <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  801e11:	68 b0 2e 80 00       	push   $0x802eb0
  801e16:	68 a5 00 00 00       	push   $0xa5
  801e1b:	68 d3 2e 80 00       	push   $0x802ed3
  801e20:	e8 eb ec ff ff       	call   800b10 <_panic>
...
void sfree(void* virtual_address)
{
  ...
  801e2e:	68 b0 2e 80 00       	push   $0x802eb0
  801e33:	68 ab 00 00 00       	push   $0xab
  801e38:	68 d3 2e 80 00       	push   $0x802ed3
  801e3d:	e8 ce ec ff ff       	call   800b10 <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  801e4b:	68 b0 2e 80 00       	push   $0x802eb0
  801e50:	68 b0 00 00 00       	push   $0xb0
  801e55:	68 d3 2e 80 00       	push   $0x802ed3
  801e5a:	e8 b1 ec ff ff       	call   800b10 <_panic>
...
void expand(uint32 newSize)
{
  ...
  801e68:	68 b0 2e 80 00       	push   $0x802eb0
  801e6d:	68 b6 00 00 00       	push   $0xb6
  801e72:	68 d3 2e 80 00       	push   $0x802ed3
  801e77:	e8 94 ec ff ff       	call   800b10 <_panic>
...
void shrink(uint32 newSize)
{
  ...
  801e85:	68 b0 2e 80 00       	push   $0x802eb0
  801e8a:	68 ba 00 00 00       	push   $0xba
  801e8f:	68 d3 2e 80 00       	push   $0x802ed3
  801e94:	e8 77 ec ff ff       	call   800b10 <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  801ea2:	68 b0 2e 80 00       	push   $0x802eb0
  801ea7:	68 bf 00 00 00       	push   $0xbf
  801eac:	68 d3 2e 80 00       	push   $0x802ed3
  801eb1:	e8 5a ec ff ff       	call   800b10 <_panic>
