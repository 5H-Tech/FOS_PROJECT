...
void free(void* virtual_address)
{
  ...
  801efa:	8b 04 85 c0 50 80 00 	mov    0x8050c0(,%eax,4),%eax
  ...
  801f2b:	8b 04 85 60 60 80 00 	mov    0x806060(,%eax,4),%eax
  ...
  801f4d:	c7 04 85 c0 50 80 00 	movl   $0x0,0x8050c0(,%eax,4)
  801f54:	00 00 00 00 
    	changes++;
