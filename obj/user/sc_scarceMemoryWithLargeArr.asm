...
void _main(void)
{
  ...
  800046:	e8 a4 19 00 00       	call   8019ef <env_sleep>
...
libmain(int argc, char **argv)
{
  ...
  8000ac:	e8 82 13 00 00       	call   801433 <sys_getenvindex>
  ...
  800129:	e8 a0 14 00 00       	call   8015ce <sys_disable_interrupt>
	cprintf("**************************************\n");
  80012e:	83 ec 0c             	sub    $0xc,%esp
  800131:	68 4c 1f 80 00       	push   $0x801f4c
  ...
  80017f:	52                   	push   %edx
  800180:	50                   	push   %eax
  800181:	68 9c 1f 80 00       	push   $0x801f9c
  ...
  80019c:	50                   	push   %eax
  80019d:	68 dd 1f 80 00       	push   $0x801fdd
  8001a2:	e8 18 01 00 00       	call   8002bf <cprintf>
  8001a7:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  8001aa:	83 ec 0c             	sub    $0xc,%esp
  8001ad:	68 4c 1f 80 00       	push   $0x801f4c
  8001b2:	e8 08 01 00 00       	call   8002bf <cprintf>
  8001b7:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  8001ba:	e8 29 14 00 00       	call   8015e8 <sys_enable_interrupt>
...
destroy(void)
{
  ...
  8001d2:	e8 28 12 00 00       	call   8013ff <sys_env_destroy>
...
exit(void)
{
  ...
  8001e0:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  8001e3:	e8 7d 12 00 00       	call   801465 <sys_env_exit>
}
  8001e8:	90                   	nop
  8001e9:	c9                   	leave  
  8001ea:	c3                   	ret    
...
static void putch(int ch, struct printbuf *b) {
  ...
  80022f:	51                   	push   %ecx
  800230:	52                   	push   %edx
  800231:	e8 87 11 00 00       	call   8013bd <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  8002a7:	50                   	push   %eax
  8002a8:	e8 10 11 00 00       	call   8013bd <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  8002ef:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8002f2:	e8 d7 12 00 00       	call   8015ce <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  80030f:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  800312:	e8 d1 12 00 00       	call   8015e8 <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80035c:	e8 13 19 00 00       	call   801c74 <__udivdi3>
  ...
  8003aa:	52                   	push   %edx
  8003ab:	50                   	push   %eax
  8003ac:	e8 d3 19 00 00       	call   801d84 <__umoddi3>
  8003b1:	83 c4 10             	add    $0x10,%esp
  8003b4:	05 14 22 80 00       	add    $0x802214,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800507:	8b 04 85 38 22 80 00 	mov    0x802238(,%eax,4),%eax
  ...
  8005e8:	8b 34 9d 80 20 80 00 	mov    0x802080(,%ebx,4),%esi
  8005ef:	85 f6                	test   %esi,%esi
  8005f1:	75 19                	jne    80060c <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  8005f3:	53                   	push   %ebx
  8005f4:	68 25 22 80 00       	push   $0x802225
  ...
  800607:	e9 49 02 00 00       	jmp    800855 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  80060c:	56                   	push   %esi
  80060d:	68 2e 22 80 00       	push   $0x80222e
  ...
  800638:	75 05                	jne    80063f <vprintfmt+0x1a6>
				p = "(null)";
  80063a:	be 31 22 80 00       	mov    $0x802231,%esi
			if (width > 0 && padc != '-')
...
//		return (void*) return_addres;
	//} else {
	if (changes == 0) {
  801067:	a1 28 30 80 00       	mov    0x803028,%eax
  80106c:	85 c0                	test   %eax,%eax
  80106e:	75 71                	jne    8010e1 <malloc+0x98>
		sys_allocateMem(last_addres, size);
  801070:	a1 04 30 80 00       	mov    0x803004,%eax
  801075:	83 ec 08             	sub    $0x8,%esp
  801078:	ff 75 08             	pushl  0x8(%ebp)
  80107b:	50                   	push   %eax
  80107c:	e8 e4 04 00 00       	call   801565 <sys_allocateMem>
  801081:	83 c4 10             	add    $0x10,%esp
		return_addres = last_addres;
  801084:	a1 04 30 80 00       	mov    0x803004,%eax
  801089:	89 45 d8             	mov    %eax,-0x28(%ebp)
		last_addres += num * PAGE_SIZE;
  80108c:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80108f:	c1 e0 0c             	shl    $0xc,%eax
  801092:	89 c2                	mov    %eax,%edx
  801094:	a1 04 30 80 00       	mov    0x803004,%eax
  801099:	01 d0                	add    %edx,%eax
  80109b:	a3 04 30 80 00       	mov    %eax,0x803004
		numOfPages[sizeofarray] = num;
  8010a0:	a1 2c 30 80 00       	mov    0x80302c,%eax
  8010a5:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8010a8:	89 14 85 40 66 cc 06 	mov    %edx,0x6cc6640(,%eax,4)
		addresses[sizeofarray] = return_addres;
  8010af:	a1 2c 30 80 00       	mov    0x80302c,%eax
  8010b4:	8b 55 d8             	mov    -0x28(%ebp),%edx
  8010b7:	89 14 85 40 31 c0 06 	mov    %edx,0x6c03140(,%eax,4)
		changed[sizeofarray] = 1;
  8010be:	a1 2c 30 80 00       	mov    0x80302c,%eax
  8010c3:	c7 04 85 c0 4b c6 06 	movl   $0x1,0x6c64bc0(,%eax,4)
  8010ca:	01 00 00 00 
		sizeofarray++;
  8010ce:	a1 2c 30 80 00       	mov    0x80302c,%eax
  8010d3:	40                   	inc    %eax
  8010d4:	a3 2c 30 80 00       	mov    %eax,0x80302c
		return (void*) return_addres;
  8010d9:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8010dc:	e9 f7 00 00 00       	jmp    8011d8 <malloc+0x18f>
	} else {
		int count = 0;
  8010e1:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
		int min = 1000;
  8010e8:	c7 45 ec e8 03 00 00 	movl   $0x3e8,-0x14(%ebp)
		int index = -1;
  8010ef:	c7 45 e8 ff ff ff ff 	movl   $0xffffffff,-0x18(%ebp)
		uint32 min_addresss;
		for (uint32 i = USER_HEAP_START; i < USER_HEAP_MAX; i += PAGE_SIZE)
  8010f6:	c7 45 e0 00 00 00 80 	movl   $0x80000000,-0x20(%ebp)
  8010fd:	eb 7c                	jmp    80117b <malloc+0x132>
		{
			uint32 *pg = NULL;
  8010ff:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
			for (int j = 0; j < sizeofarray; j++) {
  801106:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
  80110d:	eb 1a                	jmp    801129 <malloc+0xe0>
				if (addresses[j] == i) {
  80110f:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801112:	8b 04 85 40 31 c0 06 	mov    0x6c03140(,%eax,4),%eax
  801119:	3b 45 e0             	cmp    -0x20(%ebp),%eax
  80111c:	75 08                	jne    801126 <malloc+0xdd>
					index = j;
  80111e:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801121:	89 45 e8             	mov    %eax,-0x18(%ebp)
					break;
  801124:	eb 0d                	jmp    801133 <malloc+0xea>
		int index = -1;
		uint32 min_addresss;
		for (uint32 i = USER_HEAP_START; i < USER_HEAP_MAX; i += PAGE_SIZE)
		{
			uint32 *pg = NULL;
			for (int j = 0; j < sizeofarray; j++) {
  801126:	ff 45 dc             	incl   -0x24(%ebp)
  801129:	a1 2c 30 80 00       	mov    0x80302c,%eax
  80112e:	39 45 dc             	cmp    %eax,-0x24(%ebp)
  801131:	7c dc                	jl     80110f <malloc+0xc6>
					index = j;
					break;
				}
			}
			...
			if (index == -1) {
  801133:	83 7d e8 ff          	cmpl   $0xffffffff,-0x18(%ebp)
  801137:	75 05                	jne    80113e <malloc+0xf5>
				count++;
  801139:	ff 45 f0             	incl   -0x10(%ebp)
  80113c:	eb 36                	jmp    801174 <malloc+0x12b>
			} else {
				if (changed[index] == 0) {
  80113e:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801141:	8b 04 85 c0 4b c6 06 	mov    0x6c64bc0(,%eax,4),%eax
  801148:	85 c0                	test   %eax,%eax
  80114a:	75 05                	jne    801151 <malloc+0x108>
					count++;
  80114c:	ff 45 f0             	incl   -0x10(%ebp)
  80114f:	eb 23                	jmp    801174 <malloc+0x12b>
				} else {
					if (count < min && count >= num) {
  801151:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801154:	3b 45 ec             	cmp    -0x14(%ebp),%eax
  801157:	7d 14                	jge    80116d <malloc+0x124>
  801159:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80115c:	3b 45 f4             	cmp    -0xc(%ebp),%eax
  80115f:	7c 0c                	jl     80116d <malloc+0x124>
						min = count;
  ...
  80116a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
					...
					count = 0;
  80116d:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
	} else {
		int count = 0;
		int min = 1000;
		int index = -1;
		uint32 min_addresss;
		for (uint32 i = USER_HEAP_START; i < USER_HEAP_MAX; i += PAGE_SIZE)
  801174:	81 45 e0 00 10 00 00 	addl   $0x1000,-0x20(%ebp)
  80117b:	81 7d e0 ff ff ff 9f 	cmpl   $0x9fffffff,-0x20(%ebp)
  801182:	0f 86 77 ff ff ff    	jbe    8010ff <malloc+0xb6>
  ...
  801191:	e8 cf 03 00 00       	call   801565 <sys_allocateMem>
  801196:	83 c4 10             	add    $0x10,%esp
		numOfPages[sizeofarray] = num;
  801199:	a1 2c 30 80 00       	mov    0x80302c,%eax
  80119e:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8011a1:	89 14 85 40 66 cc 06 	mov    %edx,0x6cc6640(,%eax,4)
		addresses[sizeofarray] = last_addres;
  8011a8:	a1 2c 30 80 00       	mov    0x80302c,%eax
  8011ad:	8b 15 04 30 80 00    	mov    0x803004,%edx
  8011b3:	89 14 85 40 31 c0 06 	mov    %edx,0x6c03140(,%eax,4)
		changed[sizeofarray] = 1;
  8011ba:	a1 2c 30 80 00       	mov    0x80302c,%eax
  8011bf:	c7 04 85 c0 4b c6 06 	movl   $0x1,0x6c64bc0(,%eax,4)
  8011c6:	01 00 00 00 
		sizeofarray++;
  8011ca:	a1 2c 30 80 00       	mov    0x80302c,%eax
  8011cf:	40                   	inc    %eax
  8011d0:	a3 2c 30 80 00       	mov    %eax,0x80302c
...
void free(void* virtual_address) {
  ...
  8011e3:	89 45 e8             	mov    %eax,-0x18(%ebp)
	uint32 size;
	int is_found = 0;
  8011e6:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	int index;
	for (int i = 0; i < sizeofarray; i++) {
  8011ed:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  8011f4:	eb 30                	jmp    801226 <free+0x4c>
		if (addresses[i] == va && changed[i] == 1) {
  8011f6:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8011f9:	8b 04 85 40 31 c0 06 	mov    0x6c03140(,%eax,4),%eax
  801200:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801203:	75 1e                	jne    801223 <free+0x49>
  801205:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801208:	8b 04 85 c0 4b c6 06 	mov    0x6c64bc0(,%eax,4),%eax
  80120f:	83 f8 01             	cmp    $0x1,%eax
  801212:	75 0f                	jne    801223 <free+0x49>
			is_found = 1;
  801214:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
			index = i;
  80121b:	8b 45 ec             	mov    -0x14(%ebp),%eax
  80121e:	89 45 f0             	mov    %eax,-0x10(%ebp)
			break;
  801221:	eb 0d                	jmp    801230 <free+0x56>
	//---------------------------
	uint32 va = (uint32) virtual_address;
	uint32 size;
	int is_found = 0;
	int index;
	for (int i = 0; i < sizeofarray; i++) {
  801223:	ff 45 ec             	incl   -0x14(%ebp)
  801226:	a1 2c 30 80 00       	mov    0x80302c,%eax
  80122b:	39 45 ec             	cmp    %eax,-0x14(%ebp)
  80122e:	7c c6                	jl     8011f6 <free+0x1c>
			is_found = 1;
			index = i;
			break;
		}
	...
	if (is_found == 1) {
  801230:	83 7d f4 01          	cmpl   $0x1,-0xc(%ebp)
  801234:	75 4f                	jne    801285 <free+0xab>
		size = numOfPages[index] * PAGE_SIZE;
  801236:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801239:	8b 04 85 40 66 cc 06 	mov    0x6cc6640(,%eax,4),%eax
  801240:	c1 e0 0c             	shl    $0xc,%eax
  801243:	89 45 e4             	mov    %eax,-0x1c(%ebp)
		cprintf("the size form the free is %d \n", size);
  801246:	83 ec 08             	sub    $0x8,%esp
  801249:	ff 75 e4             	pushl  -0x1c(%ebp)
  80124c:	68 90 23 80 00       	push   $0x802390
  801251:	e8 69 f0 ff ff       	call   8002bf <cprintf>
  801256:	83 c4 10             	add    $0x10,%esp
		sys_freeMem(va, size);
  801259:	83 ec 08             	sub    $0x8,%esp
  80125c:	ff 75 e4             	pushl  -0x1c(%ebp)
  80125f:	ff 75 e8             	pushl  -0x18(%ebp)
  801262:	e8 e2 02 00 00       	call   801549 <sys_freeMem>
  801267:	83 c4 10             	add    $0x10,%esp
		changed[index] = 0;
  80126a:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80126d:	c7 04 85 c0 4b c6 06 	movl   $0x0,0x6c64bc0(,%eax,4)
  801274:	00 00 00 00 
		changes++;
  801278:	a1 28 30 80 00       	mov    0x803028,%eax
  80127d:	40                   	inc    %eax
  80127e:	a3 28 30 80 00       	mov    %eax,0x803028
		sys_freeMem(va, size);
		changed[index] = 0;
	}
  ...
  801283:	eb 39                	jmp    8012be <free+0xe4>
		cprintf("the size form the free is %d \n", size);
		sys_freeMem(va, size);
		changed[index] = 0;
		changes++;
		...
		size = 513 * PAGE_SIZE;
  801285:	c7 45 e4 00 10 20 00 	movl   $0x201000,-0x1c(%ebp)
		cprintf("the size form the free is %d \n", size);
  80128c:	83 ec 08             	sub    $0x8,%esp
  80128f:	ff 75 e4             	pushl  -0x1c(%ebp)
  801292:	68 90 23 80 00       	push   $0x802390
  801297:	e8 23 f0 ff ff       	call   8002bf <cprintf>
  80129c:	83 c4 10             	add    $0x10,%esp
		sys_freeMem(va, size);
  80129f:	83 ec 08             	sub    $0x8,%esp
  8012a2:	ff 75 e4             	pushl  -0x1c(%ebp)
  8012a5:	ff 75 e8             	pushl  -0x18(%ebp)
  8012a8:	e8 9c 02 00 00       	call   801549 <sys_freeMem>
  8012ad:	83 c4 10             	add    $0x10,%esp
		changed[index] = 0;
  8012b0:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8012b3:	c7 04 85 c0 4b c6 06 	movl   $0x0,0x6c64bc0(,%eax,4)
  8012ba:	00 00 00 00 
	}
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable) {
  ...
  8012c4:	83 ec 18             	sub    $0x18,%esp
  8012c7:	8b 45 10             	mov    0x10(%ebp),%eax
  8012ca:	88 45 f4             	mov    %al,-0xc(%ebp)
	panic("this function is not required...!!");
  8012cd:	83 ec 04             	sub    $0x4,%esp
  8012d0:	68 b0 23 80 00       	push   $0x8023b0
  8012d5:	68 9d 00 00 00       	push   $0x9d
  8012da:	68 d3 23 80 00       	push   $0x8023d3
  8012df:	e8 bf 07 00 00       	call   801aa3 <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName) {
  ...
  8012ed:	68 b0 23 80 00       	push   $0x8023b0
  8012f2:	68 a2 00 00 00       	push   $0xa2
  8012f7:	68 d3 23 80 00       	push   $0x8023d3
  8012fc:	e8 a2 07 00 00       	call   801aa3 <_panic>
...
void sfree(void* virtual_address) {
  ...
  80130a:	68 b0 23 80 00       	push   $0x8023b0
  80130f:	68 a7 00 00 00       	push   $0xa7
  801314:	68 d3 23 80 00       	push   $0x8023d3
  801319:	e8 85 07 00 00       	call   801aa3 <_panic>
...
void *realloc(void *virtual_address, uint32 new_size) {
  ...
  801327:	68 b0 23 80 00       	push   $0x8023b0
  80132c:	68 ab 00 00 00       	push   $0xab
  801331:	68 d3 23 80 00       	push   $0x8023d3
  801336:	e8 68 07 00 00       	call   801aa3 <_panic>
...
void expand(uint32 newSize) {
  ...
  801344:	68 b0 23 80 00       	push   $0x8023b0
  801349:	68 b0 00 00 00       	push   $0xb0
  80134e:	68 d3 23 80 00       	push   $0x8023d3
  801353:	e8 4b 07 00 00       	call   801aa3 <_panic>
...
void shrink(uint32 newSize) {
  ...
  801361:	68 b0 23 80 00       	push   $0x8023b0
  801366:	68 b3 00 00 00       	push   $0xb3
  80136b:	68 d3 23 80 00       	push   $0x8023d3
  801370:	e8 2e 07 00 00       	call   801aa3 <_panic>
...
void freeHeap(void* virtual_address) {
  ...
  80137e:	68 b0 23 80 00       	push   $0x8023b0
  801383:	68 b7 00 00 00       	push   $0xb7
  801388:	68 d3 23 80 00       	push   $0x8023d3
  80138d:	e8 11 07 00 00       	call   801aa3 <_panic>
...
syscall(int num, uint32 a1, uint32 a2, uint32 a3, uint32 a4, uint32 a5)
{
  ...
  8013a7:	8b 7d 18             	mov    0x18(%ebp),%edi
  8013aa:	8b 75 1c             	mov    0x1c(%ebp),%esi
...
sys_cputs(const char *s, uint32 len, uint8 printProgName)
{
  ...
  8013db:	e8 b2 ff ff ff       	call   801392 <syscall>
...
sys_cgetc(void)
{
  ...
  8013f5:	e8 98 ff ff ff       	call   801392 <syscall>
  8013fa:	83 c4 18             	add    $0x18,%esp
}
  8013fd:	c9                   	leave  
  8013fe:	c3                   	ret    

008013ff <sys_env_destroy>:
...
int sys_env_destroy(int32  envid)
{
  ...
  80140d:	50                   	push   %eax
  80140e:	6a 05                	push   $0x5
  801410:	e8 7d ff ff ff       	call   801392 <syscall>
  801415:	83 c4 18             	add    $0x18,%esp
}
  801418:	c9                   	leave  
  801419:	c3                   	ret    

0080141a <sys_getenvid>:
...
int32 sys_getenvid(void)
{
  ...
  801429:	e8 64 ff ff ff       	call   801392 <syscall>
  80142e:	83 c4 18             	add    $0x18,%esp
}
  801431:	c9                   	leave  
  801432:	c3                   	ret    

00801433 <sys_getenvindex>:
...
int32 sys_getenvindex(void)
{
  ...
  801440:	6a 03                	push   $0x3
  801442:	e8 4b ff ff ff       	call   801392 <syscall>
  801447:	83 c4 18             	add    $0x18,%esp
}
  80144a:	c9                   	leave  
  80144b:	c3                   	ret    

0080144c <sys_getparentenvid>:
...
int32 sys_getparentenvid(void)
{
  ...
  801459:	6a 04                	push   $0x4
  80145b:	e8 32 ff ff ff       	call   801392 <syscall>
  801460:	83 c4 18             	add    $0x18,%esp
}
  801463:	c9                   	leave  
  801464:	c3                   	ret    

00801465 <sys_env_exit>:
...
void sys_env_exit(void)
{
  ...
  801472:	6a 06                	push   $0x6
  801474:	e8 19 ff ff ff       	call   801392 <syscall>
...
int __sys_allocate_page(void *va, int perm)
{
  ...
  801492:	e8 fb fe ff ff       	call   801392 <syscall>
  801497:	83 c4 18             	add    $0x18,%esp
}
  80149a:	c9                   	leave  
  80149b:	c3                   	ret    

0080149c <__sys_map_frame>:
...
int __sys_map_frame(int32 srcenv, void *srcva, int32 dstenv, void *dstva, int perm)
{
  ...
  8014a1:	8b 75 18             	mov    0x18(%ebp),%esi
  ...
  8014b3:	52                   	push   %edx
  8014b4:	50                   	push   %eax
  8014b5:	6a 08                	push   $0x8
  8014b7:	e8 d6 fe ff ff       	call   801392 <syscall>
...
int __sys_unmap_frame(int32 envid, void *va)
{
  ...
  8014d5:	52                   	push   %edx
  8014d6:	50                   	push   %eax
  8014d7:	6a 09                	push   $0x9
  8014d9:	e8 b4 fe ff ff       	call   801392 <syscall>
...
uint32 sys_calculate_required_frames(uint32 start_virtual_address, uint32 size)
{
  ...
  8014f4:	e8 99 fe ff ff       	call   801392 <syscall>
...
uint32 sys_calculate_free_frames()
{
  ...
  80150b:	6a 0b                	push   $0xb
  80150d:	e8 80 fe ff ff       	call   801392 <syscall>
...
uint32 sys_calculate_modified_frames()
{
  ...
  801526:	e8 67 fe ff ff       	call   801392 <syscall>
...
uint32 sys_calculate_notmod_frames()
{
  ...
  80153d:	6a 0d                	push   $0xd
  80153f:	e8 4e fe ff ff       	call   801392 <syscall>
  801544:	83 c4 18             	add    $0x18,%esp
}
  801547:	c9                   	leave  
  801548:	c3                   	ret    

00801549 <sys_freeMem>:
...
void sys_freeMem(uint32 virtual_address, uint32 size)
{
  ...
  801558:	6a 11                	push   $0x11
  80155a:	e8 33 fe ff ff       	call   801392 <syscall>
...
void sys_allocateMem(uint32 virtual_address, uint32 size)
{
  ...
  801574:	6a 12                	push   $0x12
  801576:	e8 17 fe ff ff       	call   801392 <syscall>
...
00801581 <sys_pf_calculate_allocated_pages>:
...
int sys_pf_calculate_allocated_pages()
{
  ...
  80158e:	6a 0e                	push   $0xe
  801590:	e8 fd fd ff ff       	call   801392 <syscall>
  801595:	83 c4 18             	add    $0x18,%esp
}
  801598:	c9                   	leave  
  801599:	c3                   	ret    

0080159a <sys_calculate_pages_tobe_removed_ready_exit>:
...
int sys_calculate_pages_tobe_removed_ready_exit(uint32 WS_or_MEMORY_flag)
{
  ...
  8015a8:	6a 0f                	push   $0xf
  8015aa:	e8 e3 fd ff ff       	call   801392 <syscall>
  8015af:	83 c4 18             	add    $0x18,%esp
}
  8015b2:	c9                   	leave  
  8015b3:	c3                   	ret    

008015b4 <sys_scarce_memory>:
...
void sys_scarce_memory()
{
  ...
  8015c3:	e8 ca fd ff ff       	call   801392 <syscall>
...
008015ce <sys_disable_interrupt>:
...
sys_disable_interrupt()
{
  ...
  8015db:	6a 14                	push   $0x14
  8015dd:	e8 b0 fd ff ff       	call   801392 <syscall>
...
sys_enable_interrupt()
{
  ...
  8015f5:	6a 15                	push   $0x15
  8015f7:	e8 96 fd ff ff       	call   801392 <syscall>
...
sys_cputc(const char c)
{
  ...
  80161a:	50                   	push   %eax
  80161b:	6a 16                	push   $0x16
  80161d:	e8 70 fd ff ff       	call   801392 <syscall>
...
sys_clear_ffl()
{
  ...
  801635:	6a 17                	push   $0x17
  801637:	e8 56 fd ff ff       	call   801392 <syscall>
...
sys_createSemaphore(char* semaphoreName, uint32 initialValue)
{
  ...
  801651:	50                   	push   %eax
  801652:	6a 18                	push   $0x18
  801654:	e8 39 fd ff ff       	call   801392 <syscall>
  801659:	83 c4 18             	add    $0x18,%esp
}
  80165c:	c9                   	leave  
  80165d:	c3                   	ret    

0080165e <sys_getSemaphoreValue>:
...
sys_getSemaphoreValue(int32 ownerEnvID, char* semaphoreName)
{
  ...
  80166d:	52                   	push   %edx
  80166e:	50                   	push   %eax
  80166f:	6a 1b                	push   $0x1b
  801671:	e8 1c fd ff ff       	call   801392 <syscall>
  801676:	83 c4 18             	add    $0x18,%esp
}
  801679:	c9                   	leave  
  80167a:	c3                   	ret    

0080167b <sys_waitSemaphore>:
...
sys_waitSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  80168a:	52                   	push   %edx
  80168b:	50                   	push   %eax
  80168c:	6a 19                	push   $0x19
  80168e:	e8 ff fc ff ff       	call   801392 <syscall>
...
sys_signalSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  8016a8:	52                   	push   %edx
  8016a9:	50                   	push   %eax
  8016aa:	6a 1a                	push   $0x1a
  8016ac:	e8 e1 fc ff ff       	call   801392 <syscall>
...
008016b7 <sys_createSharedObject>:
...
sys_createSharedObject(char* shareName, uint32 size, uint8 isWritable, void* virtual_address)
{
  ...
  8016c3:	8b 4d 14             	mov    0x14(%ebp),%ecx
  8016c6:	0f b6 55 fc          	movzbl -0x4(%ebp),%edx
  ...
  8016d4:	50                   	push   %eax
  8016d5:	6a 1c                	push   $0x1c
  8016d7:	e8 b6 fc ff ff       	call   801392 <syscall>
  8016dc:	83 c4 18             	add    $0x18,%esp
}
  8016df:	c9                   	leave  
  8016e0:	c3                   	ret    

008016e1 <sys_getSizeOfSharedObject>:
...
sys_getSizeOfSharedObject(int32 ownerID, char* shareName)
{
  ...
  8016f4:	e8 99 fc ff ff       	call   801392 <syscall>
  8016f9:	83 c4 18             	add    $0x18,%esp
}
  8016fc:	c9                   	leave  
  8016fd:	c3                   	ret    

008016fe <sys_getSharedObject>:
//==========
...
sys_getSharedObject(int32 ownerID, char* shareName, void* virtual_address)
{
  ...
  801701:	8b 4d 10             	mov    0x10(%ebp),%ecx
  ...
  80170f:	52                   	push   %edx
  801710:	50                   	push   %eax
  801711:	6a 1e                	push   $0x1e
  801713:	e8 7a fc ff ff       	call   801392 <syscall>
  801718:	83 c4 18             	add    $0x18,%esp
}
  80171b:	c9                   	leave  
  80171c:	c3                   	ret    

0080171d <sys_freeSharedObject>:
...
sys_freeSharedObject(int32 sharedObjectID, void *startVA)
{
  ...
  80172c:	52                   	push   %edx
  80172d:	50                   	push   %eax
  80172e:	6a 1f                	push   $0x1f
  801730:	e8 5d fc ff ff       	call   801392 <syscall>
  801735:	83 c4 18             	add    $0x18,%esp
}
  801738:	c9                   	leave  
  801739:	c3                   	ret    

0080173a <sys_getMaxShares>:
...
uint32 	sys_getMaxShares()
{
  ...
  801747:	6a 20                	push   $0x20
  801749:	e8 44 fc ff ff       	call   801392 <syscall>
  80174e:	83 c4 18             	add    $0x18,%esp
}
  801751:	c9                   	leave  
  801752:	c3                   	ret    

00801753 <sys_create_env>:
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int LRU_second_list_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  80175b:	ff 75 14             	pushl  0x14(%ebp)
  80175e:	ff 75 10             	pushl  0x10(%ebp)
  801761:	ff 75 0c             	pushl  0xc(%ebp)
  801764:	50                   	push   %eax
  801765:	6a 21                	push   $0x21
  801767:	e8 26 fc ff ff       	call   801392 <syscall>
  80176c:	83 c4 18             	add    $0x18,%esp
}
  80176f:	c9                   	leave  
  801770:	c3                   	ret    

00801771 <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  80177f:	50                   	push   %eax
  801780:	6a 22                	push   $0x22
  801782:	e8 0b fc ff ff       	call   801392 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  80179b:	50                   	push   %eax
  80179c:	6a 23                	push   $0x23
  80179e:	e8 ef fb ff ff       	call   801392 <syscall>
...
sys_get_virtual_time()
{
  ...
  8017be:	52                   	push   %edx
  8017bf:	50                   	push   %eax
  8017c0:	6a 24                	push   $0x24
  8017c2:	e8 cb fb ff ff       	call   801392 <syscall>
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  8017f1:	e8 9c fb ff ff       	call   801392 <syscall>
...
uint32 sys_rcr2()
{
  ...
  801809:	6a 25                	push   $0x25
  80180b:	e8 82 fb ff ff       	call   801392 <syscall>
...
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  80182d:	50                   	push   %eax
  80182e:	6a 26                	push   $0x26
  801830:	e8 5d fb ff ff       	call   801392 <syscall>
...
void rsttst()
{
  ...
  801848:	6a 28                	push   $0x28
  80184a:	e8 43 fb ff ff       	call   801392 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801873:	6a 27                	push   $0x27
  801875:	e8 18 fb ff ff       	call   801392 <syscall>
...
void chktst(uint32 n)
{
  ...
  80188e:	6a 29                	push   $0x29
  801890:	e8 fd fa ff ff       	call   801392 <syscall>
...
void inctst()
{
  ...
  8018aa:	e8 e3 fa ff ff       	call   801392 <syscall>
...
uint32 gettst()
{
  ...
  8018c2:	6a 2b                	push   $0x2b
  8018c4:	e8 c9 fa ff ff       	call   801392 <syscall>
  8018c9:	83 c4 18             	add    $0x18,%esp
}
  8018cc:	c9                   	leave  
  8018cd:	c3                   	ret    

008018ce <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  8018e0:	e8 ad fa ff ff       	call   801392 <syscall>
  8018e5:	83 c4 18             	add    $0x18,%esp
  8018e8:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  8018eb:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  8018ef:	75 07                	jne    8018f8 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  8018f1:	b8 01 00 00 00       	mov    $0x1,%eax
  8018f6:	eb 05                	jmp    8018fd <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
008018ff <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801911:	e8 7c fa ff ff       	call   801392 <syscall>
  801916:	83 c4 18             	add    $0x18,%esp
  801919:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  80191c:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  801920:	75 07                	jne    801929 <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  801922:	b8 01 00 00 00       	mov    $0x1,%eax
  801927:	eb 05                	jmp    80192e <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
00801930 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801942:	e8 4b fa ff ff       	call   801392 <syscall>
  801947:	83 c4 18             	add    $0x18,%esp
  80194a:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  80194d:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  801951:	75 07                	jne    80195a <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  801953:	b8 01 00 00 00       	mov    $0x1,%eax
  801958:	eb 05                	jmp    80195f <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
00801961 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801973:	e8 1a fa ff ff       	call   801392 <syscall>
  801978:	83 c4 18             	add    $0x18,%esp
  80197b:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  80197e:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  801982:	75 07                	jne    80198b <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  801984:	b8 01 00 00 00       	mov    $0x1,%eax
  801989:	eb 05                	jmp    801990 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
00801992 <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  8019a2:	e8 eb f9 ff ff       	call   801392 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  8019c1:	52                   	push   %edx
  8019c2:	50                   	push   %eax
  8019c3:	6a 2e                	push   $0x2e
  8019c5:	e8 c8 f9 ff ff       	call   801392 <syscall>
...
008019d2 <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  8019e1:	52                   	push   %edx
  8019e2:	50                   	push   %eax
  8019e3:	6a 2f                	push   $0x2f
  8019e5:	e8 a8 f9 ff ff       	call   801392 <syscall>
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  8019ff:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  ...
  801a1a:	c1 e0 04             	shl    $0x4,%eax
  801a1d:	89 45 f0             	mov    %eax,-0x10(%ebp)
	uint32 cycles_counter =0;
  801a20:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)

	struct uint64 baseTime = sys_get_virtual_time() ;
  801a27:	8d 45 e8             	lea    -0x18(%ebp),%eax
  801a2a:	83 ec 0c             	sub    $0xc,%esp
  801a2d:	50                   	push   %eax
  801a2e:	e8 76 fd ff ff       	call   8017a9 <sys_get_virtual_time>
  801a33:	83 c4 0c             	add    $0xc,%esp
	while(cycles_counter<time_in_cycles)
  801a36:	eb 41                	jmp    801a79 <env_sleep+0x8a>
	{
		struct uint64 currentTime = sys_get_virtual_time() ;
  801a38:	8d 45 e0             	lea    -0x20(%ebp),%eax
  801a3b:	83 ec 0c             	sub    $0xc,%esp
  801a3e:	50                   	push   %eax
  801a3f:	e8 65 fd ff ff       	call   8017a9 <sys_get_virtual_time>
  ...
  801a47:	8b 55 e0             	mov    -0x20(%ebp),%edx
  801a4a:	8b 45 e8             	mov    -0x18(%ebp),%eax
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  801a7c:	3b 45 f0             	cmp    -0x10(%ebp),%eax
  801a7f:	72 b7                	jb     801a38 <env_sleep+0x49>
//				,cycles_counter
//				);
	}
...
uint32 busy_wait(uint32 loopMax)
{
  ...
  801a87:	83 ec 10             	sub    $0x10,%esp
	uint32 i = 0 ;
  801a8a:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
	while (i < loopMax) i++;
  801a91:	eb 03                	jmp    801a96 <busy_wait+0x12>
  801a93:	ff 45 fc             	incl   -0x4(%ebp)
  801a96:	8b 45 fc             	mov    -0x4(%ebp),%eax
  801a99:	3b 45 08             	cmp    0x8(%ebp),%eax
  801a9c:	72 f5                	jb     801a93 <busy_wait+0xf>
	return i;
  801a9e:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
  801aa1:	c9                   	leave  
  801aa2:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  801aa6:	83 ec 18             	sub    $0x18,%esp
	va_list ap;
	va_start(ap, fmt);
  801aa9:	8d 45 10             	lea    0x10(%ebp),%eax
  801aac:	83 c0 04             	add    $0x4,%eax
  801aaf:	89 45 f4             	mov    %eax,-0xc(%ebp)
	// Print the panic message
	if (argv0)
  801ab2:	a1 c0 80 d2 06       	mov    0x6d280c0,%eax
  801ab7:	85 c0                	test   %eax,%eax
  801ab9:	74 16                	je     801ad1 <_panic+0x2e>
		cprintf("%s: ", argv0);
  801abb:	a1 c0 80 d2 06       	mov    0x6d280c0,%eax
  801ac0:	83 ec 08             	sub    $0x8,%esp
  801ac3:	50                   	push   %eax
  801ac4:	68 e0 23 80 00       	push   $0x8023e0
  801ac9:	e8 f1 e7 ff ff       	call   8002bf <cprintf>
  801ace:	83 c4 10             	add    $0x10,%esp
	cprintf("user panic in %s at %s:%d: ", binaryname, file, line);
  801ad1:	a1 00 30 80 00       	mov    0x803000,%eax
  801ad6:	ff 75 0c             	pushl  0xc(%ebp)
  801ad9:	ff 75 08             	pushl  0x8(%ebp)
  801adc:	50                   	push   %eax
  801add:	68 e5 23 80 00       	push   $0x8023e5
  801ae2:	e8 d8 e7 ff ff       	call   8002bf <cprintf>
  ...
  801af3:	50                   	push   %eax
  801af4:	e8 5b e7 ff ff       	call   800254 <vcprintf>
  801af9:	83 c4 10             	add    $0x10,%esp
	vcprintf("\n", NULL);
  801afc:	83 ec 08             	sub    $0x8,%esp
  801aff:	6a 00                	push   $0x0
  801b01:	68 01 24 80 00       	push   $0x802401
  801b06:	e8 49 e7 ff ff       	call   800254 <vcprintf>
...
//		asm volatile("int3");
	...
	exit() ;
  801b0e:	e8 ca e6 ff ff       	call   8001dd <exit>

	// should not return here
	while (1) ;
  801b13:	eb fe                	jmp    801b13 <_panic+0x70>

00801b15 <CheckWSWithoutLastIndex>:
}
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  801b28:	74 14                	je     801b3e <CheckWSWithoutLastIndex+0x29>
	{
		panic("number of expected pages SHOULD BE EQUAL to max WS size... review your TA!!");
  801b2a:	83 ec 04             	sub    $0x4,%esp
  801b2d:	68 04 24 80 00       	push   $0x802404
  801b32:	6a 26                	push   $0x26
  801b34:	68 50 24 80 00       	push   $0x802450
  801b39:	e8 65 ff ff ff       	call   801aa3 <_panic>
	}
	int expectedNumOfEmptyLocs = 0;
  801b3e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int e = 0; e < arraySize; e++) {
  801b45:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801b4c:	e9 b6 00 00 00       	jmp    801c07 <CheckWSWithoutLastIndex+0xf2>
  ...
  801b64:	75 08                	jne    801b6e <CheckWSWithoutLastIndex+0x59>
			expectedNumOfEmptyLocs++;
  801b66:	ff 45 f4             	incl   -0xc(%ebp)
			continue;
  801b69:	e9 96 00 00 00       	jmp    801c04 <CheckWSWithoutLastIndex+0xef>
		}
		int found = 0;
  801b6e:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
		for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  801b75:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
  801b7c:	eb 5d                	jmp    801bdb <CheckWSWithoutLastIndex+0xc6>
			if (myEnv->__uptr_pws[w].empty == 0) {
  801b7e:	a1 20 30 80 00       	mov    0x803020,%eax
  801b83:	8b 80 80 3c 01 00    	mov    0x13c80(%eax),%eax
  801b89:	8b 55 e8             	mov    -0x18(%ebp),%edx
  801b8c:	c1 e2 04             	shl    $0x4,%edx
  801b8f:	01 d0                	add    %edx,%eax
  801b91:	8a 40 04             	mov    0x4(%eax),%al
  801b94:	84 c0                	test   %al,%al
  801b96:	75 40                	jne    801bd8 <CheckWSWithoutLastIndex+0xc3>
				if (ROUNDDOWN(myEnv->__uptr_pws[w].virtual_address, PAGE_SIZE)
  801b98:	a1 20 30 80 00       	mov    0x803020,%eax
  801b9d:	8b 80 80 3c 01 00    	mov    0x13c80(%eax),%eax
  801ba3:	8b 55 e8             	mov    -0x18(%ebp),%edx
  801ba6:	c1 e2 04             	shl    $0x4,%edx
  801ba9:	01 d0                	add    %edx,%eax
  801bab:	8b 00                	mov    (%eax),%eax
  801bad:	89 45 dc             	mov    %eax,-0x24(%ebp)
  801bb0:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801bb3:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  801bb8:	89 c2                	mov    %eax,%edx
						== expectedPages[e]) {
  801bba:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801bbd:	8d 0c 85 00 00 00 00 	lea    0x0(,%eax,4),%ecx
  ...
  801bcd:	75 09                	jne    801bd8 <CheckWSWithoutLastIndex+0xc3>
						== expectedPages[e]) {
					found = 1;
  801bcf:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
					break;
  801bd6:	eb 12                	jmp    801bea <CheckWSWithoutLastIndex+0xd5>
		if (expectedPages[e] == 0) {
			expectedNumOfEmptyLocs++;
			continue;
		}
  ...
  801be8:	77 94                	ja     801b7e <CheckWSWithoutLastIndex+0x69>
					found = 1;
					break;
				}
			}
  ...
  801bee:	75 14                	jne    801c04 <CheckWSWithoutLastIndex+0xef>
			panic(
  801bf0:	83 ec 04             	sub    $0x4,%esp
  801bf3:	68 5c 24 80 00       	push   $0x80245c
  801bf8:	6a 3a                	push   $0x3a
  801bfa:	68 50 24 80 00       	push   $0x802450
  801bff:	e8 9f fe ff ff       	call   801aa3 <_panic>
	if (arraySize != myEnv->page_WS_max_size)
	{
		panic("number of expected pages SHOULD BE EQUAL to max WS size... review your TA!!");
	}
	int expectedNumOfEmptyLocs = 0;
	for (int e = 0; e < arraySize; e++) {
  801c04:	ff 45 f0             	incl   -0x10(%ebp)
  801c07:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801c0a:	3b 45 0c             	cmp    0xc(%ebp),%eax
  801c0d:	0f 8c 3e ff ff ff    	jl     801b51 <CheckWSWithoutLastIndex+0x3c>
		}
		if (!found)
			panic(
  ...
  801c13:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
	for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  801c1a:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
  801c21:	eb 20                	jmp    801c43 <CheckWSWithoutLastIndex+0x12e>
		if (myEnv->__uptr_pws[w].empty == 1) {
  801c23:	a1 20 30 80 00       	mov    0x803020,%eax
  801c28:	8b 80 80 3c 01 00    	mov    0x13c80(%eax),%eax
  801c2e:	8b 55 e0             	mov    -0x20(%ebp),%edx
  801c31:	c1 e2 04             	shl    $0x4,%edx
  801c34:	01 d0                	add    %edx,%eax
  801c36:	8a 40 04             	mov    0x4(%eax),%al
  801c39:	3c 01                	cmp    $0x1,%al
  801c3b:	75 03                	jne    801c40 <CheckWSWithoutLastIndex+0x12b>
  ...
  801c3d:	ff 45 e4             	incl   -0x1c(%ebp)
	...
	int actualNumOfEmptyLocs = 0;
	for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  801c40:	ff 45 e0             	incl   -0x20(%ebp)
  801c43:	a1 20 30 80 00       	mov    0x803020,%eax
  801c48:	8b 50 74             	mov    0x74(%eax),%edx
  801c4b:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801c4e:	39 c2                	cmp    %eax,%edx
  801c50:	77 d1                	ja     801c23 <CheckWSWithoutLastIndex+0x10e>
		if (myEnv->__uptr_pws[w].empty == 1) {
			actualNumOfEmptyLocs++;
		}
	}
  ...
  801c55:	3b 45 e4             	cmp    -0x1c(%ebp),%eax
  801c58:	74 14                	je     801c6e <CheckWSWithoutLastIndex+0x159>
		panic(
  801c5a:	83 ec 04             	sub    $0x4,%esp
  801c5d:	68 b0 24 80 00       	push   $0x8024b0
  801c62:	6a 44                	push   $0x44
  801c64:	68 50 24 80 00       	push   $0x802450
  801c69:	e8 35 fe ff ff       	call   801aa3 <_panic>
