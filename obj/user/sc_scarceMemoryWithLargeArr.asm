...
void _main(void)
{
  ...
  800046:	e8 fc 18 00 00       	call   801947 <env_sleep>
...
libmain(int argc, char **argv)
{
  ...
  8000ac:	e8 da 12 00 00       	call   80138b <sys_getenvindex>
  ...
  800129:	e8 f8 13 00 00       	call   801526 <sys_disable_interrupt>
	cprintf("**************************************\n");
  80012e:	83 ec 0c             	sub    $0xc,%esp
  800131:	68 ac 1e 80 00       	push   $0x801eac
  ...
  800157:	52                   	push   %edx
  800158:	50                   	push   %eax
  800159:	68 d4 1e 80 00       	push   $0x801ed4
  ...
  80017f:	52                   	push   %edx
  800180:	50                   	push   %eax
  800181:	68 fc 1e 80 00       	push   $0x801efc
  ...
  80019c:	50                   	push   %eax
  80019d:	68 3d 1f 80 00       	push   $0x801f3d
  8001a2:	e8 18 01 00 00       	call   8002bf <cprintf>
  8001a7:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  8001aa:	83 ec 0c             	sub    $0xc,%esp
  8001ad:	68 ac 1e 80 00       	push   $0x801eac
  8001b2:	e8 08 01 00 00       	call   8002bf <cprintf>
  8001b7:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  8001ba:	e8 81 13 00 00       	call   801540 <sys_enable_interrupt>
...
destroy(void)
{
  ...
  8001d2:	e8 80 11 00 00       	call   801357 <sys_env_destroy>
...
exit(void)
{
  ...
  8001e0:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  8001e3:	e8 d5 11 00 00       	call   8013bd <sys_env_exit>
}
  8001e8:	90                   	nop
  8001e9:	c9                   	leave  
  8001ea:	c3                   	ret    
...
static void putch(int ch, struct printbuf *b) {
  ...
  80022f:	51                   	push   %ecx
  800230:	52                   	push   %edx
  800231:	e8 df 10 00 00       	call   801315 <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  8002a7:	50                   	push   %eax
  8002a8:	e8 68 10 00 00       	call   801315 <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  8002ef:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8002f2:	e8 2f 12 00 00       	call   801526 <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  80030f:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  800312:	e8 29 12 00 00       	call   801540 <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80035c:	e8 6b 18 00 00       	call   801bcc <__udivdi3>
  ...
  8003aa:	52                   	push   %edx
  8003ab:	50                   	push   %eax
  8003ac:	e8 2b 19 00 00       	call   801cdc <__umoddi3>
  8003b1:	83 c4 10             	add    $0x10,%esp
  8003b4:	05 74 21 80 00       	add    $0x802174,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800507:	8b 04 85 98 21 80 00 	mov    0x802198(,%eax,4),%eax
  ...
  8005e8:	8b 34 9d e0 1f 80 00 	mov    0x801fe0(,%ebx,4),%esi
  8005ef:	85 f6                	test   %esi,%esi
  8005f1:	75 19                	jne    80060c <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  8005f3:	53                   	push   %ebx
  8005f4:	68 85 21 80 00       	push   $0x802185
  ...
  800607:	e9 49 02 00 00       	jmp    800855 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  80060c:	56                   	push   %esi
  80060d:	68 8e 21 80 00       	push   $0x80218e
  ...
  800638:	75 05                	jne    80063f <vprintfmt+0x1a6>
				p = "(null)";
  80063a:	be 91 21 80 00       	mov    $0x802191,%esi
			if (width > 0 && padc != '-')
...
void* malloc(uint32 size)
{
  ...
  8010a7:	8b 15 04 30 80 00    	mov    0x803004,%edx
  8010ad:	89 14 85 40 31 c0 06 	mov    %edx,0x6c03140(,%eax,4)
			changed[sizeofarray]=1;
  8010b4:	a1 2c 30 80 00       	mov    0x80302c,%eax
  8010b9:	c7 04 85 e0 32 c0 06 	movl   $0x1,0x6c032e0(,%eax,4)
  8010c0:	01 00 00 00 
			sizeofarray++;
  8010c4:	a1 2c 30 80 00       	mov    0x80302c,%eax
  8010c9:	40                   	inc    %eax
  8010ca:	a3 2c 30 80 00       	mov    %eax,0x80302c
			return (void*)return_addres;
  8010cf:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8010d2:	e9 26 01 00 00       	jmp    8011fd <malloc+0x1b4>
		}
		else
		{
			if(changes==0)
  8010d7:	a1 28 30 80 00       	mov    0x803028,%eax
  8010dc:	85 c0                	test   %eax,%eax
  8010de:	75 62                	jne    801142 <malloc+0xf9>
			{
				sys_allocateMem(last_addres,size);
  8010e0:	a1 04 30 80 00       	mov    0x803004,%eax
  8010e5:	83 ec 08             	sub    $0x8,%esp
  8010e8:	ff 75 08             	pushl  0x8(%ebp)
  8010eb:	50                   	push   %eax
  8010ec:	e8 cc 03 00 00       	call   8014bd <sys_allocateMem>
  8010f1:	83 c4 10             	add    $0x10,%esp
				return_addres=last_addres;
  8010f4:	a1 04 30 80 00       	mov    0x803004,%eax
  8010f9:	89 45 d8             	mov    %eax,-0x28(%ebp)
				last_addres+=num*PAGE_SIZE;
  8010fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8010ff:	c1 e0 0c             	shl    $0xc,%eax
  801102:	89 c2                	mov    %eax,%edx
  801104:	a1 04 30 80 00       	mov    0x803004,%eax
  801109:	01 d0                	add    %edx,%eax
  80110b:	a3 04 30 80 00       	mov    %eax,0x803004
				addresses[sizeofarray]=return_addres;
  801110:	a1 2c 30 80 00       	mov    0x80302c,%eax
  801115:	8b 55 d8             	mov    -0x28(%ebp),%edx
  801118:	89 14 85 40 31 c0 06 	mov    %edx,0x6c03140(,%eax,4)
				changed[sizeofarray]=1;
  80111f:	a1 2c 30 80 00       	mov    0x80302c,%eax
  801124:	c7 04 85 e0 32 c0 06 	movl   $0x1,0x6c032e0(,%eax,4)
  80112b:	01 00 00 00 
				sizeofarray++;
  80112f:	a1 2c 30 80 00       	mov    0x80302c,%eax
  801134:	40                   	inc    %eax
  801135:	a3 2c 30 80 00       	mov    %eax,0x80302c
				return (void*)return_addres;
  80113a:	8b 45 d8             	mov    -0x28(%ebp),%eax
  80113d:	e9 bb 00 00 00       	jmp    8011fd <malloc+0x1b4>
			}
			else{
				int count=0;
  801142:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
				int min=1000;
  801149:	c7 45 ec e8 03 00 00 	movl   $0x3e8,-0x14(%ebp)
				int index=-1;
  801150:	c7 45 e8 ff ff ff ff 	movl   $0xffffffff,-0x18(%ebp)
				uint32 min_addresss;
				for(uint32 i=USER_HEAP_START;i<USER_HEAP_MAX;i+=PAGE_SIZE)
  801157:	c7 45 e0 00 00 00 80 	movl   $0x80000000,-0x20(%ebp)
  80115e:	eb 7c                	jmp    8011dc <malloc+0x193>
				{
					uint32 *pg=NULL;
  801160:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
					for(int j=0;j<sizeofarray;j++)
  801167:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
  80116e:	eb 1a                	jmp    80118a <malloc+0x141>
					{
						if(addresses[j]==i)
  801170:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801173:	8b 04 85 40 31 c0 06 	mov    0x6c03140(,%eax,4),%eax
  80117a:	3b 45 e0             	cmp    -0x20(%ebp),%eax
  80117d:	75 08                	jne    801187 <malloc+0x13e>
						{
							index=j;
  80117f:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801182:	89 45 e8             	mov    %eax,-0x18(%ebp)
							break;
  801185:	eb 0d                	jmp    801194 <malloc+0x14b>
				int index=-1;
				uint32 min_addresss;
				for(uint32 i=USER_HEAP_START;i<USER_HEAP_MAX;i+=PAGE_SIZE)
				{
					uint32 *pg=NULL;
					for(int j=0;j<sizeofarray;j++)
  801187:	ff 45 dc             	incl   -0x24(%ebp)
  80118a:	a1 2c 30 80 00       	mov    0x80302c,%eax
  80118f:	39 45 dc             	cmp    %eax,-0x24(%ebp)
  801192:	7c dc                	jl     801170 <malloc+0x127>
							index=j;
							break;
						}
					}
					...
					if(index==-1)
  801194:	83 7d e8 ff          	cmpl   $0xffffffff,-0x18(%ebp)
  801198:	75 05                	jne    80119f <malloc+0x156>
					{
						count++;
  80119a:	ff 45 f0             	incl   -0x10(%ebp)
  80119d:	eb 36                	jmp    8011d5 <malloc+0x18c>
					}
					else
					{
						if(changed[index]==0)
  80119f:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8011a2:	8b 04 85 e0 32 c0 06 	mov    0x6c032e0(,%eax,4),%eax
  8011a9:	85 c0                	test   %eax,%eax
  8011ab:	75 05                	jne    8011b2 <malloc+0x169>
						{
							count++;
  8011ad:	ff 45 f0             	incl   -0x10(%ebp)
  8011b0:	eb 23                	jmp    8011d5 <malloc+0x18c>
						}
						else
						{
							if(count<min&&count>=num)
  8011b2:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8011b5:	3b 45 ec             	cmp    -0x14(%ebp),%eax
  8011b8:	7d 14                	jge    8011ce <malloc+0x185>
  8011ba:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8011bd:	3b 45 f4             	cmp    -0xc(%ebp),%eax
  8011c0:	7c 0c                	jl     8011ce <malloc+0x185>
							{
								min=count;
  ...
  8011cb:	89 45 e4             	mov    %eax,-0x1c(%ebp)
							...
							count=0;
  8011ce:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
			else{
				int count=0;
				int min=1000;
				int index=-1;
				uint32 min_addresss;
				for(uint32 i=USER_HEAP_START;i<USER_HEAP_MAX;i+=PAGE_SIZE)
  8011d5:	81 45 e0 00 10 00 00 	addl   $0x1000,-0x20(%ebp)
  8011dc:	81 7d e0 ff ff ff 9f 	cmpl   $0x9fffffff,-0x20(%ebp)
  8011e3:	0f 86 77 ff ff ff    	jbe    801160 <malloc+0x117>
  ...
  8011f2:	e8 c6 02 00 00       	call   8014bd <sys_allocateMem>
...
void free(void* virtual_address)
{
  ...
  801208:	68 f0 22 80 00       	push   $0x8022f0
  80120d:	6a 7b                	push   $0x7b
  80120f:	68 13 23 80 00       	push   $0x802313
  801214:	e8 e2 07 00 00       	call   8019fb <_panic>
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  801222:	88 45 f4             	mov    %al,-0xc(%ebp)
	panic("this function is not required...!!");
  801225:	83 ec 04             	sub    $0x4,%esp
  801228:	68 20 23 80 00       	push   $0x802320
  80122d:	68 88 00 00 00       	push   $0x88
  801232:	68 13 23 80 00       	push   $0x802313
  801237:	e8 bf 07 00 00       	call   8019fb <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  801245:	68 20 23 80 00       	push   $0x802320
  80124a:	68 8e 00 00 00       	push   $0x8e
  80124f:	68 13 23 80 00       	push   $0x802313
  801254:	e8 a2 07 00 00       	call   8019fb <_panic>
...
void sfree(void* virtual_address)
{
  ...
  801262:	68 20 23 80 00       	push   $0x802320
  801267:	68 94 00 00 00       	push   $0x94
  80126c:	68 13 23 80 00       	push   $0x802313
  801271:	e8 85 07 00 00       	call   8019fb <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  80127f:	68 20 23 80 00       	push   $0x802320
  801284:	68 99 00 00 00       	push   $0x99
  801289:	68 13 23 80 00       	push   $0x802313
  80128e:	e8 68 07 00 00       	call   8019fb <_panic>
...
void expand(uint32 newSize)
{
  ...
  80129c:	68 20 23 80 00       	push   $0x802320
  8012a1:	68 9f 00 00 00       	push   $0x9f
  8012a6:	68 13 23 80 00       	push   $0x802313
  8012ab:	e8 4b 07 00 00       	call   8019fb <_panic>
...
void shrink(uint32 newSize)
{
  ...
  8012b9:	68 20 23 80 00       	push   $0x802320
  8012be:	68 a3 00 00 00       	push   $0xa3
  8012c3:	68 13 23 80 00       	push   $0x802313
  8012c8:	e8 2e 07 00 00       	call   8019fb <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  8012d6:	68 20 23 80 00       	push   $0x802320
  8012db:	68 a8 00 00 00       	push   $0xa8
  8012e0:	68 13 23 80 00       	push   $0x802313
  8012e5:	e8 11 07 00 00       	call   8019fb <_panic>
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  801a07:	89 45 f4             	mov    %eax,-0xc(%ebp)
	...
	if (argv0)
  801a0a:	a1 70 34 c0 06       	mov    0x6c03470,%eax
  801a0f:	85 c0                	test   %eax,%eax
  801a11:	74 16                	je     801a29 <_panic+0x2e>
		cprintf("%s: ", argv0);
  801a13:	a1 70 34 c0 06       	mov    0x6c03470,%eax
  801a18:	83 ec 08             	sub    $0x8,%esp
  801a1b:	50                   	push   %eax
  801a1c:	68 44 23 80 00       	push   $0x802344
  801a21:	e8 99 e8 ff ff       	call   8002bf <cprintf>
  ...
  801a34:	50                   	push   %eax
  801a35:	68 49 23 80 00       	push   $0x802349
  801a3a:	e8 80 e8 ff ff       	call   8002bf <cprintf>
  ...
  801a4b:	50                   	push   %eax
  801a4c:	e8 03 e8 ff ff       	call   800254 <vcprintf>
  801a51:	83 c4 10             	add    $0x10,%esp
	vcprintf("\n", NULL);
  801a54:	83 ec 08             	sub    $0x8,%esp
  801a57:	6a 00                	push   $0x0
  801a59:	68 65 23 80 00       	push   $0x802365
  801a5e:	e8 f1 e7 ff ff       	call   800254 <vcprintf>
...
//		asm volatile("int3");
	...
	exit() ;
  801a66:	e8 72 e7 ff ff       	call   8001dd <exit>
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  801a85:	68 68 23 80 00       	push   $0x802368
  801a8a:	6a 26                	push   $0x26
  801a8c:	68 b4 23 80 00       	push   $0x8023b4
  ...
  801aa4:	e9 b6 00 00 00       	jmp    801b5f <CheckWSWithoutLastIndex+0xf2>
  ...
  801abe:	ff 45 f4             	incl   -0xc(%ebp)
			continue;
  801ac1:	e9 96 00 00 00       	jmp    801b5c <CheckWSWithoutLastIndex+0xef>
		}
		int found = 0;
  801ac6:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
		for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  801acd:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
  801ad4:	eb 5d                	jmp    801b33 <CheckWSWithoutLastIndex+0xc6>
			if (myEnv->__uptr_pws[w].empty == 0) {
  801ad6:	a1 20 30 80 00       	mov    0x803020,%eax
  801adb:	8b 80 80 3c 01 00    	mov    0x13c80(%eax),%eax
  801ae1:	8b 55 e8             	mov    -0x18(%ebp),%edx
  801ae4:	c1 e2 04             	shl    $0x4,%edx
  801ae7:	01 d0                	add    %edx,%eax
  801ae9:	8a 40 04             	mov    0x4(%eax),%al
  801aec:	84 c0                	test   %al,%al
  801aee:	75 40                	jne    801b30 <CheckWSWithoutLastIndex+0xc3>
				if (ROUNDDOWN(myEnv->__uptr_pws[w].virtual_address, PAGE_SIZE)
  801af0:	a1 20 30 80 00       	mov    0x803020,%eax
  801af5:	8b 80 80 3c 01 00    	mov    0x13c80(%eax),%eax
  801afb:	8b 55 e8             	mov    -0x18(%ebp),%edx
  801afe:	c1 e2 04             	shl    $0x4,%edx
  801b01:	01 d0                	add    %edx,%eax
  801b03:	8b 00                	mov    (%eax),%eax
  801b05:	89 45 dc             	mov    %eax,-0x24(%ebp)
  801b08:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801b0b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  801b10:	89 c2                	mov    %eax,%edx
						== expectedPages[e]) {
  801b12:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801b15:	8d 0c 85 00 00 00 00 	lea    0x0(,%eax,4),%ecx
  801b1c:	8b 45 08             	mov    0x8(%ebp),%eax
  801b1f:	01 c8                	add    %ecx,%eax
  801b21:	8b 00                	mov    (%eax),%eax
		...
		for (int w = 0; w < myEnv->page_WS_max_size; w++) {
			if (myEnv->__uptr_pws[w].empty == 0) {
				if (ROUNDDOWN(myEnv->__uptr_pws[w].virtual_address, PAGE_SIZE)
  801b23:	39 c2                	cmp    %eax,%edx
  801b25:	75 09                	jne    801b30 <CheckWSWithoutLastIndex+0xc3>
						== expectedPages[e]) {
					found = 1;
  801b27:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
					break;
  801b2e:	eb 12                	jmp    801b42 <CheckWSWithoutLastIndex+0xd5>
		if (expectedPages[e] == 0) {
			expectedNumOfEmptyLocs++;
			continue;
		}
		int found = 0;
		for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  801b30:	ff 45 e8             	incl   -0x18(%ebp)
  801b33:	a1 20 30 80 00       	mov    0x803020,%eax
  801b38:	8b 50 74             	mov    0x74(%eax),%edx
  801b3b:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801b3e:	39 c2                	cmp    %eax,%edx
  801b40:	77 94                	ja     801ad6 <CheckWSWithoutLastIndex+0x69>
					found = 1;
					break;
				}
			}
		...
		if (!found)
  801b42:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801b46:	75 14                	jne    801b5c <CheckWSWithoutLastIndex+0xef>
			panic(
  801b48:	83 ec 04             	sub    $0x4,%esp
  801b4b:	68 c0 23 80 00       	push   $0x8023c0
  801b50:	6a 3a                	push   $0x3a
  801b52:	68 b4 23 80 00       	push   $0x8023b4
  801b57:	e8 9f fe ff ff       	call   8019fb <_panic>
	if (arraySize != myEnv->page_WS_max_size)
	{
		panic("number of expected pages SHOULD BE EQUAL to max WS size... review your TA!!");
	}
	int expectedNumOfEmptyLocs = 0;
	for (int e = 0; e < arraySize; e++) {
  801b5c:	ff 45 f0             	incl   -0x10(%ebp)
  801b5f:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801b62:	3b 45 0c             	cmp    0xc(%ebp),%eax
  801b65:	0f 8c 3e ff ff ff    	jl     801aa9 <CheckWSWithoutLastIndex+0x3c>
		}
		if (!found)
			panic(
  ...
  801b6b:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
	for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  801b72:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
  801b79:	eb 20                	jmp    801b9b <CheckWSWithoutLastIndex+0x12e>
		if (myEnv->__uptr_pws[w].empty == 1) {
  801b7b:	a1 20 30 80 00       	mov    0x803020,%eax
  801b80:	8b 80 80 3c 01 00    	mov    0x13c80(%eax),%eax
  801b86:	8b 55 e0             	mov    -0x20(%ebp),%edx
  801b89:	c1 e2 04             	shl    $0x4,%edx
  801b8c:	01 d0                	add    %edx,%eax
  801b8e:	8a 40 04             	mov    0x4(%eax),%al
  801b91:	3c 01                	cmp    $0x1,%al
  801b93:	75 03                	jne    801b98 <CheckWSWithoutLastIndex+0x12b>
			actualNumOfEmptyLocs++;
  801b95:	ff 45 e4             	incl   -0x1c(%ebp)
		if (!found)
			panic(
					"PAGE WS entry checking failed... trace it by printing page WS before & after fault");
	}
	int actualNumOfEmptyLocs = 0;
	for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  801b98:	ff 45 e0             	incl   -0x20(%ebp)
  801b9b:	a1 20 30 80 00       	mov    0x803020,%eax
  801ba0:	8b 50 74             	mov    0x74(%eax),%edx
  801ba3:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801ba6:	39 c2                	cmp    %eax,%edx
  801ba8:	77 d1                	ja     801b7b <CheckWSWithoutLastIndex+0x10e>
		if (myEnv->__uptr_pws[w].empty == 1) {
			actualNumOfEmptyLocs++;
		}
	}
  ...
  801bad:	3b 45 e4             	cmp    -0x1c(%ebp),%eax
  801bb0:	74 14                	je     801bc6 <CheckWSWithoutLastIndex+0x159>
		panic(
  801bb2:	83 ec 04             	sub    $0x4,%esp
  801bb5:	68 14 24 80 00       	push   $0x802414
  801bba:	6a 44                	push   $0x44
  801bbc:	68 b4 23 80 00       	push   $0x8023b4
  801bc1:	e8 35 fe ff ff       	call   8019fb <_panic>
