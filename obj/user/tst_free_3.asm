...
void free(void* virtual_address)
{
  ...
  8027a7:	8b 04 85 c0 50 80 00 	mov    0x8050c0(,%eax,4),%eax
  ...
  8027d8:	8b 04 85 60 60 80 00 	mov    0x806060(,%eax,4),%eax
  ...
  8027fa:	c7 04 85 c0 50 80 00 	movl   $0x0,0x8050c0(,%eax,4)
  802801:	00 00 00 00 
    	changes++;
