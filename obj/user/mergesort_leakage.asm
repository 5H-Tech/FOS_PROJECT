...
void _main(void)
{
  ...
  8001d4:	83 c4 10             	add    $0x10,%esp
		...
		sys_disable_interrupt();
  8001d7:	e8 fa 1e 00 00       	call   8020d6 <sys_disable_interrupt>
  ...
  8001e9:	83 c4 10             	add    $0x10,%esp
		...
		sys_enable_interrupt();
  8001ec:	e8 ff 1e 00 00       	call   8020f0 <sys_enable_interrupt>
  ...
  80021a:	e8 cf 06 00 00       	call   8008ee <_panic>
		...
		{
			sys_disable_interrupt();
  80021f:	e8 b2 1e 00 00       	call   8020d6 <sys_disable_interrupt>
			cprintf("===============================================\n") ;
  ...
  800251:	83 c4 10             	add    $0x10,%esp
			sys_enable_interrupt();
  800254:	e8 97 1e 00 00       	call   8020f0 <sys_enable_interrupt>
		}
  ...
  800264:	83 c4 10             	add    $0x10,%esp
		...
		sys_disable_interrupt();
  800267:	e8 6a 1e 00 00       	call   8020d6 <sys_disable_interrupt>
			Chose = 0 ;
  ...
  8002be:	75 b2                	jne    800272 <_main+0x23a>
		...
		sys_enable_interrupt();
  8002c0:	e8 2b 1e 00 00       	call   8020f0 <sys_enable_interrupt>
...
cputchar(int ch)
{
  ...
  80071c:	50                   	push   %eax
  80071d:	e8 e8 19 00 00       	call   80210a <sys_cputc>
...
atomic_cputchar(int ch)
{
  ...
  80072b:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  80072e:	e8 a3 19 00 00       	call   8020d6 <sys_disable_interrupt>
	char c = ch;
  ...
  800740:	50                   	push   %eax
  800741:	e8 c4 19 00 00       	call   80210a <sys_cputc>
  800746:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  800749:	e8 a2 19 00 00       	call   8020f0 <sys_enable_interrupt>
}
  80074e:	90                   	nop
  80074f:	c9                   	leave  
  800750:	c3                   	ret    
...
getchar(void)
{
  ...
  80075e:	eb 08                	jmp    800768 <getchar+0x17>
	{
		c = sys_cgetc();
  800760:	e8 89 17 00 00       	call   801eee <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  800776:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800779:	e8 58 19 00 00       	call   8020d6 <sys_disable_interrupt>
	int c=0;
  ...
  800785:	eb 08                	jmp    80078f <atomic_getchar+0x1c>
	{
		c = sys_cgetc();
  800787:	e8 62 17 00 00       	call   801eee <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  800793:	74 f2                	je     800787 <atomic_getchar+0x14>
	...
	sys_enable_interrupt();
  800795:	e8 56 19 00 00       	call   8020f0 <sys_enable_interrupt>
	return c;
...
libmain(int argc, char **argv)
{
  ...
  8007af:	e8 87 17 00 00       	call   801f3b <sys_getenvindex>
  ...
  800829:	83 c4 10             	add    $0x10,%esp
	...
	sys_disable_interrupt();
  80082c:	e8 a5 18 00 00       	call   8020d6 <sys_disable_interrupt>
	cprintf("**************************************\n");
  ...
  8008ba:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  8008bd:	e8 2e 18 00 00       	call   8020f0 <sys_enable_interrupt>
...
destroy(void)
{
  ...
  8008d5:	e8 2d 16 00 00       	call   801f07 <sys_env_destroy>
...
exit(void)
{
  ...
  8008e3:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  8008e6:	e8 82 16 00 00       	call   801f6d <sys_env_exit>
}
  8008eb:	90                   	nop
  8008ec:	c9                   	leave  
  8008ed:	c3                   	ret    
...
static void putch(int ch, struct printbuf *b) {
  ...
  800b00:	51                   	push   %ecx
  800b01:	52                   	push   %edx
  800b02:	e8 be 13 00 00       	call   801ec5 <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800b78:	50                   	push   %eax
  800b79:	e8 47 13 00 00       	call   801ec5 <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  800bc0:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800bc3:	e8 0e 15 00 00       	call   8020d6 <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  800be0:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  800be3:	e8 08 15 00 00       	call   8020f0 <sys_enable_interrupt>
	return cnt;
...
void atomic_readline(const char *prompt, char* buf)
{
  ...
  801313:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  801316:	e8 bb 0d 00 00       	call   8020d6 <sys_disable_interrupt>
	int i, c, echoing;
  ...
  80136f:	83 c4 10             	add    $0x10,%esp
			sys_enable_interrupt();
  801372:	e8 79 0d 00 00       	call   8020f0 <sys_enable_interrupt>
			return;
  ...
  801407:	c6 00 00             	movb   $0x0,(%eax)
			sys_enable_interrupt();
  80140a:	e8 e1 0c 00 00       	call   8020f0 <sys_enable_interrupt>
			return;
...
void* malloc(uint32 size)
{
  ...
  801b55:	e8 13 05 00 00       	call   80206d <sys_allocateMem>
  ...
  801bd1:	50                   	push   %eax
  801bd2:	e8 96 04 00 00       	call   80206d <sys_allocateMem>
  ...
  801ce7:	e8 81 03 00 00       	call   80206d <sys_allocateMem>
...
void free(void* virtual_address)
{
  ...
  801d8a:	75 3a                	jne    801dc6 <free+0x96>
  ...
  801da2:	ff 75 e8             	pushl  -0x18(%ebp)
  801da5:	e8 a7 02 00 00       	call   802051 <sys_freeMem>
  801daa:	83 c4 10             	add    $0x10,%esp
    	changed[index]=0;
  801dad:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801db0:	c7 04 85 a0 4b 86 00 	movl   $0x0,0x864ba0(,%eax,4)
  801db7:	00 00 00 00 
    	changes++;
  801dbb:	a1 2c 30 80 00       	mov    0x80302c,%eax
  801dc0:	40                   	inc    %eax
  801dc1:	a3 2c 30 80 00       	mov    %eax,0x80302c
    }
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  801dd2:	88 45 f4             	mov    %al,-0xc(%ebp)
	panic("this function is not required...!!");
  801dd5:	83 ec 04             	sub    $0x4,%esp
  801dd8:	68 c4 2e 80 00       	push   $0x802ec4
  801ddd:	68 9f 00 00 00       	push   $0x9f
  801de2:	68 e7 2e 80 00       	push   $0x802ee7
  801de7:	e8 02 eb ff ff       	call   8008ee <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  801df5:	68 c4 2e 80 00       	push   $0x802ec4
  801dfa:	68 a5 00 00 00       	push   $0xa5
  801dff:	68 e7 2e 80 00       	push   $0x802ee7
  801e04:	e8 e5 ea ff ff       	call   8008ee <_panic>
...
void sfree(void* virtual_address)
{
  ...
  801e12:	68 c4 2e 80 00       	push   $0x802ec4
  801e17:	68 ab 00 00 00       	push   $0xab
  801e1c:	68 e7 2e 80 00       	push   $0x802ee7
  801e21:	e8 c8 ea ff ff       	call   8008ee <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  801e2f:	68 c4 2e 80 00       	push   $0x802ec4
  801e34:	68 b0 00 00 00       	push   $0xb0
  801e39:	68 e7 2e 80 00       	push   $0x802ee7
  801e3e:	e8 ab ea ff ff       	call   8008ee <_panic>
...
void expand(uint32 newSize)
{
  ...
  801e4c:	68 c4 2e 80 00       	push   $0x802ec4
  801e51:	68 b6 00 00 00       	push   $0xb6
  801e56:	68 e7 2e 80 00       	push   $0x802ee7
  801e5b:	e8 8e ea ff ff       	call   8008ee <_panic>
...
void shrink(uint32 newSize)
{
  ...
  801e69:	68 c4 2e 80 00       	push   $0x802ec4
  801e6e:	68 ba 00 00 00       	push   $0xba
  801e73:	68 e7 2e 80 00       	push   $0x802ee7
  801e78:	e8 71 ea ff ff       	call   8008ee <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  801e86:	68 c4 2e 80 00       	push   $0x802ec4
  801e8b:	68 bf 00 00 00       	push   $0xbf
  801e90:	68 e7 2e 80 00       	push   $0x802ee7
  801e95:	e8 54 ea ff ff       	call   8008ee <_panic>
...
syscall(int num, uint32 a1, uint32 a2, uint32 a3, uint32 a4, uint32 a5)
{
  ...
  801eaf:	8b 7d 18             	mov    0x18(%ebp),%edi
  801eb2:	8b 75 1c             	mov    0x1c(%ebp),%esi
  801eb5:	cd 30                	int    $0x30
...
sys_cputs(const char *s, uint32 len, uint8 printProgName)
{
  ...
  801ed1:	0f b6 55 fc          	movzbl -0x4(%ebp),%edx
  ...
  801ee3:	e8 b2 ff ff ff       	call   801e9a <syscall>
...
sys_cgetc(void)
{
  ...
  801efd:	e8 98 ff ff ff       	call   801e9a <syscall>
  801f02:	83 c4 18             	add    $0x18,%esp
}
  801f05:	c9                   	leave  
  801f06:	c3                   	ret    

00801f07 <sys_env_destroy>:
...
int sys_env_destroy(int32  envid)
{
  ...
  801f15:	50                   	push   %eax
  801f16:	6a 05                	push   $0x5
  801f18:	e8 7d ff ff ff       	call   801e9a <syscall>
  801f1d:	83 c4 18             	add    $0x18,%esp
}
  801f20:	c9                   	leave  
  801f21:	c3                   	ret    

00801f22 <sys_getenvid>:
...
int32 sys_getenvid(void)
{
  ...
  801f31:	e8 64 ff ff ff       	call   801e9a <syscall>
  801f36:	83 c4 18             	add    $0x18,%esp
}
  801f39:	c9                   	leave  
  801f3a:	c3                   	ret    

00801f3b <sys_getenvindex>:
...
int32 sys_getenvindex(void)
{
  ...
  801f48:	6a 03                	push   $0x3
  801f4a:	e8 4b ff ff ff       	call   801e9a <syscall>
  801f4f:	83 c4 18             	add    $0x18,%esp
}
  801f52:	c9                   	leave  
  801f53:	c3                   	ret    

00801f54 <sys_getparentenvid>:
...
int32 sys_getparentenvid(void)
{
  ...
  801f61:	6a 04                	push   $0x4
  801f63:	e8 32 ff ff ff       	call   801e9a <syscall>
  801f68:	83 c4 18             	add    $0x18,%esp
}
  801f6b:	c9                   	leave  
  801f6c:	c3                   	ret    

00801f6d <sys_env_exit>:
...
void sys_env_exit(void)
{
  ...
  801f7a:	6a 06                	push   $0x6
  801f7c:	e8 19 ff ff ff       	call   801e9a <syscall>
...
int __sys_allocate_page(void *va, int perm)
{
  ...
  801f9a:	e8 fb fe ff ff       	call   801e9a <syscall>
  801f9f:	83 c4 18             	add    $0x18,%esp
}
  801fa2:	c9                   	leave  
  801fa3:	c3                   	ret    

00801fa4 <__sys_map_frame>:
...
int __sys_map_frame(int32 srcenv, void *srcva, int32 dstenv, void *dstva, int perm)
{
  ...
  801fa9:	8b 75 18             	mov    0x18(%ebp),%esi
  801fac:	8b 5d 14             	mov    0x14(%ebp),%ebx
  ...
  801fbf:	e8 d6 fe ff ff       	call   801e9a <syscall>
...
int __sys_unmap_frame(int32 envid, void *va)
{
  ...
  801fdd:	52                   	push   %edx
  801fde:	50                   	push   %eax
  801fdf:	6a 09                	push   $0x9
  801fe1:	e8 b4 fe ff ff       	call   801e9a <syscall>
  801fe6:	83 c4 18             	add    $0x18,%esp
}
  801fe9:	c9                   	leave  
  801fea:	c3                   	ret    

00801feb <sys_calculate_required_frames>:
...
uint32 sys_calculate_required_frames(uint32 start_virtual_address, uint32 size)
{
  ...
  801ffc:	e8 99 fe ff ff       	call   801e9a <syscall>
  802001:	83 c4 18             	add    $0x18,%esp
}
  802004:	c9                   	leave  
  802005:	c3                   	ret    

00802006 <sys_calculate_free_frames>:
...
uint32 sys_calculate_free_frames()
{
  ...
  802015:	e8 80 fe ff ff       	call   801e9a <syscall>
  80201a:	83 c4 18             	add    $0x18,%esp
}
  80201d:	c9                   	leave  
  80201e:	c3                   	ret    

0080201f <sys_calculate_modified_frames>:
uint32 sys_calculate_modified_frames()
{
  ...
  80202e:	e8 67 fe ff ff       	call   801e9a <syscall>
  802033:	83 c4 18             	add    $0x18,%esp
}
  802036:	c9                   	leave  
  802037:	c3                   	ret    

00802038 <sys_calculate_notmod_frames>:
...
uint32 sys_calculate_notmod_frames()
{
  ...
  802047:	e8 4e fe ff ff       	call   801e9a <syscall>
  80204c:	83 c4 18             	add    $0x18,%esp
}
  80204f:	c9                   	leave  
  802050:	c3                   	ret    

00802051 <sys_freeMem>:
...
void sys_freeMem(uint32 virtual_address, uint32 size)
{
  ...
  802060:	6a 11                	push   $0x11
  802062:	e8 33 fe ff ff       	call   801e9a <syscall>
...
void sys_allocateMem(uint32 virtual_address, uint32 size)
{
  ...
  80207e:	e8 17 fe ff ff       	call   801e9a <syscall>
...
int sys_pf_calculate_allocated_pages()
{
  ...
  802096:	6a 0e                	push   $0xe
  802098:	e8 fd fd ff ff       	call   801e9a <syscall>
...
int sys_calculate_pages_tobe_removed_ready_exit(uint32 WS_or_MEMORY_flag)
{
  ...
  8020b0:	6a 0f                	push   $0xf
  8020b2:	e8 e3 fd ff ff       	call   801e9a <syscall>
...
void sys_scarce_memory()
{
  ...
  8020c9:	6a 10                	push   $0x10
  8020cb:	e8 ca fd ff ff       	call   801e9a <syscall>
...
sys_disable_interrupt()
{
  ...
  8020e5:	e8 b0 fd ff ff       	call   801e9a <syscall>
...
sys_enable_interrupt()
{
  ...
  8020ff:	e8 96 fd ff ff       	call   801e9a <syscall>
...
sys_cputc(const char c)
{
  ...
  802122:	50                   	push   %eax
  802123:	6a 16                	push   $0x16
  802125:	e8 70 fd ff ff       	call   801e9a <syscall>
...
sys_clear_ffl()
{
  ...
  80213f:	e8 56 fd ff ff       	call   801e9a <syscall>
...
sys_createSemaphore(char* semaphoreName, uint32 initialValue)
{
  ...
  802159:	50                   	push   %eax
  80215a:	6a 18                	push   $0x18
  80215c:	e8 39 fd ff ff       	call   801e9a <syscall>
...
sys_getSemaphoreValue(int32 ownerEnvID, char* semaphoreName)
{
  ...
  802175:	52                   	push   %edx
  802176:	50                   	push   %eax
  802177:	6a 1b                	push   $0x1b
  802179:	e8 1c fd ff ff       	call   801e9a <syscall>
...
sys_waitSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  802196:	e8 ff fc ff ff       	call   801e9a <syscall>
...
sys_signalSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  8021b0:	52                   	push   %edx
  8021b1:	50                   	push   %eax
  8021b2:	6a 1a                	push   $0x1a
  8021b4:	e8 e1 fc ff ff       	call   801e9a <syscall>
...
sys_createSharedObject(char* shareName, uint32 size, uint8 isWritable, void* virtual_address)
{
  ...
  8021dc:	50                   	push   %eax
  8021dd:	6a 1c                	push   $0x1c
  8021df:	e8 b6 fc ff ff       	call   801e9a <syscall>
...
sys_getSizeOfSharedObject(int32 ownerID, char* shareName)
{
  ...
  8021fc:	e8 99 fc ff ff       	call   801e9a <syscall>
...
sys_getSharedObject(int32 ownerID, char* shareName, void* virtual_address)
{
  ...
  802217:	52                   	push   %edx
  802218:	50                   	push   %eax
  802219:	6a 1e                	push   $0x1e
  80221b:	e8 7a fc ff ff       	call   801e9a <syscall>
...
sys_freeSharedObject(int32 sharedObjectID, void *startVA)
{
  ...
  802234:	52                   	push   %edx
  802235:	50                   	push   %eax
  802236:	6a 1f                	push   $0x1f
  802238:	e8 5d fc ff ff       	call   801e9a <syscall>
...
uint32 	sys_getMaxShares()
{
  ...
  802251:	e8 44 fc ff ff       	call   801e9a <syscall>
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int LRU_second_list_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  80226c:	50                   	push   %eax
  80226d:	6a 21                	push   $0x21
  80226f:	e8 26 fc ff ff       	call   801e9a <syscall>
...
sys_run_env(int32 envId)
{
  ...
  802287:	50                   	push   %eax
  802288:	6a 22                	push   $0x22
  80228a:	e8 0b fc ff ff       	call   801e9a <syscall>
...
sys_free_env(int32 envId)
{
  ...
  8022a6:	e8 ef fb ff ff       	call   801e9a <syscall>
...
sys_get_virtual_time()
{
  ...
  8022ca:	e8 cb fb ff ff       	call   801e9a <syscall>
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  8022f9:	e8 9c fb ff ff       	call   801e9a <syscall>
...
uint32 sys_rcr2()
{
  ...
  802313:	e8 82 fb ff ff       	call   801e9a <syscall>
...
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  802338:	e8 5d fb ff ff       	call   801e9a <syscall>
...
void rsttst()
{
  ...
  802352:	e8 43 fb ff ff       	call   801e9a <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  80237d:	e8 18 fb ff ff       	call   801e9a <syscall>
...
void chktst(uint32 n)
{
  ...
  802398:	e8 fd fa ff ff       	call   801e9a <syscall>
...
void inctst()
{
  ...
  8023b2:	e8 e3 fa ff ff       	call   801e9a <syscall>
...
uint32 gettst()
{
  ...
  8023cc:	e8 c9 fa ff ff       	call   801e9a <syscall>
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  8023e8:	e8 ad fa ff ff       	call   801e9a <syscall>
...
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  802419:	e8 7c fa ff ff       	call   801e9a <syscall>
...
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  80244a:	e8 4b fa ff ff       	call   801e9a <syscall>
...
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  80247b:	e8 1a fa ff ff       	call   801e9a <syscall>
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  8024aa:	e8 eb f9 ff ff       	call   801e9a <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  8024cd:	e8 c8 f9 ff ff       	call   801e9a <syscall>
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  8024ed:	e8 a8 f9 ff ff       	call   801e9a <syscall>
