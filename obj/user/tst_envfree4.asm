...
void _main(void)
{
  ...
  80004a:	e8 35 14 00 00       	call   801484 <smalloc>
  ...
  80005e:	e8 5e 16 00 00       	call   8016c1 <sys_calculate_free_frames>
  800063:	89 45 f0             	mov    %eax,-0x10(%ebp)
	int usedDiskPages_before = sys_pf_calculate_allocated_pages() ;
  800066:	e8 d9 16 00 00       	call   801744 <sys_pf_calculate_allocated_pages>
  ...
  800091:	68 63 1e 80 00       	push   $0x801e63
  800096:	e8 7b 18 00 00       	call   801916 <sys_create_env>
  ...
  8000a7:	e8 88 18 00 00       	call   801934 <sys_run_env>
  ...
  8000ba:	e8 02 16 00 00       	call   8016c1 <sys_calculate_free_frames>
  8000bf:	83 ec 08             	sub    $0x8,%esp
  8000c2:	50                   	push   %eax
  8000c3:	68 6c 1e 80 00       	push   $0x801e6c
  ...
  8000d6:	e8 75 18 00 00       	call   801950 <sys_free_env>
  8000db:	83 c4 10             	add    $0x10,%esp

	//Checking the number of frames after killing the created environments
	int freeFrames_after = sys_calculate_free_frames() ;
  8000de:	e8 de 15 00 00       	call   8016c1 <sys_calculate_free_frames>
  8000e3:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	int usedDiskPages_after = sys_pf_calculate_allocated_pages() ;
  8000e6:	e8 59 16 00 00       	call   801744 <sys_pf_calculate_allocated_pages>
  ...
  8000fc:	68 a0 1e 80 00       	push   $0x801ea0
  800101:	e8 24 04 00 00       	call   80052a <cprintf>
  800106:	83 c4 10             	add    $0x10,%esp
				freeFrames_after);
		panic("env_free() does not work correctly... check it again.");
  800109:	83 ec 04             	sub    $0x4,%esp
  80010c:	68 f0 1e 80 00       	push   $0x801ef0
  800111:	6a 1f                	push   $0x1f
  800113:	68 26 1f 80 00       	push   $0x801f26
  ...
  800133:	68 9c 1f 80 00       	push   $0x801f9c
...
libmain(int argc, char **argv)
{
  ...
  800149:	e8 a8 14 00 00       	call   8015f6 <sys_getenvindex>
  ...
  8001c6:	e8 c6 15 00 00       	call   801791 <sys_disable_interrupt>
	cprintf("**************************************\n");
  8001cb:	83 ec 0c             	sub    $0xc,%esp
  8001ce:	68 00 20 80 00       	push   $0x802000
  ...
  8001f4:	52                   	push   %edx
  8001f5:	50                   	push   %eax
  8001f6:	68 28 20 80 00       	push   $0x802028
  ...
  80021c:	52                   	push   %edx
  80021d:	50                   	push   %eax
  80021e:	68 50 20 80 00       	push   $0x802050
  ...
  800239:	50                   	push   %eax
  80023a:	68 91 20 80 00       	push   $0x802091
  80023f:	e8 e6 02 00 00       	call   80052a <cprintf>
  800244:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  800247:	83 ec 0c             	sub    $0xc,%esp
  80024a:	68 00 20 80 00       	push   $0x802000
  80024f:	e8 d6 02 00 00       	call   80052a <cprintf>
  800254:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  800257:	e8 4f 15 00 00       	call   8017ab <sys_enable_interrupt>
...
destroy(void)
{
  ...
  80026f:	e8 4e 13 00 00       	call   8015c2 <sys_env_destroy>
...
exit(void)
{
  ...
  80027d:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  800280:	e8 a3 13 00 00       	call   801628 <sys_env_exit>
}
  800285:	90                   	nop
  800286:	c9                   	leave  
  800287:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8002c1:	50                   	push   %eax
  8002c2:	68 ad 20 80 00       	push   $0x8020ad
  ...
  8002e6:	68 c9 20 80 00       	push   $0x8020c9
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800312:	68 cc 20 80 00       	push   $0x8020cc
  800317:	6a 26                	push   $0x26
  800319:	68 18 21 80 00       	push   $0x802118
  ...
  8003d8:	68 24 21 80 00       	push   $0x802124
  8003dd:	6a 3a                	push   $0x3a
  8003df:	68 18 21 80 00       	push   $0x802118
  ...
  800442:	68 78 21 80 00       	push   $0x802178
  800447:	6a 44                	push   $0x44
  800449:	68 18 21 80 00       	push   $0x802118
...
static void putch(int ch, struct printbuf *b) {
  ...
  80049a:	51                   	push   %ecx
  80049b:	52                   	push   %edx
  80049c:	e8 df 10 00 00       	call   801580 <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800512:	50                   	push   %eax
  800513:	e8 68 10 00 00       	call   801580 <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  80055a:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  80055d:	e8 2f 12 00 00       	call   801791 <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  80057a:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  80057d:	e8 29 12 00 00       	call   8017ab <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8005c7:	e8 e8 15 00 00       	call   801bb4 <__udivdi3>
  ...
  800615:	52                   	push   %edx
  800616:	50                   	push   %eax
  800617:	e8 a8 16 00 00       	call   801cc4 <__umoddi3>
...
void* malloc(uint32 size)
{
  ...
  801312:	8b 15 04 30 80 00    	mov    0x803004,%edx
  801318:	89 14 85 20 31 80 00 	mov    %edx,0x803120(,%eax,4)
			changed[sizeofarray]=1;
  80131f:	a1 2c 30 80 00       	mov    0x80302c,%eax
  801324:	c7 04 85 c0 32 80 00 	movl   $0x1,0x8032c0(,%eax,4)
  80132b:	01 00 00 00 
			sizeofarray++;
  80132f:	a1 2c 30 80 00       	mov    0x80302c,%eax
  801334:	40                   	inc    %eax
  801335:	a3 2c 30 80 00       	mov    %eax,0x80302c
			return (void*)return_addres;
  80133a:	8b 45 d8             	mov    -0x28(%ebp),%eax
  80133d:	e9 26 01 00 00       	jmp    801468 <malloc+0x1b4>
		}
		else
		{
			if(changes==0)
  801342:	a1 28 30 80 00       	mov    0x803028,%eax
  801347:	85 c0                	test   %eax,%eax
  801349:	75 62                	jne    8013ad <malloc+0xf9>
			{
				sys_allocateMem(last_addres,size);
  80134b:	a1 04 30 80 00       	mov    0x803004,%eax
  801350:	83 ec 08             	sub    $0x8,%esp
  801353:	ff 75 08             	pushl  0x8(%ebp)
  801356:	50                   	push   %eax
  801357:	e8 cc 03 00 00       	call   801728 <sys_allocateMem>
  80135c:	83 c4 10             	add    $0x10,%esp
				return_addres=last_addres;
  80135f:	a1 04 30 80 00       	mov    0x803004,%eax
  801364:	89 45 d8             	mov    %eax,-0x28(%ebp)
				last_addres+=num*PAGE_SIZE;
  801367:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80136a:	c1 e0 0c             	shl    $0xc,%eax
  80136d:	89 c2                	mov    %eax,%edx
  80136f:	a1 04 30 80 00       	mov    0x803004,%eax
  801374:	01 d0                	add    %edx,%eax
  801376:	a3 04 30 80 00       	mov    %eax,0x803004
				addresses[sizeofarray]=return_addres;
  80137b:	a1 2c 30 80 00       	mov    0x80302c,%eax
  801380:	8b 55 d8             	mov    -0x28(%ebp),%edx
  801383:	89 14 85 20 31 80 00 	mov    %edx,0x803120(,%eax,4)
				changed[sizeofarray]=1;
  80138a:	a1 2c 30 80 00       	mov    0x80302c,%eax
  80138f:	c7 04 85 c0 32 80 00 	movl   $0x1,0x8032c0(,%eax,4)
  801396:	01 00 00 00 
				sizeofarray++;
  80139a:	a1 2c 30 80 00       	mov    0x80302c,%eax
  80139f:	40                   	inc    %eax
  8013a0:	a3 2c 30 80 00       	mov    %eax,0x80302c
				return (void*)return_addres;
  8013a5:	8b 45 d8             	mov    -0x28(%ebp),%eax
  8013a8:	e9 bb 00 00 00       	jmp    801468 <malloc+0x1b4>
			}
			else{
				int count=0;
  8013ad:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
				int min=1000;
  8013b4:	c7 45 ec e8 03 00 00 	movl   $0x3e8,-0x14(%ebp)
				int index=-1;
  8013bb:	c7 45 e8 ff ff ff ff 	movl   $0xffffffff,-0x18(%ebp)
				uint32 min_addresss;
				for(uint32 i=USER_HEAP_START;i<USER_HEAP_MAX;i+=PAGE_SIZE)
  8013c2:	c7 45 e0 00 00 00 80 	movl   $0x80000000,-0x20(%ebp)
  8013c9:	eb 7c                	jmp    801447 <malloc+0x193>
				{
					uint32 *pg=NULL;
  8013cb:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
					for(int j=0;j<sizeofarray;j++)
  8013d2:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
  8013d9:	eb 1a                	jmp    8013f5 <malloc+0x141>
					{
						if(addresses[j]==i)
  8013db:	8b 45 dc             	mov    -0x24(%ebp),%eax
  8013de:	8b 04 85 20 31 80 00 	mov    0x803120(,%eax,4),%eax
  8013e5:	3b 45 e0             	cmp    -0x20(%ebp),%eax
  8013e8:	75 08                	jne    8013f2 <malloc+0x13e>
						{
							index=j;
  8013ea:	8b 45 dc             	mov    -0x24(%ebp),%eax
  8013ed:	89 45 e8             	mov    %eax,-0x18(%ebp)
							break;
  8013f0:	eb 0d                	jmp    8013ff <malloc+0x14b>
				int index=-1;
				uint32 min_addresss;
				for(uint32 i=USER_HEAP_START;i<USER_HEAP_MAX;i+=PAGE_SIZE)
				{
					uint32 *pg=NULL;
					for(int j=0;j<sizeofarray;j++)
  8013f2:	ff 45 dc             	incl   -0x24(%ebp)
  8013f5:	a1 2c 30 80 00       	mov    0x80302c,%eax
  8013fa:	39 45 dc             	cmp    %eax,-0x24(%ebp)
  8013fd:	7c dc                	jl     8013db <malloc+0x127>
							index=j;
							break;
						}
					}
					...
					if(index==-1)
  8013ff:	83 7d e8 ff          	cmpl   $0xffffffff,-0x18(%ebp)
  801403:	75 05                	jne    80140a <malloc+0x156>
					{
						count++;
  801405:	ff 45 f0             	incl   -0x10(%ebp)
  801408:	eb 36                	jmp    801440 <malloc+0x18c>
					}
					else
					{
						if(changed[index]==0)
  80140a:	8b 45 e8             	mov    -0x18(%ebp),%eax
  80140d:	8b 04 85 c0 32 80 00 	mov    0x8032c0(,%eax,4),%eax
  801414:	85 c0                	test   %eax,%eax
  801416:	75 05                	jne    80141d <malloc+0x169>
						{
							count++;
  801418:	ff 45 f0             	incl   -0x10(%ebp)
  80141b:	eb 23                	jmp    801440 <malloc+0x18c>
						}
						else
						{
							if(count<min&&count>=num)
  80141d:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801420:	3b 45 ec             	cmp    -0x14(%ebp),%eax
  801423:	7d 14                	jge    801439 <malloc+0x185>
  801425:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801428:	3b 45 f4             	cmp    -0xc(%ebp),%eax
  80142b:	7c 0c                	jl     801439 <malloc+0x185>
							{
								min=count;
  ...
  801436:	89 45 e4             	mov    %eax,-0x1c(%ebp)
							}
							count=0;
  801439:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
				...
				uint32 min_addresss;
				for(uint32 i=USER_HEAP_START;i<USER_HEAP_MAX;i+=PAGE_SIZE)
  801440:	81 45 e0 00 10 00 00 	addl   $0x1000,-0x20(%ebp)
  801447:	81 7d e0 ff ff ff 9f 	cmpl   $0x9fffffff,-0x20(%ebp)
  80144e:	0f 86 77 ff ff ff    	jbe    8013cb <malloc+0x117>
  ...
  80145d:	e8 c6 02 00 00       	call   801728 <sys_allocateMem>
...
void free(void* virtual_address)
{
  ...
  801473:	68 70 25 80 00       	push   $0x802570
  801478:	6a 7b                	push   $0x7b
  80147a:	68 93 25 80 00       	push   $0x802593
  80147f:	e8 04 ee ff ff       	call   800288 <_panic>
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  80148d:	88 45 f4             	mov    %al,-0xc(%ebp)
	panic("this function is not required...!!");
  801490:	83 ec 04             	sub    $0x4,%esp
  801493:	68 a0 25 80 00       	push   $0x8025a0
  801498:	68 88 00 00 00       	push   $0x88
  80149d:	68 93 25 80 00       	push   $0x802593
  8014a2:	e8 e1 ed ff ff       	call   800288 <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  8014b0:	68 a0 25 80 00       	push   $0x8025a0
  8014b5:	68 8e 00 00 00       	push   $0x8e
  8014ba:	68 93 25 80 00       	push   $0x802593
  8014bf:	e8 c4 ed ff ff       	call   800288 <_panic>
...
void sfree(void* virtual_address)
{
  ...
  8014cd:	68 a0 25 80 00       	push   $0x8025a0
  8014d2:	68 94 00 00 00       	push   $0x94
  8014d7:	68 93 25 80 00       	push   $0x802593
  8014dc:	e8 a7 ed ff ff       	call   800288 <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  8014ea:	68 a0 25 80 00       	push   $0x8025a0
  8014ef:	68 99 00 00 00       	push   $0x99
  8014f4:	68 93 25 80 00       	push   $0x802593
  8014f9:	e8 8a ed ff ff       	call   800288 <_panic>
...
void expand(uint32 newSize)
{
  ...
  801507:	68 a0 25 80 00       	push   $0x8025a0
  80150c:	68 9f 00 00 00       	push   $0x9f
  801511:	68 93 25 80 00       	push   $0x802593
  801516:	e8 6d ed ff ff       	call   800288 <_panic>
...
void shrink(uint32 newSize)
{
  ...
  801524:	68 a0 25 80 00       	push   $0x8025a0
  801529:	68 a3 00 00 00       	push   $0xa3
  80152e:	68 93 25 80 00       	push   $0x802593
  801533:	e8 50 ed ff ff       	call   800288 <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  801541:	68 a0 25 80 00       	push   $0x8025a0
  801546:	68 a8 00 00 00       	push   $0xa8
  80154b:	68 93 25 80 00       	push   $0x802593
  801550:	e8 33 ed ff ff       	call   800288 <_panic>
...
int sys_env_destroy(int32  envid)
{
  ...
  8015d3:	e8 7d ff ff ff       	call   801555 <syscall>
  8015d8:	83 c4 18             	add    $0x18,%esp
}
  8015db:	c9                   	leave  
  8015dc:	c3                   	ret    

008015dd <sys_getenvid>:
...
int32 sys_getenvid(void)
{
  ...
  8015ea:	6a 02                	push   $0x2
  8015ec:	e8 64 ff ff ff       	call   801555 <syscall>
  8015f1:	83 c4 18             	add    $0x18,%esp
}
  8015f4:	c9                   	leave  
  8015f5:	c3                   	ret    

008015f6 <sys_getenvindex>:
...
int32 sys_getenvindex(void)
{
  ...
  801603:	6a 03                	push   $0x3
  801605:	e8 4b ff ff ff       	call   801555 <syscall>
  80160a:	83 c4 18             	add    $0x18,%esp
}
  80160d:	c9                   	leave  
  80160e:	c3                   	ret    

0080160f <sys_getparentenvid>:
...
int32 sys_getparentenvid(void)
{
  ...
  80161c:	6a 04                	push   $0x4
  80161e:	e8 32 ff ff ff       	call   801555 <syscall>
  801623:	83 c4 18             	add    $0x18,%esp
}
  801626:	c9                   	leave  
  801627:	c3                   	ret    

00801628 <sys_env_exit>:
...
void sys_env_exit(void)
{
  ...
  801637:	e8 19 ff ff ff       	call   801555 <syscall>
...
int __sys_allocate_page(void *va, int perm)
{
  ...
  801655:	e8 fb fe ff ff       	call   801555 <syscall>
  80165a:	83 c4 18             	add    $0x18,%esp
}
  80165d:	c9                   	leave  
  80165e:	c3                   	ret    

0080165f <__sys_map_frame>:
...
int __sys_map_frame(int32 srcenv, void *srcva, int32 dstenv, void *dstva, int perm)
{
  ...
  801664:	8b 75 18             	mov    0x18(%ebp),%esi
  801667:	8b 5d 14             	mov    0x14(%ebp),%ebx
  80166a:	8b 4d 10             	mov    0x10(%ebp),%ecx
  ...
  801676:	52                   	push   %edx
  801677:	50                   	push   %eax
  801678:	6a 08                	push   $0x8
  80167a:	e8 d6 fe ff ff       	call   801555 <syscall>
...
int __sys_unmap_frame(int32 envid, void *va)
{
  ...
  801698:	52                   	push   %edx
  801699:	50                   	push   %eax
  80169a:	6a 09                	push   $0x9
  80169c:	e8 b4 fe ff ff       	call   801555 <syscall>
...
uint32 sys_calculate_required_frames(uint32 start_virtual_address, uint32 size)
{
  ...
  8016b7:	e8 99 fe ff ff       	call   801555 <syscall>
...
uint32 sys_calculate_free_frames()
{
  ...
  8016d0:	e8 80 fe ff ff       	call   801555 <syscall>
...
void sys_freeMem(uint32 virtual_address, uint32 size)
{
  ...
  80171b:	6a 11                	push   $0x11
  80171d:	e8 33 fe ff ff       	call   801555 <syscall>
...
void sys_allocateMem(uint32 virtual_address, uint32 size)
{
  ...
  801737:	6a 12                	push   $0x12
  801739:	e8 17 fe ff ff       	call   801555 <syscall>
...
00801744 <sys_pf_calculate_allocated_pages>:
...
int sys_pf_calculate_allocated_pages()
{
  ...
  801753:	e8 fd fd ff ff       	call   801555 <syscall>
  801758:	83 c4 18             	add    $0x18,%esp
}
  80175b:	c9                   	leave  
  80175c:	c3                   	ret    

0080175d <sys_calculate_pages_tobe_removed_ready_exit>:
...
void sys_scarce_memory()
{
  ...
  801786:	e8 ca fd ff ff       	call   801555 <syscall>
...
00801791 <sys_disable_interrupt>:
...
sys_disable_interrupt()
{
  ...
  80179e:	6a 14                	push   $0x14
  8017a0:	e8 b0 fd ff ff       	call   801555 <syscall>
...
sys_enable_interrupt()
{
  ...
  8017b8:	6a 15                	push   $0x15
  8017ba:	e8 96 fd ff ff       	call   801555 <syscall>
...
sys_cputc(const char c)
{
  ...
  8017e0:	e8 70 fd ff ff       	call   801555 <syscall>
...
sys_clear_ffl()
{
  ...
  8017f8:	6a 17                	push   $0x17
  8017fa:	e8 56 fd ff ff       	call   801555 <syscall>
...
sys_createSemaphore(char* semaphoreName, uint32 initialValue)
{
  ...
  801817:	e8 39 fd ff ff       	call   801555 <syscall>
  80181c:	83 c4 18             	add    $0x18,%esp
}
  80181f:	c9                   	leave  
  801820:	c3                   	ret    

00801821 <sys_getSemaphoreValue>:
...
sys_waitSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801851:	e8 ff fc ff ff       	call   801555 <syscall>
...
sys_signalSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  80186f:	e8 e1 fc ff ff       	call   801555 <syscall>
...
0080187a <sys_createSharedObject>:
...
sys_createSharedObject(char* shareName, uint32 size, uint8 isWritable, void* virtual_address)
{
  ...
  801886:	8b 4d 14             	mov    0x14(%ebp),%ecx
  ...
  801897:	50                   	push   %eax
  801898:	6a 1c                	push   $0x1c
  80189a:	e8 b6 fc ff ff       	call   801555 <syscall>
  80189f:	83 c4 18             	add    $0x18,%esp
}
  8018a2:	c9                   	leave  
  8018a3:	c3                   	ret    

008018a4 <sys_getSizeOfSharedObject>:
...
sys_getSizeOfSharedObject(int32 ownerID, char* shareName)
{
  ...
  8018b7:	e8 99 fc ff ff       	call   801555 <syscall>
  8018bc:	83 c4 18             	add    $0x18,%esp
}
  8018bf:	c9                   	leave  
  8018c0:	c3                   	ret    

008018c1 <sys_getSharedObject>:
//==========
...
sys_getSharedObject(int32 ownerID, char* shareName, void* virtual_address)
{
  ...
  8018d2:	52                   	push   %edx
  8018d3:	50                   	push   %eax
  8018d4:	6a 1e                	push   $0x1e
  8018d6:	e8 7a fc ff ff       	call   801555 <syscall>
  8018db:	83 c4 18             	add    $0x18,%esp
}
  8018de:	c9                   	leave  
  8018df:	c3                   	ret    

008018e0 <sys_freeSharedObject>:
...
sys_freeSharedObject(int32 sharedObjectID, void *startVA)
{
  ...
  8018ef:	52                   	push   %edx
  8018f0:	50                   	push   %eax
  8018f1:	6a 1f                	push   $0x1f
  8018f3:	e8 5d fc ff ff       	call   801555 <syscall>
  8018f8:	83 c4 18             	add    $0x18,%esp
}
  8018fb:	c9                   	leave  
  8018fc:	c3                   	ret    

008018fd <sys_getMaxShares>:
...
uint32 	sys_getMaxShares()
{
  ...
  80190c:	e8 44 fc ff ff       	call   801555 <syscall>
  801911:	83 c4 18             	add    $0x18,%esp
}
  801914:	c9                   	leave  
  801915:	c3                   	ret    

00801916 <sys_create_env>:
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int LRU_second_list_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  801927:	50                   	push   %eax
  801928:	6a 21                	push   $0x21
  80192a:	e8 26 fc ff ff       	call   801555 <syscall>
  80192f:	83 c4 18             	add    $0x18,%esp
}
  801932:	c9                   	leave  
  801933:	c3                   	ret    

00801934 <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  801942:	50                   	push   %eax
  801943:	6a 22                	push   $0x22
  801945:	e8 0b fc ff ff       	call   801555 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  80195e:	50                   	push   %eax
  80195f:	6a 23                	push   $0x23
  801961:	e8 ef fb ff ff       	call   801555 <syscall>
...
sys_get_virtual_time()
{
  ...
  801975:	8d 50 04             	lea    0x4(%eax),%edx
  ...
  801981:	52                   	push   %edx
  801982:	50                   	push   %eax
  801983:	6a 24                	push   $0x24
  801985:	e8 cb fb ff ff       	call   801555 <syscall>
  80198a:	83 c4 18             	add    $0x18,%esp
	return result;
  80198d:	8b 4d 08             	mov    0x8(%ebp),%ecx
  801990:	8b 45 f8             	mov    -0x8(%ebp),%eax
  801993:	8b 55 fc             	mov    -0x4(%ebp),%edx
  801996:	89 01                	mov    %eax,(%ecx)
  801998:	89 51 04             	mov    %edx,0x4(%ecx)
}
  80199b:	8b 45 08             	mov    0x8(%ebp),%eax
  80199e:	c9                   	leave  
  80199f:	c2 04 00             	ret    $0x4

008019a2 <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  8019b4:	e8 9c fb ff ff       	call   801555 <syscall>
...
uint32 sys_rcr2()
{
  ...
  8019cc:	6a 25                	push   $0x25
  8019ce:	e8 82 fb ff ff       	call   801555 <syscall>
  8019d3:	83 c4 18             	add    $0x18,%esp
}
  8019d6:	c9                   	leave  
  8019d7:	c3                   	ret    

008019d8 <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  8019e4:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  ...
  8019f3:	e8 5d fb ff ff       	call   801555 <syscall>
...
void rsttst()
{
  ...
  801a0b:	6a 28                	push   $0x28
  801a0d:	e8 43 fb ff ff       	call   801555 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801a24:	8b 55 18             	mov    0x18(%ebp),%edx
  801a27:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
  801a2b:	52                   	push   %edx
  801a2c:	50                   	push   %eax
  801a2d:	ff 75 10             	pushl  0x10(%ebp)
  801a30:	ff 75 0c             	pushl  0xc(%ebp)
  801a33:	ff 75 08             	pushl  0x8(%ebp)
  801a36:	6a 27                	push   $0x27
  801a38:	e8 18 fb ff ff       	call   801555 <syscall>
...
void chktst(uint32 n)
{
  ...
  801a51:	6a 29                	push   $0x29
  801a53:	e8 fd fa ff ff       	call   801555 <syscall>
...
void inctst()
{
  ...
  801a6d:	e8 e3 fa ff ff       	call   801555 <syscall>
...
uint32 gettst()
{
  ...
  801a85:	6a 2b                	push   $0x2b
  801a87:	e8 c9 fa ff ff       	call   801555 <syscall>
  801a8c:	83 c4 18             	add    $0x18,%esp
}
  801a8f:	c9                   	leave  
  801a90:	c3                   	ret    

00801a91 <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  801aa3:	e8 ad fa ff ff       	call   801555 <syscall>
  801aa8:	83 c4 18             	add    $0x18,%esp
  801aab:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  801aae:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  801ab2:	75 07                	jne    801abb <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  801ab4:	b8 01 00 00 00       	mov    $0x1,%eax
  801ab9:	eb 05                	jmp    801ac0 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
00801ac2 <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801ad4:	e8 7c fa ff ff       	call   801555 <syscall>
  801ad9:	83 c4 18             	add    $0x18,%esp
  801adc:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  801adf:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  801ae3:	75 07                	jne    801aec <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  801ae5:	b8 01 00 00 00       	mov    $0x1,%eax
  801aea:	eb 05                	jmp    801af1 <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
00801af3 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801b05:	e8 4b fa ff ff       	call   801555 <syscall>
  801b0a:	83 c4 18             	add    $0x18,%esp
  801b0d:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  801b10:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  801b14:	75 07                	jne    801b1d <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  801b16:	b8 01 00 00 00       	mov    $0x1,%eax
  801b1b:	eb 05                	jmp    801b22 <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
00801b24 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801b36:	e8 1a fa ff ff       	call   801555 <syscall>
  801b3b:	83 c4 18             	add    $0x18,%esp
  801b3e:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  801b41:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  801b45:	75 07                	jne    801b4e <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  801b47:	b8 01 00 00 00       	mov    $0x1,%eax
  801b4c:	eb 05                	jmp    801b53 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
00801b55 <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801b65:	e8 eb f9 ff ff       	call   801555 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801b74:	8b 5d 14             	mov    0x14(%ebp),%ebx
  ...
  801b88:	e8 c8 f9 ff ff       	call   801555 <syscall>
...
00801b95 <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  801ba4:	52                   	push   %edx
  801ba5:	50                   	push   %eax
  801ba6:	6a 2f                	push   $0x2f
  801ba8:	e8 a8 f9 ff ff       	call   801555 <syscall>
