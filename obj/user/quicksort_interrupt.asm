...
{	
  ...
  800049:	e8 a1 1b 00 00       	call   801bef <sys_calculate_free_frames>
  80004e:	89 c3                	mov    %eax,%ebx
  800050:	e8 b3 1b 00 00       	call   801c08 <sys_calculate_modified_frames>
...
//	sys_disable_interrupt();
		...
		sys_disable_interrupt();
  80005d:	e8 5d 1c 00 00       	call   801cbf <sys_disable_interrupt>
  ...
  8000ea:	68 d0 23 80 00       	push   $0x8023d0
  ...
  80012e:	e8 a6 1b 00 00       	call   801cd9 <sys_enable_interrupt>
		//sys_enable_interrupt();
		int  i ;
		switch (Chose)
  ...
  8001be:	68 dc 23 80 00       	push   $0x8023dc
  8001c3:	6a 46                	push   $0x46
  8001c5:	68 fe 23 80 00       	push   $0x8023fe
  8001ca:	e8 92 05 00 00       	call   800761 <_panic>
		else
		{ 
			sys_disable_interrupt();
  8001cf:	e8 eb 1a 00 00       	call   801cbf <sys_disable_interrupt>
				cprintf("\n===============================================\n") ;
  8001d4:	83 ec 0c             	sub    $0xc,%esp
  8001d7:	68 1c 24 80 00       	push   $0x80241c
  8001dc:	e8 22 08 00 00       	call   800a03 <cprintf>
  8001e1:	83 c4 10             	add    $0x10,%esp
				cprintf("Congratulations!! The array is sorted correctly\n") ;
  8001e4:	83 ec 0c             	sub    $0xc,%esp
  8001e7:	68 50 24 80 00       	push   $0x802450
  8001ec:	e8 12 08 00 00       	call   800a03 <cprintf>
  8001f1:	83 c4 10             	add    $0x10,%esp
				cprintf("===============================================\n\n") ;
  8001f4:	83 ec 0c             	sub    $0xc,%esp
  8001f7:	68 84 24 80 00       	push   $0x802484
  8001fc:	e8 02 08 00 00       	call   800a03 <cprintf>
  800201:	83 c4 10             	add    $0x10,%esp
			sys_enable_interrupt();
  800204:	e8 d0 1a 00 00       	call   801cd9 <sys_enable_interrupt>
		}

		//		cprintf("Free Frames After Calculation = %d\n", sys_calculate_free_frames()) ;

		sys_disable_interrupt();
  800209:	e8 b1 1a 00 00       	call   801cbf <sys_disable_interrupt>
			cprintf("Freeing the Heap...\n\n") ;
  80020e:	83 ec 0c             	sub    $0xc,%esp
  800211:	68 b6 24 80 00       	push   $0x8024b6
  800216:	e8 e8 07 00 00       	call   800a03 <cprintf>
  80021b:	83 c4 10             	add    $0x10,%esp
		sys_enable_interrupt();
  80021e:	e8 b6 1a 00 00       	call   801cd9 <sys_enable_interrupt>
	...
	//sys_disable_interrupt();
		sys_disable_interrupt();
  800223:	e8 97 1a 00 00       	call   801cbf <sys_disable_interrupt>
			cprintf("Do you want to repeat (y/n): ") ;
  800228:	83 ec 0c             	sub    $0xc,%esp
  80022b:	68 cc 24 80 00       	push   $0x8024cc
  ...
  800267:	83 c4 10             	add    $0x10,%esp
	//sys_enable_interrupt();
		sys_enable_interrupt();
  80026a:	e8 6a 1a 00 00       	call   801cd9 <sys_enable_interrupt>
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  8004ef:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8004f2:	e8 c8 17 00 00       	call   801cbf <sys_disable_interrupt>
		int i ;
		int NumsPerLine = 20 ;
  ...
  800517:	68 ea 24 80 00       	push   $0x8024ea
  ...
  800538:	50                   	push   %eax
  800539:	68 ec 24 80 00       	push   $0x8024ec
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  800566:	50                   	push   %eax
  800567:	68 f1 24 80 00       	push   $0x8024f1
  80056c:	e8 92 04 00 00       	call   800a03 <cprintf>
  800571:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  800574:	e8 60 17 00 00       	call   801cd9 <sys_enable_interrupt>
}
  800579:	90                   	nop
  80057a:	c9                   	leave  
  80057b:	c3                   	ret    
...
cputchar(int ch)
{
  ...
  80058f:	50                   	push   %eax
  800590:	e8 5e 17 00 00       	call   801cf3 <sys_cputc>
...
atomic_cputchar(int ch)
{
  ...
  80059e:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8005a1:	e8 19 17 00 00       	call   801cbf <sys_disable_interrupt>
	char c = ch;
  ...
  8005b3:	50                   	push   %eax
  8005b4:	e8 3a 17 00 00       	call   801cf3 <sys_cputc>
  8005b9:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  8005bc:	e8 18 17 00 00       	call   801cd9 <sys_enable_interrupt>
}
  8005c1:	90                   	nop
  8005c2:	c9                   	leave  
  8005c3:	c3                   	ret    
...
getchar(void)
{
  ...
  8005d1:	eb 08                	jmp    8005db <getchar+0x17>
	{
		c = sys_cgetc();
  8005d3:	e8 ff 14 00 00       	call   801ad7 <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  8005e9:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8005ec:	e8 ce 16 00 00       	call   801cbf <sys_disable_interrupt>
	int c=0;
  ...
  8005f8:	eb 08                	jmp    800602 <atomic_getchar+0x1c>
	{
		c = sys_cgetc();
  8005fa:	e8 d8 14 00 00       	call   801ad7 <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  800606:	74 f2                	je     8005fa <atomic_getchar+0x14>
	...
	sys_enable_interrupt();
  800608:	e8 cc 16 00 00       	call   801cd9 <sys_enable_interrupt>
	return c;
...
libmain(int argc, char **argv)
{
  ...
  800622:	e8 fd 14 00 00       	call   801b24 <sys_getenvindex>
  ...
  80069c:	83 c4 10             	add    $0x10,%esp
	...
	sys_disable_interrupt();
  80069f:	e8 1b 16 00 00       	call   801cbf <sys_disable_interrupt>
	cprintf("**************************************\n");
  8006a4:	83 ec 0c             	sub    $0xc,%esp
  8006a7:	68 10 25 80 00       	push   $0x802510
  ...
  8006cd:	52                   	push   %edx
  8006ce:	50                   	push   %eax
  8006cf:	68 38 25 80 00       	push   $0x802538
  ...
  8006f5:	52                   	push   %edx
  8006f6:	50                   	push   %eax
  8006f7:	68 60 25 80 00       	push   $0x802560
  ...
  800712:	50                   	push   %eax
  800713:	68 a1 25 80 00       	push   $0x8025a1
  800718:	e8 e6 02 00 00       	call   800a03 <cprintf>
  80071d:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  800720:	83 ec 0c             	sub    $0xc,%esp
  800723:	68 10 25 80 00       	push   $0x802510
  800728:	e8 d6 02 00 00       	call   800a03 <cprintf>
  80072d:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  800730:	e8 a4 15 00 00       	call   801cd9 <sys_enable_interrupt>
...
destroy(void)
{
  ...
  800748:	e8 a3 13 00 00       	call   801af0 <sys_env_destroy>
...
exit(void)
{
  ...
  800756:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  800759:	e8 f8 13 00 00       	call   801b56 <sys_env_exit>
}
  80075e:	90                   	nop
  80075f:	c9                   	leave  
  800760:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800781:	50                   	push   %eax
  800782:	68 b8 25 80 00       	push   $0x8025b8
  ...
  80079a:	50                   	push   %eax
  80079b:	68 bd 25 80 00       	push   $0x8025bd
  ...
  8007bf:	68 d9 25 80 00       	push   $0x8025d9
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  8007eb:	68 dc 25 80 00       	push   $0x8025dc
  8007f0:	6a 26                	push   $0x26
  8007f2:	68 28 26 80 00       	push   $0x802628
  ...
  8008b1:	68 34 26 80 00       	push   $0x802634
  8008b6:	6a 3a                	push   $0x3a
  8008b8:	68 28 26 80 00       	push   $0x802628
  ...
  800922:	68 28 26 80 00       	push   $0x802628
...
static void putch(int ch, struct printbuf *b) {
  ...
  800973:	51                   	push   %ecx
  800974:	52                   	push   %edx
  800975:	e8 34 11 00 00       	call   801aae <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  8009eb:	50                   	push   %eax
  8009ec:	e8 bd 10 00 00       	call   801aae <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  800a33:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800a36:	e8 84 12 00 00       	call   801cbf <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  800a53:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  800a56:	e8 7e 12 00 00       	call   801cd9 <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800aa0:	e8 3b 16 00 00       	call   8020e0 <__udivdi3>
  ...
  800aee:	52                   	push   %edx
  800aef:	50                   	push   %eax
  800af0:	e8 fb 16 00 00       	call   8021f0 <__umoddi3>
  800af5:	83 c4 10             	add    $0x10,%esp
  800af8:	05 f4 28 80 00       	add    $0x8028f4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800c4b:	8b 04 85 18 29 80 00 	mov    0x802918(,%eax,4),%eax
  ...
  800d2c:	8b 34 9d 60 27 80 00 	mov    0x802760(,%ebx,4),%esi
  800d33:	85 f6                	test   %esi,%esi
  800d35:	75 19                	jne    800d50 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800d37:	53                   	push   %ebx
  800d38:	68 05 29 80 00       	push   $0x802905
  ...
  800d4b:	e9 49 02 00 00       	jmp    800f99 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800d50:	56                   	push   %esi
  800d51:	68 0e 29 80 00       	push   $0x80290e
  ...
  800d7c:	75 05                	jne    800d83 <vprintfmt+0x1a6>
				p = "(null)";
  800d7e:	be 11 29 80 00       	mov    $0x802911,%esi
			if (width > 0 && padc != '-')
...
void readline(const char *prompt, char* buf)
{
  ...
  801097:	68 70 2a 80 00       	push   $0x802a70
  ...
  8010d9:	68 73 2a 80 00       	push   $0x802a73
...
void atomic_readline(const char *prompt, char* buf)
{
  ...
  801186:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  801189:	e8 31 0b 00 00       	call   801cbf <sys_disable_interrupt>
	int i, c, echoing;
  ...
  80119a:	68 70 2a 80 00       	push   $0x802a70
  ...
  8011d8:	68 73 2a 80 00       	push   $0x802a73
  8011dd:	e8 21 f8 ff ff       	call   800a03 <cprintf>
  8011e2:	83 c4 10             	add    $0x10,%esp
			sys_enable_interrupt();
  8011e5:	e8 ef 0a 00 00       	call   801cd9 <sys_enable_interrupt>
			return;
  ...
  80127a:	c6 00 00             	movb   $0x0,(%eax)
			sys_enable_interrupt();
  80127d:	e8 57 0a 00 00       	call   801cd9 <sys_enable_interrupt>
			return;
...
void* malloc(uint32 size)
{
  ...
  80199c:	68 84 2a 80 00       	push   $0x802a84
  8019a1:	6a 16                	push   $0x16
  8019a3:	68 a9 2a 80 00       	push   $0x802aa9
  8019a8:	e8 b4 ed ff ff       	call   800761 <_panic>
...
void free(void* virtual_address)
{
  ...
  8019b6:	68 b8 2a 80 00       	push   $0x802ab8
  8019bb:	6a 2e                	push   $0x2e
  8019bd:	68 a9 2a 80 00       	push   $0x802aa9
  8019c2:	e8 9a ed ff ff       	call   800761 <_panic>
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  8019d0:	88 45 f4             	mov    %al,-0xc(%ebp)
	panic("this function is not required...!!");
  8019d3:	83 ec 04             	sub    $0x4,%esp
  8019d6:	68 dc 2a 80 00       	push   $0x802adc
  8019db:	6a 3b                	push   $0x3b
  8019dd:	68 a9 2a 80 00       	push   $0x802aa9
  8019e2:	e8 7a ed ff ff       	call   800761 <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  8019f0:	68 dc 2a 80 00       	push   $0x802adc
  8019f5:	6a 41                	push   $0x41
  8019f7:	68 a9 2a 80 00       	push   $0x802aa9
  8019fc:	e8 60 ed ff ff       	call   800761 <_panic>
...
void sfree(void* virtual_address)
{
  ...
  801a0a:	68 dc 2a 80 00       	push   $0x802adc
  801a0f:	6a 47                	push   $0x47
  801a11:	68 a9 2a 80 00       	push   $0x802aa9
  801a16:	e8 46 ed ff ff       	call   800761 <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  801a24:	68 dc 2a 80 00       	push   $0x802adc
  801a29:	6a 4c                	push   $0x4c
  801a2b:	68 a9 2a 80 00       	push   $0x802aa9
  801a30:	e8 2c ed ff ff       	call   800761 <_panic>
...
void expand(uint32 newSize)
{
  ...
  801a3e:	68 dc 2a 80 00       	push   $0x802adc
  801a43:	6a 52                	push   $0x52
  801a45:	68 a9 2a 80 00       	push   $0x802aa9
  801a4a:	e8 12 ed ff ff       	call   800761 <_panic>
...
void shrink(uint32 newSize)
{
  ...
  801a58:	68 dc 2a 80 00       	push   $0x802adc
  801a5d:	6a 56                	push   $0x56
  801a5f:	68 a9 2a 80 00       	push   $0x802aa9
  801a64:	e8 f8 ec ff ff       	call   800761 <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  801a72:	68 dc 2a 80 00       	push   $0x802adc
  801a77:	6a 5b                	push   $0x5b
  801a79:	68 a9 2a 80 00       	push   $0x802aa9
  801a7e:	e8 de ec ff ff       	call   800761 <_panic>
...
sys_cputs(const char *s, uint32 len, uint8 printProgName)
{
  ...
  801aba:	0f b6 55 fc          	movzbl -0x4(%ebp),%edx
  ...
  801acc:	e8 b2 ff ff ff       	call   801a83 <syscall>
...
sys_cgetc(void)
{
  ...
  801ae6:	e8 98 ff ff ff       	call   801a83 <syscall>
  801aeb:	83 c4 18             	add    $0x18,%esp
}
  801aee:	c9                   	leave  
  801aef:	c3                   	ret    

00801af0 <sys_env_destroy>:
...
int32 sys_getenvid(void)
{
  ...
  801b1a:	e8 64 ff ff ff       	call   801a83 <syscall>
  801b1f:	83 c4 18             	add    $0x18,%esp
}
  801b22:	c9                   	leave  
  801b23:	c3                   	ret    

00801b24 <sys_getenvindex>:
...
int32 sys_getenvindex(void)
{
  ...
  801b31:	6a 03                	push   $0x3
  801b33:	e8 4b ff ff ff       	call   801a83 <syscall>
  801b38:	83 c4 18             	add    $0x18,%esp
}
  801b3b:	c9                   	leave  
  801b3c:	c3                   	ret    

00801b3d <sys_getparentenvid>:
...
int32 sys_getparentenvid(void)
{
  ...
  801b4a:	6a 04                	push   $0x4
  801b4c:	e8 32 ff ff ff       	call   801a83 <syscall>
  801b51:	83 c4 18             	add    $0x18,%esp
}
  801b54:	c9                   	leave  
  801b55:	c3                   	ret    

00801b56 <sys_env_exit>:
...
void sys_env_exit(void)
{
  ...
  801b65:	e8 19 ff ff ff       	call   801a83 <syscall>
...
int __sys_allocate_page(void *va, int perm)
{
  ...
  801b7f:	52                   	push   %edx
  801b80:	50                   	push   %eax
  801b81:	6a 07                	push   $0x7
  801b83:	e8 fb fe ff ff       	call   801a83 <syscall>
  801b88:	83 c4 18             	add    $0x18,%esp
}
  801b8b:	c9                   	leave  
  801b8c:	c3                   	ret    

00801b8d <__sys_map_frame>:
...
int __sys_map_frame(int32 srcenv, void *srcva, int32 dstenv, void *dstva, int perm)
{
  ...
  801b92:	8b 75 18             	mov    0x18(%ebp),%esi
  ...
  801ba8:	e8 d6 fe ff ff       	call   801a83 <syscall>
...
00801bd4 <sys_calculate_required_frames>:
...
uint32 sys_calculate_required_frames(uint32 start_virtual_address, uint32 size)
{
  ...
  801be5:	e8 99 fe ff ff       	call   801a83 <syscall>
  801bea:	83 c4 18             	add    $0x18,%esp
}
  801bed:	c9                   	leave  
  801bee:	c3                   	ret    

00801bef <sys_calculate_free_frames>:
...
uint32 sys_calculate_free_frames()
{
  ...
  801bfe:	e8 80 fe ff ff       	call   801a83 <syscall>
  801c03:	83 c4 18             	add    $0x18,%esp
}
  801c06:	c9                   	leave  
  801c07:	c3                   	ret    

00801c08 <sys_calculate_modified_frames>:
uint32 sys_calculate_modified_frames()
{
  ...
  801c17:	e8 67 fe ff ff       	call   801a83 <syscall>
  801c1c:	83 c4 18             	add    $0x18,%esp
}
  801c1f:	c9                   	leave  
  801c20:	c3                   	ret    

00801c21 <sys_calculate_notmod_frames>:
...
uint32 sys_calculate_notmod_frames()
{
  ...
  801c30:	e8 4e fe ff ff       	call   801a83 <syscall>
  801c35:	83 c4 18             	add    $0x18,%esp
}
  801c38:	c9                   	leave  
  801c39:	c3                   	ret    

00801c3a <sys_freeMem>:
...
void sys_freeMem(uint32 virtual_address, uint32 size)
{
  ...
  801c4b:	e8 33 fe ff ff       	call   801a83 <syscall>
...
void sys_allocateMem(uint32 virtual_address, uint32 size)
{
  ...
  801c65:	6a 12                	push   $0x12
  801c67:	e8 17 fe ff ff       	call   801a83 <syscall>
...
00801c72 <sys_pf_calculate_allocated_pages>:
...
int sys_pf_calculate_allocated_pages()
{
  ...
  801c7f:	6a 0e                	push   $0xe
  801c81:	e8 fd fd ff ff       	call   801a83 <syscall>
  801c86:	83 c4 18             	add    $0x18,%esp
}
  801c89:	c9                   	leave  
  801c8a:	c3                   	ret    

00801c8b <sys_calculate_pages_tobe_removed_ready_exit>:
...
int sys_calculate_pages_tobe_removed_ready_exit(uint32 WS_or_MEMORY_flag)
{
  ...
  801c99:	6a 0f                	push   $0xf
  801c9b:	e8 e3 fd ff ff       	call   801a83 <syscall>
  801ca0:	83 c4 18             	add    $0x18,%esp
}
  801ca3:	c9                   	leave  
  801ca4:	c3                   	ret    

00801ca5 <sys_scarce_memory>:
...
void sys_scarce_memory()
{
  ...
  801cb2:	6a 10                	push   $0x10
  801cb4:	e8 ca fd ff ff       	call   801a83 <syscall>
...
00801cbf <sys_disable_interrupt>:
...
sys_disable_interrupt()
{
  ...
  801cce:	e8 b0 fd ff ff       	call   801a83 <syscall>
...
sys_enable_interrupt()
{
  ...
  801ce8:	e8 96 fd ff ff       	call   801a83 <syscall>
...
sys_cputc(const char c)
{
  ...
  801d0e:	e8 70 fd ff ff       	call   801a83 <syscall>
...
sys_clear_ffl()
{
  ...
  801d28:	e8 56 fd ff ff       	call   801a83 <syscall>
...
sys_createSemaphore(char* semaphoreName, uint32 initialValue)
{
  ...
  801d45:	e8 39 fd ff ff       	call   801a83 <syscall>
  801d4a:	83 c4 18             	add    $0x18,%esp
}
  801d4d:	c9                   	leave  
  801d4e:	c3                   	ret    

00801d4f <sys_getSemaphoreValue>:
...
sys_getSemaphoreValue(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801d5e:	52                   	push   %edx
  801d5f:	50                   	push   %eax
  801d60:	6a 1b                	push   $0x1b
  801d62:	e8 1c fd ff ff       	call   801a83 <syscall>
  801d67:	83 c4 18             	add    $0x18,%esp
}
  801d6a:	c9                   	leave  
  801d6b:	c3                   	ret    

00801d6c <sys_waitSemaphore>:
...
sys_waitSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801d7b:	52                   	push   %edx
  801d7c:	50                   	push   %eax
  801d7d:	6a 19                	push   $0x19
  801d7f:	e8 ff fc ff ff       	call   801a83 <syscall>
...
sys_signalSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801d99:	52                   	push   %edx
  801d9a:	50                   	push   %eax
  801d9b:	6a 1a                	push   $0x1a
  801d9d:	e8 e1 fc ff ff       	call   801a83 <syscall>
...
00801da8 <sys_createSharedObject>:
...
sys_createSharedObject(char* shareName, uint32 size, uint8 isWritable, void* virtual_address)
{
  ...
  801db4:	8b 4d 14             	mov    0x14(%ebp),%ecx
  801db7:	0f b6 55 fc          	movzbl -0x4(%ebp),%edx
  ...
  801dc8:	e8 b6 fc ff ff       	call   801a83 <syscall>
  801dcd:	83 c4 18             	add    $0x18,%esp
}
  801dd0:	c9                   	leave  
  801dd1:	c3                   	ret    

00801dd2 <sys_getSizeOfSharedObject>:
...
sys_getSizeOfSharedObject(int32 ownerID, char* shareName)
{
  ...
  801de1:	52                   	push   %edx
  801de2:	50                   	push   %eax
  801de3:	6a 1d                	push   $0x1d
  801de5:	e8 99 fc ff ff       	call   801a83 <syscall>
  801dea:	83 c4 18             	add    $0x18,%esp
}
  801ded:	c9                   	leave  
  801dee:	c3                   	ret    

00801def <sys_getSharedObject>:
//==========
...
sys_getSharedObject(int32 ownerID, char* shareName, void* virtual_address)
{
  ...
  801e04:	e8 7a fc ff ff       	call   801a83 <syscall>
  801e09:	83 c4 18             	add    $0x18,%esp
}
  801e0c:	c9                   	leave  
  801e0d:	c3                   	ret    

00801e0e <sys_freeSharedObject>:
...
sys_freeSharedObject(int32 sharedObjectID, void *startVA)
{
  ...
  801e1d:	52                   	push   %edx
  801e1e:	50                   	push   %eax
  801e1f:	6a 1f                	push   $0x1f
  801e21:	e8 5d fc ff ff       	call   801a83 <syscall>
  801e26:	83 c4 18             	add    $0x18,%esp
}
  801e29:	c9                   	leave  
  801e2a:	c3                   	ret    

00801e2b <sys_getMaxShares>:
...
uint32 	sys_getMaxShares()
{
  ...
  801e38:	6a 20                	push   $0x20
  801e3a:	e8 44 fc ff ff       	call   801a83 <syscall>
  801e3f:	83 c4 18             	add    $0x18,%esp
}
  801e42:	c9                   	leave  
  801e43:	c3                   	ret    

00801e44 <sys_create_env>:
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int LRU_second_list_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  801e4c:	ff 75 14             	pushl  0x14(%ebp)
...
sys_run_env(int32 envId)
{
  ...
  801e73:	e8 0b fc ff ff       	call   801a83 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  801e8f:	e8 ef fb ff ff       	call   801a83 <syscall>
...
sys_get_virtual_time()
{
  ...
  801ea3:	8d 50 04             	lea    0x4(%eax),%edx
  ...
  801eaf:	52                   	push   %edx
  801eb0:	50                   	push   %eax
  801eb1:	6a 24                	push   $0x24
  801eb3:	e8 cb fb ff ff       	call   801a83 <syscall>
  801eb8:	83 c4 18             	add    $0x18,%esp
	return result;
  801ebb:	8b 4d 08             	mov    0x8(%ebp),%ecx
  801ebe:	8b 45 f8             	mov    -0x8(%ebp),%eax
  801ec1:	8b 55 fc             	mov    -0x4(%ebp),%edx
  801ec4:	89 01                	mov    %eax,(%ecx)
  801ec6:	89 51 04             	mov    %edx,0x4(%ecx)
}
  801ec9:	8b 45 08             	mov    0x8(%ebp),%eax
  801ecc:	c9                   	leave  
  801ecd:	c2 04 00             	ret    $0x4

00801ed0 <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  801ee0:	6a 13                	push   $0x13
  801ee2:	e8 9c fb ff ff       	call   801a83 <syscall>
...
uint32 sys_rcr2()
{
  ...
  801efc:	e8 82 fb ff ff       	call   801a83 <syscall>
  801f01:	83 c4 18             	add    $0x18,%esp
}
  801f04:	c9                   	leave  
  801f05:	c3                   	ret    

00801f06 <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  801f12:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  801f16:	6a 00                	push   $0x0
  801f18:	6a 00                	push   $0x0
  801f1a:	6a 00                	push   $0x0
  801f1c:	6a 00                	push   $0x0
  801f1e:	50                   	push   %eax
  801f1f:	6a 26                	push   $0x26
  801f21:	e8 5d fb ff ff       	call   801a83 <syscall>
...
void rsttst()
{
  ...
  801f39:	6a 28                	push   $0x28
  801f3b:	e8 43 fb ff ff       	call   801a83 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801f52:	8b 55 18             	mov    0x18(%ebp),%edx
  ...
  801f64:	6a 27                	push   $0x27
  801f66:	e8 18 fb ff ff       	call   801a83 <syscall>
...
void chktst(uint32 n)
{
  ...
  801f7f:	6a 29                	push   $0x29
  801f81:	e8 fd fa ff ff       	call   801a83 <syscall>
...
void inctst()
{
  ...
  801f99:	6a 2a                	push   $0x2a
  801f9b:	e8 e3 fa ff ff       	call   801a83 <syscall>
...
uint32 gettst()
{
  ...
  801fb3:	6a 2b                	push   $0x2b
  801fb5:	e8 c9 fa ff ff       	call   801a83 <syscall>
  801fba:	83 c4 18             	add    $0x18,%esp
}
  801fbd:	c9                   	leave  
  801fbe:	c3                   	ret    

00801fbf <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  801fd1:	e8 ad fa ff ff       	call   801a83 <syscall>
  801fd6:	83 c4 18             	add    $0x18,%esp
  801fd9:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  801fdc:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  801fe0:	75 07                	jne    801fe9 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  801fe2:	b8 01 00 00 00       	mov    $0x1,%eax
  801fe7:	eb 05                	jmp    801fee <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
00801ff0 <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  802002:	e8 7c fa ff ff       	call   801a83 <syscall>
  802007:	83 c4 18             	add    $0x18,%esp
  80200a:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  80200d:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  802011:	75 07                	jne    80201a <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  802013:	b8 01 00 00 00       	mov    $0x1,%eax
  802018:	eb 05                	jmp    80201f <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
00802021 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  802033:	e8 4b fa ff ff       	call   801a83 <syscall>
  802038:	83 c4 18             	add    $0x18,%esp
  80203b:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  80203e:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  802042:	75 07                	jne    80204b <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  802044:	b8 01 00 00 00       	mov    $0x1,%eax
  802049:	eb 05                	jmp    802050 <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
00802052 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  802064:	e8 1a fa ff ff       	call   801a83 <syscall>
  802069:	83 c4 18             	add    $0x18,%esp
  80206c:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  80206f:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  802073:	75 07                	jne    80207c <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  802075:	b8 01 00 00 00       	mov    $0x1,%eax
  80207a:	eb 05                	jmp    802081 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
00802083 <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  802091:	6a 2d                	push   $0x2d
  802093:	e8 eb f9 ff ff       	call   801a83 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  8020b2:	52                   	push   %edx
  8020b3:	50                   	push   %eax
  8020b4:	6a 2e                	push   $0x2e
  8020b6:	e8 c8 f9 ff ff       	call   801a83 <syscall>
...
008020c3 <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  8020d2:	52                   	push   %edx
  8020d3:	50                   	push   %eax
  8020d4:	6a 2f                	push   $0x2f
  8020d6:	e8 a8 f9 ff ff       	call   801a83 <syscall>
