...
_main(void)
{
  ...
  80009f:	68 fc 1e 80 00       	push   $0x801efc
  8000a4:	50                   	push   %eax
  ...
  8000f9:	68 48 1f 80 00       	push   $0x801f48
  ...
  80011c:	68 60 1f 80 00       	push   $0x801f60
...
libmain(int argc, char **argv)
{
  ...
  8001c0:	68 20 20 80 00       	push   $0x802020
  ...
  8001e6:	52                   	push   %edx
  8001e7:	50                   	push   %eax
  8001e8:	68 48 20 80 00       	push   $0x802048
  ...
  80020e:	52                   	push   %edx
  80020f:	50                   	push   %eax
  800210:	68 70 20 80 00       	push   $0x802070
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80029a:	50                   	push   %eax
  80029b:	68 c8 20 80 00       	push   $0x8020c8
  ...
  8002b3:	50                   	push   %eax
  8002b4:	68 cd 20 80 00       	push   $0x8020cd
  ...
  8002d8:	68 e9 20 80 00       	push   $0x8020e9
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800304:	68 ec 20 80 00       	push   $0x8020ec
  800309:	6a 26                	push   $0x26
  80030b:	68 38 21 80 00       	push   $0x802138
  ...
  8003ca:	68 44 21 80 00       	push   $0x802144
  8003cf:	6a 3a                	push   $0x3a
  8003d1:	68 38 21 80 00       	push   $0x802138
  ...
  800434:	68 98 21 80 00       	push   $0x802198
  800439:	6a 44                	push   $0x44
  80043b:	68 38 21 80 00       	push   $0x802138
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800611:	05 14 24 80 00       	add    $0x802414,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800764:	8b 04 85 38 24 80 00 	mov    0x802438(,%eax,4),%eax
  ...
  800845:	8b 34 9d 80 22 80 00 	mov    0x802280(,%ebx,4),%esi
  80084c:	85 f6                	test   %esi,%esi
  80084e:	75 19                	jne    800869 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800850:	53                   	push   %ebx
  800851:	68 25 24 80 00       	push   $0x802425
  ...
  800864:	e9 49 02 00 00       	jmp    800ab2 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800869:	56                   	push   %esi
  80086a:	68 2e 24 80 00       	push   $0x80242e
  ...
  800895:	75 05                	jne    80089c <vprintfmt+0x1a6>
				p = "(null)";
  800897:	be 31 24 80 00       	mov    $0x802431,%esi
			if (width > 0 && padc != '-')
...
void free(void* virtual_address)
{
  ...
  801465:	68 90 25 80 00       	push   $0x802590
  80146a:	6a 7b                	push   $0x7b
  80146c:	68 b3 25 80 00       	push   $0x8025b3
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  801485:	68 c0 25 80 00       	push   $0x8025c0
  80148a:	68 88 00 00 00       	push   $0x88
  80148f:	68 b3 25 80 00       	push   $0x8025b3
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  8014a2:	68 c0 25 80 00       	push   $0x8025c0
  8014a7:	68 8e 00 00 00       	push   $0x8e
  8014ac:	68 b3 25 80 00       	push   $0x8025b3
...
void sfree(void* virtual_address)
{
  ...
  8014bf:	68 c0 25 80 00       	push   $0x8025c0
  8014c4:	68 94 00 00 00       	push   $0x94
  8014c9:	68 b3 25 80 00       	push   $0x8025b3
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  8014dc:	68 c0 25 80 00       	push   $0x8025c0
  8014e1:	68 99 00 00 00       	push   $0x99
  8014e6:	68 b3 25 80 00       	push   $0x8025b3
...
void expand(uint32 newSize)
{
  ...
  8014f9:	68 c0 25 80 00       	push   $0x8025c0
  8014fe:	68 9f 00 00 00       	push   $0x9f
  801503:	68 b3 25 80 00       	push   $0x8025b3
...
void shrink(uint32 newSize)
{
  ...
  801516:	68 c0 25 80 00       	push   $0x8025c0
  80151b:	68 a3 00 00 00       	push   $0xa3
  801520:	68 b3 25 80 00       	push   $0x8025b3
...
void freeHeap(void* virtual_address)
{
  ...
  801533:	68 c0 25 80 00       	push   $0x8025c0
  801538:	68 a8 00 00 00       	push   $0xa8
  80153d:	68 b3 25 80 00       	push   $0x8025b3
