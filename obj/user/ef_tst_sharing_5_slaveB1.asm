...
_main(void)
{
  ...
  80009f:	68 dc 1f 80 00       	push   $0x801fdc
  8000a4:	50                   	push   %eax
  ...
  8000f9:	68 28 20 80 00       	push   $0x802028
  ...
  80011c:	68 40 20 80 00       	push   $0x802040
...
libmain(int argc, char **argv)
{
  ...
  8001c0:	68 00 21 80 00       	push   $0x802100
  ...
  8001e6:	52                   	push   %edx
  8001e7:	50                   	push   %eax
  8001e8:	68 28 21 80 00       	push   $0x802128
  ...
  80020e:	52                   	push   %edx
  80020f:	50                   	push   %eax
  800210:	68 50 21 80 00       	push   $0x802150
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80029a:	50                   	push   %eax
  80029b:	68 a8 21 80 00       	push   $0x8021a8
  ...
  8002b3:	50                   	push   %eax
  8002b4:	68 ad 21 80 00       	push   $0x8021ad
  ...
  8002d8:	68 c9 21 80 00       	push   $0x8021c9
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800304:	68 cc 21 80 00       	push   $0x8021cc
  800309:	6a 26                	push   $0x26
  80030b:	68 18 22 80 00       	push   $0x802218
  ...
  8003ca:	68 24 22 80 00       	push   $0x802224
  8003cf:	6a 3a                	push   $0x3a
  8003d1:	68 18 22 80 00       	push   $0x802218
  ...
  80043b:	68 18 22 80 00       	push   $0x802218
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800611:	05 f4 24 80 00       	add    $0x8024f4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800764:	8b 04 85 18 25 80 00 	mov    0x802518(,%eax,4),%eax
  ...
  800845:	8b 34 9d 60 23 80 00 	mov    0x802360(,%ebx,4),%esi
  80084c:	85 f6                	test   %esi,%esi
  80084e:	75 19                	jne    800869 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800850:	53                   	push   %ebx
  800851:	68 05 25 80 00       	push   $0x802505
  ...
  800864:	e9 49 02 00 00       	jmp    800ab2 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800869:	56                   	push   %esi
  80086a:	68 0e 25 80 00       	push   $0x80250e
  ...
  800895:	75 05                	jne    80089c <vprintfmt+0x1a6>
				p = "(null)";
  800897:	be 11 25 80 00       	mov    $0x802511,%esi
			if (width > 0 && padc != '-')
...
void free(void* virtual_address)
{
  ...
  801537:	c7 04 85 a0 4b 86 00 	movl   $0x0,0x864ba0(,%eax,4)
  80153e:	00 00 00 00 
    	changes++;
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  80155f:	68 70 26 80 00       	push   $0x802670
  801564:	68 9f 00 00 00       	push   $0x9f
  801569:	68 93 26 80 00       	push   $0x802693
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  80157c:	68 70 26 80 00       	push   $0x802670
  801581:	68 a5 00 00 00       	push   $0xa5
  801586:	68 93 26 80 00       	push   $0x802693
...
void sfree(void* virtual_address)
{
  ...
  801599:	68 70 26 80 00       	push   $0x802670
  80159e:	68 ab 00 00 00       	push   $0xab
  8015a3:	68 93 26 80 00       	push   $0x802693
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  8015b6:	68 70 26 80 00       	push   $0x802670
  8015bb:	68 b0 00 00 00       	push   $0xb0
  8015c0:	68 93 26 80 00       	push   $0x802693
...
void expand(uint32 newSize)
{
  ...
  8015d3:	68 70 26 80 00       	push   $0x802670
  8015d8:	68 b6 00 00 00       	push   $0xb6
  8015dd:	68 93 26 80 00       	push   $0x802693
...
void shrink(uint32 newSize)
{
  ...
  8015f0:	68 70 26 80 00       	push   $0x802670
  8015f5:	68 ba 00 00 00       	push   $0xba
  8015fa:	68 93 26 80 00       	push   $0x802693
...
void freeHeap(void* virtual_address)
{
  ...
  80160d:	68 70 26 80 00       	push   $0x802670
  801612:	68 bf 00 00 00       	push   $0xbf
  801617:	68 93 26 80 00       	push   $0x802693
