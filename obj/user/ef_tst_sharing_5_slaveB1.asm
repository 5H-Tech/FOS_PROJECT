...
_main(void)
{
  ...
  80009f:	68 5c 1d 80 00       	push   $0x801d5c
  8000a4:	50                   	push   %eax
  ...
  8000f9:	68 a8 1d 80 00       	push   $0x801da8
  ...
  80011c:	68 c0 1d 80 00       	push   $0x801dc0
...
libmain(int argc, char **argv)
{
  ...
  8001c0:	68 80 1e 80 00       	push   $0x801e80
  ...
  8001e6:	52                   	push   %edx
  8001e7:	50                   	push   %eax
  8001e8:	68 a8 1e 80 00       	push   $0x801ea8
  ...
  80020e:	52                   	push   %edx
  80020f:	50                   	push   %eax
  800210:	68 d0 1e 80 00       	push   $0x801ed0
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80029a:	50                   	push   %eax
  80029b:	68 28 1f 80 00       	push   $0x801f28
  ...
  8002b3:	50                   	push   %eax
  8002b4:	68 2d 1f 80 00       	push   $0x801f2d
  ...
  8002d8:	68 49 1f 80 00       	push   $0x801f49
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800304:	68 4c 1f 80 00       	push   $0x801f4c
  800309:	6a 26                	push   $0x26
  80030b:	68 98 1f 80 00       	push   $0x801f98
  ...
  8003ca:	68 a4 1f 80 00       	push   $0x801fa4
  8003cf:	6a 3a                	push   $0x3a
  8003d1:	68 98 1f 80 00       	push   $0x801f98
  ...
  800434:	68 f8 1f 80 00       	push   $0x801ff8
  800439:	6a 44                	push   $0x44
  80043b:	68 98 1f 80 00       	push   $0x801f98
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800611:	05 74 22 80 00       	add    $0x802274,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800764:	8b 04 85 98 22 80 00 	mov    0x802298(,%eax,4),%eax
  ...
  800845:	8b 34 9d e0 20 80 00 	mov    0x8020e0(,%ebx,4),%esi
  80084c:	85 f6                	test   %esi,%esi
  80084e:	75 19                	jne    800869 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800850:	53                   	push   %ebx
  800851:	68 85 22 80 00       	push   $0x802285
  ...
  800864:	e9 49 02 00 00       	jmp    800ab2 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800869:	56                   	push   %esi
  80086a:	68 8e 22 80 00       	push   $0x80228e
  ...
  800895:	75 05                	jne    80089c <vprintfmt+0x1a6>
				p = "(null)";
  800897:	be 91 22 80 00       	mov    $0x802291,%esi
			if (width > 0 && padc != '-')
...
void* malloc(uint32 size)
{
  ...
  8012af:	68 f0 23 80 00       	push   $0x8023f0
  8012b4:	6a 16                	push   $0x16
  8012b6:	68 15 24 80 00       	push   $0x802415
...
void free(void* virtual_address)
{
  ...
  8012c9:	68 24 24 80 00       	push   $0x802424
  8012ce:	6a 2e                	push   $0x2e
  8012d0:	68 15 24 80 00       	push   $0x802415
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  8012e9:	68 48 24 80 00       	push   $0x802448
  8012ee:	6a 3b                	push   $0x3b
  8012f0:	68 15 24 80 00       	push   $0x802415
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  801303:	68 48 24 80 00       	push   $0x802448
  801308:	6a 41                	push   $0x41
  80130a:	68 15 24 80 00       	push   $0x802415
...
void sfree(void* virtual_address)
{
  ...
  80131d:	68 48 24 80 00       	push   $0x802448
  801322:	6a 47                	push   $0x47
  801324:	68 15 24 80 00       	push   $0x802415
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  801337:	68 48 24 80 00       	push   $0x802448
  80133c:	6a 4c                	push   $0x4c
  80133e:	68 15 24 80 00       	push   $0x802415
...
void expand(uint32 newSize)
{
  ...
  801351:	68 48 24 80 00       	push   $0x802448
  801356:	6a 52                	push   $0x52
  801358:	68 15 24 80 00       	push   $0x802415
...
void shrink(uint32 newSize)
{
  ...
  80136b:	68 48 24 80 00       	push   $0x802448
  801370:	6a 56                	push   $0x56
  801372:	68 15 24 80 00       	push   $0x802415
...
void freeHeap(void* virtual_address)
{
  ...
  801385:	68 48 24 80 00       	push   $0x802448
  80138a:	6a 5b                	push   $0x5b
  80138c:	68 15 24 80 00       	push   $0x802415
