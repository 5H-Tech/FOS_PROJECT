...
_main(void)
{
  ...
  80009f:	68 5c 1f 80 00       	push   $0x801f5c
  8000a4:	50                   	push   %eax
  ...
  8000f9:	68 a8 1f 80 00       	push   $0x801fa8
  ...
  80011c:	68 c0 1f 80 00       	push   $0x801fc0
...
libmain(int argc, char **argv)
{
  ...
  8001c0:	68 80 20 80 00       	push   $0x802080
  ...
  8001e6:	52                   	push   %edx
  8001e7:	50                   	push   %eax
  8001e8:	68 a8 20 80 00       	push   $0x8020a8
  ...
  80020e:	52                   	push   %edx
  80020f:	50                   	push   %eax
  800210:	68 d0 20 80 00       	push   $0x8020d0
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80029a:	50                   	push   %eax
  80029b:	68 28 21 80 00       	push   $0x802128
  ...
  8002b3:	50                   	push   %eax
  8002b4:	68 2d 21 80 00       	push   $0x80212d
  ...
  8002d8:	68 49 21 80 00       	push   $0x802149
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800304:	68 4c 21 80 00       	push   $0x80214c
  800309:	6a 26                	push   $0x26
  80030b:	68 98 21 80 00       	push   $0x802198
  ...
  8003ca:	68 a4 21 80 00       	push   $0x8021a4
  8003cf:	6a 3a                	push   $0x3a
  8003d1:	68 98 21 80 00       	push   $0x802198
  ...
  800434:	68 f8 21 80 00       	push   $0x8021f8
  800439:	6a 44                	push   $0x44
  80043b:	68 98 21 80 00       	push   $0x802198
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800611:	05 74 24 80 00       	add    $0x802474,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800764:	8b 04 85 98 24 80 00 	mov    0x802498(,%eax,4),%eax
  ...
  800845:	8b 34 9d e0 22 80 00 	mov    0x8022e0(,%ebx,4),%esi
  80084c:	85 f6                	test   %esi,%esi
  80084e:	75 19                	jne    800869 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800850:	53                   	push   %ebx
  800851:	68 85 24 80 00       	push   $0x802485
  ...
  800864:	e9 49 02 00 00       	jmp    800ab2 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800869:	56                   	push   %esi
  80086a:	68 8e 24 80 00       	push   $0x80248e
  ...
  800895:	75 05                	jne    80089c <vprintfmt+0x1a6>
				p = "(null)";
  800897:	be 91 24 80 00       	mov    $0x802491,%esi
			if (width > 0 && padc != '-')
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  8014cb:	68 f0 25 80 00       	push   $0x8025f0
  8014d0:	68 8d 00 00 00       	push   $0x8d
  8014d5:	68 13 26 80 00       	push   $0x802613
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  8014e8:	68 f0 25 80 00       	push   $0x8025f0
  8014ed:	68 93 00 00 00       	push   $0x93
  8014f2:	68 13 26 80 00       	push   $0x802613
...
void sfree(void* virtual_address)
{
  ...
  801505:	68 f0 25 80 00       	push   $0x8025f0
  80150a:	68 99 00 00 00       	push   $0x99
  80150f:	68 13 26 80 00       	push   $0x802613
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  801522:	68 f0 25 80 00       	push   $0x8025f0
  801527:	68 9e 00 00 00       	push   $0x9e
  80152c:	68 13 26 80 00       	push   $0x802613
...
void expand(uint32 newSize)
{
  ...
  80153f:	68 f0 25 80 00       	push   $0x8025f0
  801544:	68 a4 00 00 00       	push   $0xa4
  801549:	68 13 26 80 00       	push   $0x802613
...
void shrink(uint32 newSize)
{
  ...
  80155c:	68 f0 25 80 00       	push   $0x8025f0
  801561:	68 a8 00 00 00       	push   $0xa8
  801566:	68 13 26 80 00       	push   $0x802613
...
void freeHeap(void* virtual_address)
{
  ...
  801579:	68 f0 25 80 00       	push   $0x8025f0
  80157e:	68 ad 00 00 00       	push   $0xad
  801583:	68 13 26 80 00       	push   $0x802613
