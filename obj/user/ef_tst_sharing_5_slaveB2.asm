...
_main(void)
{
  ...
  800097:	e8 d7 15 00 00       	call   801673 <sys_getparentenvid>
  80009c:	83 ec 08             	sub    $0x8,%esp
  80009f:	68 7c 1f 80 00       	push   $0x801f7c
  8000a4:	50                   	push   %eax
  8000a5:	e8 61 14 00 00       	call   80150b <sget>
  8000aa:	83 c4 10             	add    $0x10,%esp
  8000ad:	89 45 ec             	mov    %eax,-0x14(%ebp)
	cprintf("Slave B2 env used z (getSharedObject)\n");
  8000b0:	83 ec 0c             	sub    $0xc,%esp
  8000b3:	68 80 1f 80 00       	push   $0x801f80
  8000b8:	e8 d1 04 00 00       	call   80058e <cprintf>
  8000bd:	83 c4 10             	add    $0x10,%esp

	cprintf("Slave B2 please be patient ...\n");
  8000c0:	83 ec 0c             	sub    $0xc,%esp
  8000c3:	68 a8 1f 80 00       	push   $0x801fa8
  ...
  8000d8:	e8 39 1b 00 00       	call   801c16 <env_sleep>
  8000dd:	83 c4 10             	add    $0x10,%esp
	int freeFrames = sys_calculate_free_frames() ;
  8000e0:	e8 40 16 00 00       	call   801725 <sys_calculate_free_frames>
  8000e5:	89 45 e8             	mov    %eax,-0x18(%ebp)

	sfree(z);
  8000e8:	83 ec 0c             	sub    $0xc,%esp
  8000eb:	ff 75 ec             	pushl  -0x14(%ebp)
  8000ee:	e8 35 14 00 00       	call   801528 <sfree>
  8000f3:	83 c4 10             	add    $0x10,%esp
	cprintf("Slave B2 env removed z\n");
  8000f6:	83 ec 0c             	sub    $0xc,%esp
  8000f9:	68 c8 1f 80 00       	push   $0x801fc8
  ...
  800106:	e8 1a 16 00 00       	call   801725 <sys_calculate_free_frames>
  ...
  80011c:	68 e0 1f 80 00       	push   $0x801fe0
  ...
  80012d:	e8 aa 19 00 00       	call   801adc <gettst>
  ...
  80015e:	68 b0 20 80 00       	push   $0x8020b0
  800163:	e8 26 04 00 00       	call   80058e <cprintf>
  800168:	83 c4 10             	add    $0x10,%esp

	int32 parentenvID = sys_getparentenvid();
  80016b:	e8 03 15 00 00       	call   801673 <sys_getparentenvid>
  ...
  800183:	68 fc 20 80 00       	push   $0x8020fc
  800188:	ff 75 e4             	pushl  -0x1c(%ebp)
  80018b:	e8 7b 13 00 00       	call   80150b <sget>
...
libmain(int argc, char **argv)
{
  ...
  8001ad:	e8 a8 14 00 00       	call   80165a <sys_getenvindex>
  ...
  80022a:	e8 c6 15 00 00       	call   8017f5 <sys_disable_interrupt>
	cprintf("**************************************\n");
  80022f:	83 ec 0c             	sub    $0xc,%esp
  800232:	68 24 21 80 00       	push   $0x802124
  ...
  800258:	52                   	push   %edx
  800259:	50                   	push   %eax
  80025a:	68 4c 21 80 00       	push   $0x80214c
  ...
  800280:	52                   	push   %edx
  800281:	50                   	push   %eax
  800282:	68 74 21 80 00       	push   $0x802174
  ...
  80029d:	50                   	push   %eax
  80029e:	68 b5 21 80 00       	push   $0x8021b5
  8002a3:	e8 e6 02 00 00       	call   80058e <cprintf>
  8002a8:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  8002ab:	83 ec 0c             	sub    $0xc,%esp
  8002ae:	68 24 21 80 00       	push   $0x802124
  8002b3:	e8 d6 02 00 00       	call   80058e <cprintf>
  8002b8:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  8002bb:	e8 4f 15 00 00       	call   80180f <sys_enable_interrupt>
...
destroy(void)
{
  ...
  8002d3:	e8 4e 13 00 00       	call   801626 <sys_env_destroy>
...
exit(void)
{
  ...
  8002e1:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  8002e4:	e8 a3 13 00 00       	call   80168c <sys_env_exit>
}
  8002e9:	90                   	nop
  8002ea:	c9                   	leave  
  8002eb:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80030c:	50                   	push   %eax
  80030d:	68 cc 21 80 00       	push   $0x8021cc
  ...
  800325:	50                   	push   %eax
  800326:	68 d1 21 80 00       	push   $0x8021d1
  ...
  80034a:	68 ed 21 80 00       	push   $0x8021ed
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800376:	68 f0 21 80 00       	push   $0x8021f0
  80037b:	6a 26                	push   $0x26
  80037d:	68 3c 22 80 00       	push   $0x80223c
  ...
  80043c:	68 48 22 80 00       	push   $0x802248
  800441:	6a 3a                	push   $0x3a
  800443:	68 3c 22 80 00       	push   $0x80223c
  ...
  8004a6:	68 9c 22 80 00       	push   $0x80229c
  8004ab:	6a 44                	push   $0x44
  8004ad:	68 3c 22 80 00       	push   $0x80223c
...
static void putch(int ch, struct printbuf *b) {
  ...
  8004fe:	51                   	push   %ecx
  8004ff:	52                   	push   %edx
  800500:	e8 df 10 00 00       	call   8015e4 <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800576:	50                   	push   %eax
  800577:	e8 68 10 00 00       	call   8015e4 <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  8005be:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8005c1:	e8 2f 12 00 00       	call   8017f5 <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  8005de:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  8005e1:	e8 29 12 00 00       	call   80180f <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80062b:	e8 9c 16 00 00       	call   801ccc <__udivdi3>
  ...
  800679:	52                   	push   %edx
  80067a:	50                   	push   %eax
  80067b:	e8 5c 17 00 00       	call   801ddc <__umoddi3>
  800680:	83 c4 10             	add    $0x10,%esp
  800683:	05 14 25 80 00       	add    $0x802514,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8007d6:	8b 04 85 38 25 80 00 	mov    0x802538(,%eax,4),%eax
  ...
  8008b7:	8b 34 9d 80 23 80 00 	mov    0x802380(,%ebx,4),%esi
  8008be:	85 f6                	test   %esi,%esi
  8008c0:	75 19                	jne    8008db <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  8008c2:	53                   	push   %ebx
  8008c3:	68 25 25 80 00       	push   $0x802525
  ...
  8008d6:	e9 49 02 00 00       	jmp    800b24 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8008db:	56                   	push   %esi
  8008dc:	68 2e 25 80 00       	push   $0x80252e
  ...
  800907:	75 05                	jne    80090e <vprintfmt+0x1a6>
				p = "(null)";
  800909:	be 31 25 80 00       	mov    $0x802531,%esi
			if (width > 0 && padc != '-')
...
void* malloc(uint32 size)
{
  ...
  801376:	8b 15 04 30 80 00    	mov    0x803004,%edx
  80137c:	89 14 85 20 31 80 00 	mov    %edx,0x803120(,%eax,4)
			changed[sizeofarray]=1;
  801383:	a1 2c 30 80 00       	mov    0x80302c,%eax
  801388:	c7 04 85 c0 32 80 00 	movl   $0x1,0x8032c0(,%eax,4)
  80138f:	01 00 00 00 
			sizeofarray++;
  ...
  8013a1:	e9 26 01 00 00       	jmp    8014cc <malloc+0x1b4>
		}
		else
		{
			if(changes==0)
  ...
  8013ad:	75 62                	jne    801411 <malloc+0xf9>
			{
				sys_allocateMem(last_addres,size);
  8013af:	a1 04 30 80 00       	mov    0x803004,%eax
  8013b4:	83 ec 08             	sub    $0x8,%esp
  8013b7:	ff 75 08             	pushl  0x8(%ebp)
  8013ba:	50                   	push   %eax
  8013bb:	e8 cc 03 00 00       	call   80178c <sys_allocateMem>
  8013c0:	83 c4 10             	add    $0x10,%esp
				return_addres=last_addres;
  8013c3:	a1 04 30 80 00       	mov    0x803004,%eax
  8013c8:	89 45 d8             	mov    %eax,-0x28(%ebp)
				last_addres+=num*PAGE_SIZE;
  ...
  8013da:	a3 04 30 80 00       	mov    %eax,0x803004
				addresses[sizeofarray]=return_addres;
  8013df:	a1 2c 30 80 00       	mov    0x80302c,%eax
  8013e4:	8b 55 d8             	mov    -0x28(%ebp),%edx
  8013e7:	89 14 85 20 31 80 00 	mov    %edx,0x803120(,%eax,4)
				changed[sizeofarray]=1;
  8013ee:	a1 2c 30 80 00       	mov    0x80302c,%eax
  8013f3:	c7 04 85 c0 32 80 00 	movl   $0x1,0x8032c0(,%eax,4)
  8013fa:	01 00 00 00 
				sizeofarray++;
  8013fe:	a1 2c 30 80 00       	mov    0x80302c,%eax
  801403:	40                   	inc    %eax
  801404:	a3 2c 30 80 00       	mov    %eax,0x80302c
				return (void*)return_addres;
  801409:	8b 45 d8             	mov    -0x28(%ebp),%eax
  80140c:	e9 bb 00 00 00       	jmp    8014cc <malloc+0x1b4>
			}
			else{
				int count=0;
  801411:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
				int min=1000;
  801418:	c7 45 ec e8 03 00 00 	movl   $0x3e8,-0x14(%ebp)
				int index=-1;
  80141f:	c7 45 e8 ff ff ff ff 	movl   $0xffffffff,-0x18(%ebp)
				uint32 min_addresss;
				for(uint32 i=USER_HEAP_START;i<USER_HEAP_MAX;i+=PAGE_SIZE)
  801426:	c7 45 e0 00 00 00 80 	movl   $0x80000000,-0x20(%ebp)
  80142d:	eb 7c                	jmp    8014ab <malloc+0x193>
				{
					uint32 *pg=NULL;
  80142f:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
					for(int j=0;j<sizeofarray;j++)
  801436:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
  80143d:	eb 1a                	jmp    801459 <malloc+0x141>
					{
						if(addresses[j]==i)
  80143f:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801442:	8b 04 85 20 31 80 00 	mov    0x803120(,%eax,4),%eax
  801449:	3b 45 e0             	cmp    -0x20(%ebp),%eax
  80144c:	75 08                	jne    801456 <malloc+0x13e>
						{
							index=j;
  80144e:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801451:	89 45 e8             	mov    %eax,-0x18(%ebp)
							break;
  801454:	eb 0d                	jmp    801463 <malloc+0x14b>
				int index=-1;
				uint32 min_addresss;
				for(uint32 i=USER_HEAP_START;i<USER_HEAP_MAX;i+=PAGE_SIZE)
				{
					uint32 *pg=NULL;
					for(int j=0;j<sizeofarray;j++)
  801456:	ff 45 dc             	incl   -0x24(%ebp)
  801459:	a1 2c 30 80 00       	mov    0x80302c,%eax
  80145e:	39 45 dc             	cmp    %eax,-0x24(%ebp)
  801461:	7c dc                	jl     80143f <malloc+0x127>
							index=j;
							break;
						}
					}
					...
					if(index==-1)
  801463:	83 7d e8 ff          	cmpl   $0xffffffff,-0x18(%ebp)
  801467:	75 05                	jne    80146e <malloc+0x156>
					{
						count++;
  801469:	ff 45 f0             	incl   -0x10(%ebp)
  80146c:	eb 36                	jmp    8014a4 <malloc+0x18c>
					}
					else
					{
						if(changed[index]==0)
  80146e:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801471:	8b 04 85 c0 32 80 00 	mov    0x8032c0(,%eax,4),%eax
  801478:	85 c0                	test   %eax,%eax
  80147a:	75 05                	jne    801481 <malloc+0x169>
						{
							count++;
  80147c:	ff 45 f0             	incl   -0x10(%ebp)
  80147f:	eb 23                	jmp    8014a4 <malloc+0x18c>
						}
						else
						{
							if(count<min&&count>=num)
  801481:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801484:	3b 45 ec             	cmp    -0x14(%ebp),%eax
  801487:	7d 14                	jge    80149d <malloc+0x185>
  801489:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80148c:	3b 45 f4             	cmp    -0xc(%ebp),%eax
  80148f:	7c 0c                	jl     80149d <malloc+0x185>
							{
								min=count;
  ...
  80149a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
							...
							count=0;
  80149d:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
			else{
				int count=0;
				int min=1000;
				int index=-1;
				uint32 min_addresss;
				for(uint32 i=USER_HEAP_START;i<USER_HEAP_MAX;i+=PAGE_SIZE)
  8014a4:	81 45 e0 00 10 00 00 	addl   $0x1000,-0x20(%ebp)
  8014ab:	81 7d e0 ff ff ff 9f 	cmpl   $0x9fffffff,-0x20(%ebp)
  8014b2:	0f 86 77 ff ff ff    	jbe    80142f <malloc+0x117>
  ...
  8014be:	ff 75 e4             	pushl  -0x1c(%ebp)
  8014c1:	e8 c6 02 00 00       	call   80178c <sys_allocateMem>
...
void free(void* virtual_address)
{
  ...
  8014d7:	68 90 26 80 00       	push   $0x802690
  8014dc:	6a 7b                	push   $0x7b
  8014de:	68 b3 26 80 00       	push   $0x8026b3
  8014e3:	e8 04 ee ff ff       	call   8002ec <_panic>
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  8014f1:	88 45 f4             	mov    %al,-0xc(%ebp)
	panic("this function is not required...!!");
  8014f4:	83 ec 04             	sub    $0x4,%esp
  8014f7:	68 c0 26 80 00       	push   $0x8026c0
  8014fc:	68 88 00 00 00       	push   $0x88
  801501:	68 b3 26 80 00       	push   $0x8026b3
  801506:	e8 e1 ed ff ff       	call   8002ec <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  801514:	68 c0 26 80 00       	push   $0x8026c0
  801519:	68 8e 00 00 00       	push   $0x8e
  80151e:	68 b3 26 80 00       	push   $0x8026b3
  801523:	e8 c4 ed ff ff       	call   8002ec <_panic>
...
void sfree(void* virtual_address)
{
  ...
  801531:	68 c0 26 80 00       	push   $0x8026c0
  801536:	68 94 00 00 00       	push   $0x94
  80153b:	68 b3 26 80 00       	push   $0x8026b3
  801540:	e8 a7 ed ff ff       	call   8002ec <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  80154e:	68 c0 26 80 00       	push   $0x8026c0
  801553:	68 99 00 00 00       	push   $0x99
  801558:	68 b3 26 80 00       	push   $0x8026b3
  80155d:	e8 8a ed ff ff       	call   8002ec <_panic>
...
void expand(uint32 newSize)
{
  ...
  80156b:	68 c0 26 80 00       	push   $0x8026c0
  801570:	68 9f 00 00 00       	push   $0x9f
  801575:	68 b3 26 80 00       	push   $0x8026b3
  80157a:	e8 6d ed ff ff       	call   8002ec <_panic>
...
void shrink(uint32 newSize)
{
  ...
  801588:	68 c0 26 80 00       	push   $0x8026c0
  80158d:	68 a3 00 00 00       	push   $0xa3
  801592:	68 b3 26 80 00       	push   $0x8026b3
  801597:	e8 50 ed ff ff       	call   8002ec <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  8015a5:	68 c0 26 80 00       	push   $0x8026c0
  8015aa:	68 a8 00 00 00       	push   $0xa8
  8015af:	68 b3 26 80 00       	push   $0x8026b3
  8015b4:	e8 33 ed ff ff       	call   8002ec <_panic>
