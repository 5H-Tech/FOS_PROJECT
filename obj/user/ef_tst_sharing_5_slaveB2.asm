...
_main(void)
{
  ...
  800086:	68 80 1d 80 00       	push   $0x801d80
  80008b:	6a 12                	push   $0x12
  80008d:	68 9c 1d 80 00       	push   $0x801d9c
  800092:	e8 55 02 00 00       	call   8002ec <_panic>
	}
	uint32 *z;
	z = sget(sys_getparentenvid(),"z");
  800097:	e8 26 14 00 00       	call   8014c2 <sys_getparentenvid>
  80009c:	83 ec 08             	sub    $0x8,%esp
  80009f:	68 bc 1d 80 00       	push   $0x801dbc
  8000a4:	50                   	push   %eax
  8000a5:	e8 c2 12 00 00       	call   80136c <sget>
  8000aa:	83 c4 10             	add    $0x10,%esp
  8000ad:	89 45 ec             	mov    %eax,-0x14(%ebp)
	cprintf("Slave B2 env used z (getSharedObject)\n");
  8000b0:	83 ec 0c             	sub    $0xc,%esp
  8000b3:	68 c0 1d 80 00       	push   $0x801dc0
  8000b8:	e8 d1 04 00 00       	call   80058e <cprintf>
  8000bd:	83 c4 10             	add    $0x10,%esp

	cprintf("Slave B2 please be patient ...\n");
  8000c0:	83 ec 0c             	sub    $0xc,%esp
  8000c3:	68 e8 1d 80 00       	push   $0x801de8
  ...
  8000d8:	e8 88 19 00 00       	call   801a65 <env_sleep>
  8000dd:	83 c4 10             	add    $0x10,%esp
	int freeFrames = sys_calculate_free_frames() ;
  8000e0:	e8 8f 14 00 00       	call   801574 <sys_calculate_free_frames>
  8000e5:	89 45 e8             	mov    %eax,-0x18(%ebp)

	sfree(z);
  8000e8:	83 ec 0c             	sub    $0xc,%esp
  8000eb:	ff 75 ec             	pushl  -0x14(%ebp)
  8000ee:	e8 93 12 00 00       	call   801386 <sfree>
  8000f3:	83 c4 10             	add    $0x10,%esp
	cprintf("Slave B2 env removed z\n");
  8000f6:	83 ec 0c             	sub    $0xc,%esp
  8000f9:	68 08 1e 80 00       	push   $0x801e08
  ...
  800106:	e8 69 14 00 00       	call   801574 <sys_calculate_free_frames>
  ...
  80011c:	68 20 1e 80 00       	push   $0x801e20
  ...
  80015e:	68 f0 1e 80 00       	push   $0x801ef0
  800163:	e8 26 04 00 00       	call   80058e <cprintf>
  800168:	83 c4 10             	add    $0x10,%esp

	int32 parentenvID = sys_getparentenvid();
  80016b:	e8 52 13 00 00       	call   8014c2 <sys_getparentenvid>
  ...
  800183:	68 3c 1f 80 00       	push   $0x801f3c
  800188:	ff 75 e4             	pushl  -0x1c(%ebp)
  80018b:	e8 dc 11 00 00       	call   80136c <sget>
...
libmain(int argc, char **argv)
{
  ...
  8001ad:	e8 f7 12 00 00       	call   8014a9 <sys_getenvindex>
  ...
  80022a:	e8 15 14 00 00       	call   801644 <sys_disable_interrupt>
	cprintf("**************************************\n");
  80022f:	83 ec 0c             	sub    $0xc,%esp
  800232:	68 64 1f 80 00       	push   $0x801f64
  ...
  800258:	52                   	push   %edx
  800259:	50                   	push   %eax
  80025a:	68 8c 1f 80 00       	push   $0x801f8c
  ...
  800280:	52                   	push   %edx
  800281:	50                   	push   %eax
  800282:	68 b4 1f 80 00       	push   $0x801fb4
  ...
  80029d:	50                   	push   %eax
  80029e:	68 f5 1f 80 00       	push   $0x801ff5
  8002a3:	e8 e6 02 00 00       	call   80058e <cprintf>
  8002a8:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  8002ab:	83 ec 0c             	sub    $0xc,%esp
  8002ae:	68 64 1f 80 00       	push   $0x801f64
  8002b3:	e8 d6 02 00 00       	call   80058e <cprintf>
  8002b8:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  8002bb:	e8 9e 13 00 00       	call   80165e <sys_enable_interrupt>
...
destroy(void)
{
  ...
  8002d3:	e8 9d 11 00 00       	call   801475 <sys_env_destroy>
...
exit(void)
{
  ...
  8002e1:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  8002e4:	e8 f2 11 00 00       	call   8014db <sys_env_exit>
}
  8002e9:	90                   	nop
  8002ea:	c9                   	leave  
  8002eb:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80030c:	50                   	push   %eax
  80030d:	68 0c 20 80 00       	push   $0x80200c
  ...
  800325:	50                   	push   %eax
  800326:	68 11 20 80 00       	push   $0x802011
  ...
  80034a:	68 2d 20 80 00       	push   $0x80202d
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800376:	68 30 20 80 00       	push   $0x802030
  80037b:	6a 26                	push   $0x26
  80037d:	68 7c 20 80 00       	push   $0x80207c
  ...
  80043c:	68 88 20 80 00       	push   $0x802088
  800441:	6a 3a                	push   $0x3a
  800443:	68 7c 20 80 00       	push   $0x80207c
  ...
  8004a6:	68 dc 20 80 00       	push   $0x8020dc
  8004ab:	6a 44                	push   $0x44
  8004ad:	68 7c 20 80 00       	push   $0x80207c
...
static void putch(int ch, struct printbuf *b) {
  ...
  8004fe:	51                   	push   %ecx
  8004ff:	52                   	push   %edx
  800500:	e8 2e 0f 00 00       	call   801433 <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800576:	50                   	push   %eax
  800577:	e8 b7 0e 00 00       	call   801433 <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  8005be:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8005c1:	e8 7e 10 00 00       	call   801644 <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  8005de:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  8005e1:	e8 78 10 00 00       	call   80165e <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80062b:	e8 ec 14 00 00       	call   801b1c <__udivdi3>
  ...
  800679:	52                   	push   %edx
  80067a:	50                   	push   %eax
  80067b:	e8 ac 15 00 00       	call   801c2c <__umoddi3>
  800680:	83 c4 10             	add    $0x10,%esp
  800683:	05 54 23 80 00       	add    $0x802354,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8007d6:	8b 04 85 78 23 80 00 	mov    0x802378(,%eax,4),%eax
  ...
  8008b7:	8b 34 9d c0 21 80 00 	mov    0x8021c0(,%ebx,4),%esi
  8008be:	85 f6                	test   %esi,%esi
  8008c0:	75 19                	jne    8008db <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  8008c2:	53                   	push   %ebx
  8008c3:	68 65 23 80 00       	push   $0x802365
  ...
  8008d6:	e9 49 02 00 00       	jmp    800b24 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8008db:	56                   	push   %esi
  8008dc:	68 6e 23 80 00       	push   $0x80236e
  ...
  800907:	75 05                	jne    80090e <vprintfmt+0x1a6>
				p = "(null)";
  800909:	be 71 23 80 00       	mov    $0x802371,%esi
			if (width > 0 && padc != '-')
...
void* malloc(uint32 size)
{
  ...
  801321:	68 d0 24 80 00       	push   $0x8024d0
  801326:	6a 16                	push   $0x16
  801328:	68 f5 24 80 00       	push   $0x8024f5
  80132d:	e8 ba ef ff ff       	call   8002ec <_panic>
...
void free(void* virtual_address)
{
  ...
  80133b:	68 04 25 80 00       	push   $0x802504
  801340:	6a 2e                	push   $0x2e
  801342:	68 f5 24 80 00       	push   $0x8024f5
  801347:	e8 a0 ef ff ff       	call   8002ec <_panic>
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  80135b:	68 28 25 80 00       	push   $0x802528
  801360:	6a 3b                	push   $0x3b
  801362:	68 f5 24 80 00       	push   $0x8024f5
  801367:	e8 80 ef ff ff       	call   8002ec <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  801375:	68 28 25 80 00       	push   $0x802528
  80137a:	6a 41                	push   $0x41
  80137c:	68 f5 24 80 00       	push   $0x8024f5
  801381:	e8 66 ef ff ff       	call   8002ec <_panic>
...
void sfree(void* virtual_address)
{
  ...
  80138f:	68 28 25 80 00       	push   $0x802528
  801394:	6a 47                	push   $0x47
  801396:	68 f5 24 80 00       	push   $0x8024f5
  80139b:	e8 4c ef ff ff       	call   8002ec <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  8013a9:	68 28 25 80 00       	push   $0x802528
  8013ae:	6a 4c                	push   $0x4c
  8013b0:	68 f5 24 80 00       	push   $0x8024f5
  8013b5:	e8 32 ef ff ff       	call   8002ec <_panic>
...
void expand(uint32 newSize)
{
  ...
  8013c3:	68 28 25 80 00       	push   $0x802528
  8013c8:	6a 52                	push   $0x52
  8013ca:	68 f5 24 80 00       	push   $0x8024f5
  8013cf:	e8 18 ef ff ff       	call   8002ec <_panic>
...
void shrink(uint32 newSize)
{
  ...
  8013dd:	68 28 25 80 00       	push   $0x802528
  8013e2:	6a 56                	push   $0x56
  8013e4:	68 f5 24 80 00       	push   $0x8024f5
  8013e9:	e8 fe ee ff ff       	call   8002ec <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  8013f7:	68 28 25 80 00       	push   $0x802528
  8013fc:	6a 5b                	push   $0x5b
  8013fe:	68 f5 24 80 00       	push   $0x8024f5
  801403:	e8 e4 ee ff ff       	call   8002ec <_panic>
...
syscall(int num, uint32 a1, uint32 a2, uint32 a3, uint32 a4, uint32 a5)
{
  ...
  801417:	8b 4d 10             	mov    0x10(%ebp),%ecx
  80141a:	8b 5d 14             	mov    0x14(%ebp),%ebx
  80141d:	8b 7d 18             	mov    0x18(%ebp),%edi
  801420:	8b 75 1c             	mov    0x1c(%ebp),%esi
...
sys_cputs(const char *s, uint32 len, uint8 printProgName)
{
  ...
  801451:	e8 b2 ff ff ff       	call   801408 <syscall>
...
sys_cgetc(void)
{
  ...
  80146b:	e8 98 ff ff ff       	call   801408 <syscall>
  801470:	83 c4 18             	add    $0x18,%esp
}
  801473:	c9                   	leave  
  801474:	c3                   	ret    

00801475 <sys_env_destroy>:
...
int sys_env_destroy(int32  envid)
{
  ...
  801483:	50                   	push   %eax
  801484:	6a 05                	push   $0x5
  801486:	e8 7d ff ff ff       	call   801408 <syscall>
  80148b:	83 c4 18             	add    $0x18,%esp
}
  80148e:	c9                   	leave  
  80148f:	c3                   	ret    

00801490 <sys_getenvid>:
...
int32 sys_getenvid(void)
{
  ...
  80149d:	6a 02                	push   $0x2
  80149f:	e8 64 ff ff ff       	call   801408 <syscall>
  8014a4:	83 c4 18             	add    $0x18,%esp
}
  8014a7:	c9                   	leave  
  8014a8:	c3                   	ret    

008014a9 <sys_getenvindex>:
...
int32 sys_getenvindex(void)
{
  ...
  8014b6:	6a 03                	push   $0x3
  8014b8:	e8 4b ff ff ff       	call   801408 <syscall>
  8014bd:	83 c4 18             	add    $0x18,%esp
}
  8014c0:	c9                   	leave  
  8014c1:	c3                   	ret    

008014c2 <sys_getparentenvid>:
...
int32 sys_getparentenvid(void)
{
  ...
  8014d1:	e8 32 ff ff ff       	call   801408 <syscall>
  8014d6:	83 c4 18             	add    $0x18,%esp
}
  8014d9:	c9                   	leave  
  8014da:	c3                   	ret    

008014db <sys_env_exit>:
...
void sys_env_exit(void)
{
  ...
  8014e8:	6a 06                	push   $0x6
  8014ea:	e8 19 ff ff ff       	call   801408 <syscall>
...
int __sys_allocate_page(void *va, int perm)
{
  ...
  801508:	e8 fb fe ff ff       	call   801408 <syscall>
...
int __sys_map_frame(int32 srcenv, void *srcva, int32 dstenv, void *dstva, int perm)
{
  ...
  80152d:	e8 d6 fe ff ff       	call   801408 <syscall>
...
int __sys_unmap_frame(int32 envid, void *va)
{
  ...
  80154b:	52                   	push   %edx
  80154c:	50                   	push   %eax
  80154d:	6a 09                	push   $0x9
  80154f:	e8 b4 fe ff ff       	call   801408 <syscall>
...
uint32 sys_calculate_required_frames(uint32 start_virtual_address, uint32 size)
{
  ...
  801568:	6a 0a                	push   $0xa
  80156a:	e8 99 fe ff ff       	call   801408 <syscall>
...
uint32 sys_calculate_free_frames()
{
  ...
  801583:	e8 80 fe ff ff       	call   801408 <syscall>
...
uint32 sys_calculate_modified_frames()
{
  ...
  80159c:	e8 67 fe ff ff       	call   801408 <syscall>
...
uint32 sys_calculate_notmod_frames()
{
  ...
  8015b5:	e8 4e fe ff ff       	call   801408 <syscall>
  8015ba:	83 c4 18             	add    $0x18,%esp
}
  8015bd:	c9                   	leave  
  8015be:	c3                   	ret    

008015bf <sys_freeMem>:
...
void sys_freeMem(uint32 virtual_address, uint32 size)
{
  ...
  8015ce:	6a 11                	push   $0x11
  8015d0:	e8 33 fe ff ff       	call   801408 <syscall>
...
void sys_allocateMem(uint32 virtual_address, uint32 size)
{
  ...
  8015ea:	6a 12                	push   $0x12
  8015ec:	e8 17 fe ff ff       	call   801408 <syscall>
...
int sys_pf_calculate_allocated_pages()
{
  ...
  801606:	e8 fd fd ff ff       	call   801408 <syscall>
...
int sys_calculate_pages_tobe_removed_ready_exit(uint32 WS_or_MEMORY_flag)
{
  ...
  801620:	e8 e3 fd ff ff       	call   801408 <syscall>
...
void sys_scarce_memory()
{
  ...
  801637:	6a 10                	push   $0x10
  801639:	e8 ca fd ff ff       	call   801408 <syscall>
...
00801644 <sys_disable_interrupt>:
...
sys_disable_interrupt()
{
  ...
  801651:	6a 14                	push   $0x14
  801653:	e8 b0 fd ff ff       	call   801408 <syscall>
...
sys_enable_interrupt()
{
  ...
  80166b:	6a 15                	push   $0x15
  80166d:	e8 96 fd ff ff       	call   801408 <syscall>
...
sys_cputc(const char c)
{
  ...
  801690:	50                   	push   %eax
  801691:	6a 16                	push   $0x16
  801693:	e8 70 fd ff ff       	call   801408 <syscall>
...
sys_clear_ffl()
{
  ...
  8016ab:	6a 17                	push   $0x17
  8016ad:	e8 56 fd ff ff       	call   801408 <syscall>
...
sys_createSemaphore(char* semaphoreName, uint32 initialValue)
{
  ...
  8016c7:	50                   	push   %eax
  8016c8:	6a 18                	push   $0x18
  8016ca:	e8 39 fd ff ff       	call   801408 <syscall>
  8016cf:	83 c4 18             	add    $0x18,%esp
}
  8016d2:	c9                   	leave  
  8016d3:	c3                   	ret    

008016d4 <sys_getSemaphoreValue>:
...
sys_getSemaphoreValue(int32 ownerEnvID, char* semaphoreName)
{
  ...
  8016e7:	e8 1c fd ff ff       	call   801408 <syscall>
  8016ec:	83 c4 18             	add    $0x18,%esp
}
  8016ef:	c9                   	leave  
  8016f0:	c3                   	ret    

008016f1 <sys_waitSemaphore>:
...
sys_waitSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801704:	e8 ff fc ff ff       	call   801408 <syscall>
...
sys_signalSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801722:	e8 e1 fc ff ff       	call   801408 <syscall>
...
0080172d <sys_createSharedObject>:
...
sys_createSharedObject(char* shareName, uint32 size, uint8 isWritable, void* virtual_address)
{
  ...
  801739:	8b 4d 14             	mov    0x14(%ebp),%ecx
  ...
  80174a:	50                   	push   %eax
  80174b:	6a 1c                	push   $0x1c
  80174d:	e8 b6 fc ff ff       	call   801408 <syscall>
  801752:	83 c4 18             	add    $0x18,%esp
}
  801755:	c9                   	leave  
  801756:	c3                   	ret    

00801757 <sys_getSizeOfSharedObject>:
...
sys_getSizeOfSharedObject(int32 ownerID, char* shareName)
{
  ...
  80176a:	e8 99 fc ff ff       	call   801408 <syscall>
  80176f:	83 c4 18             	add    $0x18,%esp
}
  801772:	c9                   	leave  
  801773:	c3                   	ret    

00801774 <sys_getSharedObject>:
//==========
...
sys_getSharedObject(int32 ownerID, char* shareName, void* virtual_address)
{
  ...
  801785:	52                   	push   %edx
  801786:	50                   	push   %eax
  801787:	6a 1e                	push   $0x1e
  801789:	e8 7a fc ff ff       	call   801408 <syscall>
  80178e:	83 c4 18             	add    $0x18,%esp
}
  801791:	c9                   	leave  
  801792:	c3                   	ret    

00801793 <sys_freeSharedObject>:
...
sys_freeSharedObject(int32 sharedObjectID, void *startVA)
{
  ...
  8017a2:	52                   	push   %edx
  8017a3:	50                   	push   %eax
  8017a4:	6a 1f                	push   $0x1f
  8017a6:	e8 5d fc ff ff       	call   801408 <syscall>
  8017ab:	83 c4 18             	add    $0x18,%esp
}
  8017ae:	c9                   	leave  
  8017af:	c3                   	ret    

008017b0 <sys_getMaxShares>:
...
uint32 	sys_getMaxShares()
{
  ...
  8017bf:	e8 44 fc ff ff       	call   801408 <syscall>
  8017c4:	83 c4 18             	add    $0x18,%esp
}
  8017c7:	c9                   	leave  
  8017c8:	c3                   	ret    

008017c9 <sys_create_env>:
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int LRU_second_list_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  8017d1:	ff 75 14             	pushl  0x14(%ebp)
  8017d4:	ff 75 10             	pushl  0x10(%ebp)
  8017d7:	ff 75 0c             	pushl  0xc(%ebp)
  8017da:	50                   	push   %eax
  8017db:	6a 21                	push   $0x21
  8017dd:	e8 26 fc ff ff       	call   801408 <syscall>
  8017e2:	83 c4 18             	add    $0x18,%esp
}
  8017e5:	c9                   	leave  
  8017e6:	c3                   	ret    

008017e7 <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  8017f5:	50                   	push   %eax
  8017f6:	6a 22                	push   $0x22
  8017f8:	e8 0b fc ff ff       	call   801408 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  801814:	e8 ef fb ff ff       	call   801408 <syscall>
...
sys_get_virtual_time()
{
  ...
  80182b:	8d 45 f8             	lea    -0x8(%ebp),%eax
  80182e:	6a 00                	push   $0x0
  801830:	6a 00                	push   $0x0
  801832:	6a 00                	push   $0x0
  801834:	52                   	push   %edx
  801835:	50                   	push   %eax
  801836:	6a 24                	push   $0x24
  801838:	e8 cb fb ff ff       	call   801408 <syscall>
  ...
  80184b:	89 51 04             	mov    %edx,0x4(%ecx)
}
  80184e:	8b 45 08             	mov    0x8(%ebp),%eax
  801851:	c9                   	leave  
  801852:	c2 04 00             	ret    $0x4

00801855 <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  801867:	e8 9c fb ff ff       	call   801408 <syscall>
...
uint32 sys_rcr2()
{
  ...
  80187f:	6a 25                	push   $0x25
  801881:	e8 82 fb ff ff       	call   801408 <syscall>
  801886:	83 c4 18             	add    $0x18,%esp
}
  801889:	c9                   	leave  
  80188a:	c3                   	ret    

0080188b <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  801897:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  80189b:	6a 00                	push   $0x0
  80189d:	6a 00                	push   $0x0
  80189f:	6a 00                	push   $0x0
  8018a1:	6a 00                	push   $0x0
  8018a3:	50                   	push   %eax
  8018a4:	6a 26                	push   $0x26
  8018a6:	e8 5d fb ff ff       	call   801408 <syscall>
...
void rsttst()
{
  ...
  8018be:	6a 28                	push   $0x28
  8018c0:	e8 43 fb ff ff       	call   801408 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  8018d7:	8b 55 18             	mov    0x18(%ebp),%edx
  ...
  8018e9:	6a 27                	push   $0x27
  8018eb:	e8 18 fb ff ff       	call   801408 <syscall>
...
void chktst(uint32 n)
{
  ...
  801904:	6a 29                	push   $0x29
  801906:	e8 fd fa ff ff       	call   801408 <syscall>
...
void inctst()
{
  ...
  80191e:	6a 2a                	push   $0x2a
  801920:	e8 e3 fa ff ff       	call   801408 <syscall>
...
uint32 gettst()
{
  ...
  801938:	6a 2b                	push   $0x2b
  80193a:	e8 c9 fa ff ff       	call   801408 <syscall>
  80193f:	83 c4 18             	add    $0x18,%esp
}
  801942:	c9                   	leave  
  801943:	c3                   	ret    

00801944 <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  801956:	e8 ad fa ff ff       	call   801408 <syscall>
  80195b:	83 c4 18             	add    $0x18,%esp
  80195e:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  801961:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  801965:	75 07                	jne    80196e <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  801967:	b8 01 00 00 00       	mov    $0x1,%eax
  80196c:	eb 05                	jmp    801973 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
00801975 <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801987:	e8 7c fa ff ff       	call   801408 <syscall>
  80198c:	83 c4 18             	add    $0x18,%esp
  80198f:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  801992:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  801996:	75 07                	jne    80199f <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  801998:	b8 01 00 00 00       	mov    $0x1,%eax
  80199d:	eb 05                	jmp    8019a4 <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
008019a6 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  8019b8:	e8 4b fa ff ff       	call   801408 <syscall>
  8019bd:	83 c4 18             	add    $0x18,%esp
  8019c0:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  8019c3:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  8019c7:	75 07                	jne    8019d0 <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  8019c9:	b8 01 00 00 00       	mov    $0x1,%eax
  8019ce:	eb 05                	jmp    8019d5 <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
008019d7 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  8019e9:	e8 1a fa ff ff       	call   801408 <syscall>
  8019ee:	83 c4 18             	add    $0x18,%esp
  8019f1:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  8019f4:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  8019f8:	75 07                	jne    801a01 <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  8019fa:	b8 01 00 00 00       	mov    $0x1,%eax
  8019ff:	eb 05                	jmp    801a06 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
00801a08 <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801a18:	e8 eb f9 ff ff       	call   801408 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801a37:	52                   	push   %edx
  801a38:	50                   	push   %eax
  801a39:	6a 2e                	push   $0x2e
  801a3b:	e8 c8 f9 ff ff       	call   801408 <syscall>
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  801a57:	52                   	push   %edx
  801a58:	50                   	push   %eax
  801a59:	6a 2f                	push   $0x2f
  801a5b:	e8 a8 f9 ff ff       	call   801408 <syscall>
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  801a7e:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  801a85:	01 d0                	add    %edx,%eax
  801a87:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  801a8e:	01 d0                	add    %edx,%eax
  801a90:	c1 e0 04             	shl    $0x4,%eax
  801a93:	89 45 f0             	mov    %eax,-0x10(%ebp)
	uint32 cycles_counter =0;
  801a96:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)

	struct uint64 baseTime = sys_get_virtual_time() ;
  801a9d:	8d 45 e8             	lea    -0x18(%ebp),%eax
  801aa0:	83 ec 0c             	sub    $0xc,%esp
  801aa3:	50                   	push   %eax
  801aa4:	e8 76 fd ff ff       	call   80181f <sys_get_virtual_time>
  801aa9:	83 c4 0c             	add    $0xc,%esp
	while(cycles_counter<time_in_cycles)
  801aac:	eb 41                	jmp    801aef <env_sleep+0x8a>
	{
		struct uint64 currentTime = sys_get_virtual_time() ;
  801aae:	8d 45 e0             	lea    -0x20(%ebp),%eax
  801ab1:	83 ec 0c             	sub    $0xc,%esp
  801ab4:	50                   	push   %eax
  801ab5:	e8 65 fd ff ff       	call   80181f <sys_get_virtual_time>
  ...
  801ad4:	8b 55 d8             	mov    -0x28(%ebp),%edx
  801ad7:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801ada:	39 c2                	cmp    %eax,%edx
  801adc:	0f 97 c0             	seta   %al
  801adf:	0f b6 c0             	movzbl %al,%eax
  801ae2:	29 c1                	sub    %eax,%ecx
  801ae4:	89 c8                	mov    %ecx,%eax
  801ae6:	89 45 dc             	mov    %eax,-0x24(%ebp)

		//update cycles_count with result
		cycles_counter = res.low;
  801ae9:	8b 45 d8             	mov    -0x28(%ebp),%eax
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  801af2:	3b 45 f0             	cmp    -0x10(%ebp),%eax
  801af5:	72 b7                	jb     801aae <env_sleep+0x49>
//				,cycles_counter
//				);
	}
...
uint32 busy_wait(uint32 loopMax)
{
  ...
  801afd:	83 ec 10             	sub    $0x10,%esp
	uint32 i = 0 ;
  801b00:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
	while (i < loopMax) i++;
  801b07:	eb 03                	jmp    801b0c <busy_wait+0x12>
  801b09:	ff 45 fc             	incl   -0x4(%ebp)
  801b0c:	8b 45 fc             	mov    -0x4(%ebp),%eax
  801b0f:	3b 45 08             	cmp    0x8(%ebp),%eax
  801b12:	72 f5                	jb     801b09 <busy_wait+0xf>
	return i;
...
00801b1c <__udivdi3>:
  ...
  801b23:	8b 5c 24 30          	mov    0x30(%esp),%ebx
  801b27:	8b 4c 24 34          	mov    0x34(%esp),%ecx
  801b2b:	8b 7c 24 38          	mov    0x38(%esp),%edi
  801b2f:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  801b33:	89 ca                	mov    %ecx,%edx
  801b35:	89 f8                	mov    %edi,%eax
  801b37:	8b 74 24 3c          	mov    0x3c(%esp),%esi
  801b3b:	85 f6                	test   %esi,%esi
  801b3d:	75 2d                	jne    801b6c <__udivdi3+0x50>
  801b3f:	39 cf                	cmp    %ecx,%edi
  801b41:	77 65                	ja     801ba8 <__udivdi3+0x8c>
  801b43:	89 fd                	mov    %edi,%ebp
  801b45:	85 ff                	test   %edi,%edi
  801b47:	75 0b                	jne    801b54 <__udivdi3+0x38>
  801b49:	b8 01 00 00 00       	mov    $0x1,%eax
  801b4e:	31 d2                	xor    %edx,%edx
  801b50:	f7 f7                	div    %edi
  801b52:	89 c5                	mov    %eax,%ebp
  801b54:	31 d2                	xor    %edx,%edx
  801b56:	89 c8                	mov    %ecx,%eax
  801b58:	f7 f5                	div    %ebp
  801b5a:	89 c1                	mov    %eax,%ecx
  801b5c:	89 d8                	mov    %ebx,%eax
  801b5e:	f7 f5                	div    %ebp
  801b60:	89 cf                	mov    %ecx,%edi
  ...
  801b6e:	77 28                	ja     801b98 <__udivdi3+0x7c>
  801b70:	0f bd fe             	bsr    %esi,%edi
  801b73:	83 f7 1f             	xor    $0x1f,%edi
  801b76:	75 40                	jne    801bb8 <__udivdi3+0x9c>
  801b78:	39 ce                	cmp    %ecx,%esi
  801b7a:	72 0a                	jb     801b86 <__udivdi3+0x6a>
  801b7c:	3b 44 24 08          	cmp    0x8(%esp),%eax
  801b80:	0f 87 9e 00 00 00    	ja     801c24 <__udivdi3+0x108>
  ...
  801bb6:	5d                   	pop    %ebp
  801bb7:	c3                   	ret    
  801bb8:	bd 20 00 00 00       	mov    $0x20,%ebp
  801bbd:	89 eb                	mov    %ebp,%ebx
  801bbf:	29 fb                	sub    %edi,%ebx
  801bc1:	89 f9                	mov    %edi,%ecx
  801bc3:	d3 e6                	shl    %cl,%esi
  801bc5:	89 c5                	mov    %eax,%ebp
  801bc7:	88 d9                	mov    %bl,%cl
  801bc9:	d3 ed                	shr    %cl,%ebp
  801bcb:	89 e9                	mov    %ebp,%ecx
  801bcd:	09 f1                	or     %esi,%ecx
  801bcf:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  801bd3:	89 f9                	mov    %edi,%ecx
  801bd5:	d3 e0                	shl    %cl,%eax
  801bd7:	89 c5                	mov    %eax,%ebp
  801bd9:	89 d6                	mov    %edx,%esi
  801bdb:	88 d9                	mov    %bl,%cl
  801bdd:	d3 ee                	shr    %cl,%esi
  801bdf:	89 f9                	mov    %edi,%ecx
  801be1:	d3 e2                	shl    %cl,%edx
  801be3:	8b 44 24 08          	mov    0x8(%esp),%eax
  801be7:	88 d9                	mov    %bl,%cl
  801be9:	d3 e8                	shr    %cl,%eax
  801beb:	09 c2                	or     %eax,%edx
  801bed:	89 d0                	mov    %edx,%eax
  801bef:	89 f2                	mov    %esi,%edx
  801bf1:	f7 74 24 0c          	divl   0xc(%esp)
  801bf5:	89 d6                	mov    %edx,%esi
  801bf7:	89 c3                	mov    %eax,%ebx
  801bf9:	f7 e5                	mul    %ebp
  801bfb:	39 d6                	cmp    %edx,%esi
  801bfd:	72 19                	jb     801c18 <__udivdi3+0xfc>
  801bff:	74 0b                	je     801c0c <__udivdi3+0xf0>
  801c01:	89 d8                	mov    %ebx,%eax
  801c03:	31 ff                	xor    %edi,%edi
  801c05:	e9 58 ff ff ff       	jmp    801b62 <__udivdi3+0x46>
  801c0a:	66 90                	xchg   %ax,%ax
  801c0c:	8b 54 24 08          	mov    0x8(%esp),%edx
  801c10:	89 f9                	mov    %edi,%ecx
  801c12:	d3 e2                	shl    %cl,%edx
  801c14:	39 c2                	cmp    %eax,%edx
  801c16:	73 e9                	jae    801c01 <__udivdi3+0xe5>
  801c18:	8d 43 ff             	lea    -0x1(%ebx),%eax
  801c1b:	31 ff                	xor    %edi,%edi
  801c1d:	e9 40 ff ff ff       	jmp    801b62 <__udivdi3+0x46>
  801c22:	66 90                	xchg   %ax,%ax
  801c24:	31 c0                	xor    %eax,%eax
  801c26:	e9 37 ff ff ff       	jmp    801b62 <__udivdi3+0x46>
  801c2b:	90                   	nop
...
00801c2c <__umoddi3>:
  ...
  801c33:	8b 4c 24 30          	mov    0x30(%esp),%ecx
  801c37:	8b 74 24 34          	mov    0x34(%esp),%esi
  801c3b:	8b 7c 24 38          	mov    0x38(%esp),%edi
  801c3f:	8b 44 24 3c          	mov    0x3c(%esp),%eax
  801c43:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801c47:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  801c4b:	89 f3                	mov    %esi,%ebx
  801c4d:	89 fa                	mov    %edi,%edx
  801c4f:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  801c53:	89 34 24             	mov    %esi,(%esp)
  801c56:	85 c0                	test   %eax,%eax
  801c58:	75 1a                	jne    801c74 <__umoddi3+0x48>
  801c5a:	39 f7                	cmp    %esi,%edi
  801c5c:	0f 86 a2 00 00 00    	jbe    801d04 <__umoddi3+0xd8>
  ...
  801c76:	0f 87 ac 00 00 00    	ja     801d28 <__umoddi3+0xfc>
  801c7c:	0f bd e8             	bsr    %eax,%ebp
  801c7f:	83 f5 1f             	xor    $0x1f,%ebp
  801c82:	0f 84 ac 00 00 00    	je     801d34 <__umoddi3+0x108>
  801c88:	bf 20 00 00 00       	mov    $0x20,%edi
  801c8d:	29 ef                	sub    %ebp,%edi
  801c8f:	89 fe                	mov    %edi,%esi
  801c91:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  801c95:	89 e9                	mov    %ebp,%ecx
  801c97:	d3 e0                	shl    %cl,%eax
  801c99:	89 d7                	mov    %edx,%edi
  801c9b:	89 f1                	mov    %esi,%ecx
  801c9d:	d3 ef                	shr    %cl,%edi
  801c9f:	09 c7                	or     %eax,%edi
  801ca1:	89 e9                	mov    %ebp,%ecx
  801ca3:	d3 e2                	shl    %cl,%edx
  801ca5:	89 14 24             	mov    %edx,(%esp)
  801ca8:	89 d8                	mov    %ebx,%eax
  801caa:	d3 e0                	shl    %cl,%eax
  801cac:	89 c2                	mov    %eax,%edx
  801cae:	8b 44 24 08          	mov    0x8(%esp),%eax
  801cb2:	d3 e0                	shl    %cl,%eax
  801cb4:	89 44 24 04          	mov    %eax,0x4(%esp)
  801cb8:	8b 44 24 08          	mov    0x8(%esp),%eax
  801cbc:	89 f1                	mov    %esi,%ecx
  801cbe:	d3 e8                	shr    %cl,%eax
  801cc0:	09 d0                	or     %edx,%eax
  801cc2:	d3 eb                	shr    %cl,%ebx
  801cc4:	89 da                	mov    %ebx,%edx
  801cc6:	f7 f7                	div    %edi
  801cc8:	89 d3                	mov    %edx,%ebx
  801cca:	f7 24 24             	mull   (%esp)
  801ccd:	89 c6                	mov    %eax,%esi
  801ccf:	89 d1                	mov    %edx,%ecx
  801cd1:	39 d3                	cmp    %edx,%ebx
  801cd3:	0f 82 87 00 00 00    	jb     801d60 <__umoddi3+0x134>
  801cd9:	0f 84 91 00 00 00    	je     801d70 <__umoddi3+0x144>
  801cdf:	8b 54 24 04          	mov    0x4(%esp),%edx
  801ce3:	29 f2                	sub    %esi,%edx
  801ce5:	19 cb                	sbb    %ecx,%ebx
  801ce7:	89 d8                	mov    %ebx,%eax
  801ce9:	8a 4c 24 0c          	mov    0xc(%esp),%cl
  801ced:	d3 e0                	shl    %cl,%eax
  801cef:	89 e9                	mov    %ebp,%ecx
  801cf1:	d3 ea                	shr    %cl,%edx
  801cf3:	09 d0                	or     %edx,%eax
  801cf5:	89 e9                	mov    %ebp,%ecx
  801cf7:	d3 eb                	shr    %cl,%ebx
  ...
  801d02:	c3                   	ret    
  801d03:	90                   	nop
  801d04:	89 fd                	mov    %edi,%ebp
  801d06:	85 ff                	test   %edi,%edi
  801d08:	75 0b                	jne    801d15 <__umoddi3+0xe9>
  801d0a:	b8 01 00 00 00       	mov    $0x1,%eax
  801d0f:	31 d2                	xor    %edx,%edx
  801d11:	f7 f7                	div    %edi
  ...
  801d21:	e9 44 ff ff ff       	jmp    801c6a <__umoddi3+0x3e>
  ...
  801d32:	5d                   	pop    %ebp
  801d33:	c3                   	ret    
  801d34:	3b 04 24             	cmp    (%esp),%eax
  801d37:	72 06                	jb     801d3f <__umoddi3+0x113>
  801d39:	3b 7c 24 04          	cmp    0x4(%esp),%edi
  801d3d:	77 0f                	ja     801d4e <__umoddi3+0x122>
  801d3f:	89 f2                	mov    %esi,%edx
  801d41:	29 f9                	sub    %edi,%ecx
  801d43:	1b 54 24 0c          	sbb    0xc(%esp),%edx
  801d47:	89 14 24             	mov    %edx,(%esp)
  801d4a:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  801d4e:	8b 44 24 04          	mov    0x4(%esp),%eax
  801d52:	8b 14 24             	mov    (%esp),%edx
  ...
  801d60:	2b 04 24             	sub    (%esp),%eax
  801d63:	19 fa                	sbb    %edi,%edx
  801d65:	89 d1                	mov    %edx,%ecx
  801d67:	89 c6                	mov    %eax,%esi
  801d69:	e9 71 ff ff ff       	jmp    801cdf <__umoddi3+0xb3>
  801d6e:	66 90                	xchg   %ax,%ax
  801d70:	39 44 24 04          	cmp    %eax,0x4(%esp)
  801d74:	72 ea                	jb     801d60 <__umoddi3+0x134>
  801d76:	89 d9                	mov    %ebx,%ecx
  801d78:	e9 62 ff ff ff       	jmp    801cdf <__umoddi3+0xb3>
