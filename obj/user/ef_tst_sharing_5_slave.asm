...
void free(void* virtual_address)
{
  ...
  8014c8:	8b 04 85 c0 40 80 00 	mov    0x8040c0(,%eax,4),%eax
  ...
  8014f9:	8b 04 85 60 50 80 00 	mov    0x805060(,%eax,4),%eax
  ...
  80151b:	c7 04 85 c0 40 80 00 	movl   $0x0,0x8040c0(,%eax,4)
  801522:	00 00 00 00 
    	changes++;
